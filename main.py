...
async def getDrink(format="string") -> Dict[str, str]:
    ...
    try:
        ...
        for (i) in range(tot):
            ...
            """ingString += f"{ingredients[i]}
            quanString += f"{quantities[i]}"""
        if format == "string":
        ...
        return{
            "error_msj": "An error ocurred please try again"
        }
...
async def getAffirmation() -> Dict[str, str]:
    ...
    try:
        characters: List[str] = ["pirate", "minion", "sindarin", "oldenglish", "ferblatin", "dothraki", "valyrian",
                                 "vulcan", "klingon", "pig-latin", "yoda" "sith", "cheunh", "gungan", "mandalorian", "huttese"]
        ...
        if ( choices == 1 ):
            ...
            affirmation: str = (response.json()).get("contents").get("quotes")[0].get("quote")
        ...
        if (translate_to == "yoda"):
            new_dictionary["affirmation_image"] = "https://tukaramatthews.com/wp-content/uploads/2015/03/FullSizeRender.jpg"
        elif (translate_to=="pirate"):
            new_dictionary["affirmation_image"] = "https://image.flaticon.com/icons/png/512/287/287744.png"
        elif (translate_to=="minion"):
            new_dictionary["affirmation_image"] = "https://4.bp.blogspot.com/-kLGmroF-doI/VeJhCJlpeyI/AAAAAAAASK4/TRvjlSKu4nk/s1600/13.jpeg"
        elif (translate_to=="sindarin"):
            new_dictionary["affirmation_image"] = "https://i.etsystatic.com/8273882/r/il/c6deb3/475904358/il_570xN.475904358_enru.jpg"
        elif (translate_to=="oldenglish"):
            new_dictionary["affirmation_image"] = "https://i.etsystatic.com/21833494/r/il/7e76dd/2140080884/il_570xN.2140080884_ikw0.jpg"
        elif (translate_to=="ferblatin"):
            new_dictionary["affirmation_image"] = "https://i.ytimg.com/vi/I3nAGsT2skc/maxresdefault.jpg"
        elif (translate_to=="dothraki"):
            new_dictionary["affirmation_image"] = "https://www.trbimg.com/img-55791e95/turbine/la-oe-0611-peterson-game-of-thrones-dothraki-20150611"
        elif (translate_to=="valyrian"):
            new_dictionary["affirmation_image"] = "https://i.kinja-img.com/gawker-media/image/upload/s--oY79jygD--/c_fill,f_auto,fl_progressive,g_center,h_264,pg_1,q_80,w_470/q8vern8v3ow3g7u6bu6i.png"     
        elif (translate_to=="vulcan"):
            new_dictionary["affirmation_image"] = "https://geneticliteracyproject.org/wp-content/uploads/2017/01/Leonard-Nimoy.png"
        elif (translate_to=="klingon"):
            new_dictionary["affirmation_image"] = "https://static.independent.co.uk/s3fs-public/thumbnails/image/2016/03/14/19/9-klingon-star-trek.jpg"
        elif (translate_to=="pig-latin"):
            new_dictionary["affirmation_image"] = "https://www.quickanddirtytips.com/sites/default/files/images/2104/piglatin.jpg"
        elif (translate_to=="sith"):
            new_dictionary["affirmation_image"] = "https://i.redd.it/ra6s480wfi701.jpg"
        elif (translate_to=="cheunh"):
            new_dictionary["affirmation_image"] = "https://www.thathashtagshow.com/wp-content/uploads/2019/07/steadfast-1024x655.jpg"
        elif (translate_to=="gungan"):
            new_dictionary["affirmation_image"] = "https://img1.wikia.nocookie.net/__cb20091012212518/aliens/images/9/93/Gungan-Otolla.jpg"
        elif (translate_to=="mandalorian"):
            new_dictionary["affirmation_image"] = "https://cdn.dribbble.com/users/2110632/screenshots/5607696/dribbble-03_2x.png"
        elif (translate_to=="huttese"):
            new_dictionary["affirmation_image"] = "https://vignette.wikia.nocookie.net/starwarslanguages/images/b/b1/Review_jabba_1-1-.jpg/revision/latest?cb=20091224205111"
        
        return (new_dictionary)

    except:
        return{
            "text_affirmation": "An error ocurred please try again later"
        }
...
async def getWeather(query: str = None, key: str = None) -> Dict[str, str]:
    ...
    try:
        ...
        return{
            "error_msj": "An error ocurred please verify your inputs and try again"
        }
...
async def getWakaStats(waka_key: str = None, format: str = "string") -> Dict[str, str]:
    ...
    try:
        ...
        wakatime_data: Dict = get("https://wakatime.com/api/v1/users/current/stats/last_7_days", headers={
        ...
        for language in (coded_on):
            ...
            temp_list.append("{hours} hours and {minutes} minutes".format(
                **language))
...
async def getAll(open_weather_query: str = None, open_weather_key: str = None, waka_time_api_key: str = None, format: str = "string") -> Dict[str, str]:
    ...
    try:
        ...
        weather=await getWeather(
            query=open_weather_query, key=open_weather_key)
        ...
        return {
            "error_msj": "Error ocurred"
        }


if __name__ == '__main__':

    async def updateFile(path_to_new_file: str = "README.md", path_to_template_file: str = "directory_file", open_weather_query: str = None, open_weather_key: str = None, waka_time_api_key: str = None, format: str = "string") -> bool:
        '''Updates a file with the information gathered using the rest of the functions'''
        try:
            dictionary = await getAll(open_weather_query=open_weather_query, open_weather_key=open_weather_key,
    ...
    format = "html"
    loop=get_event_loop()
    loop.run_until_complete(main(open_weather_query=open_weather_query, open_weather_key=open_weather_key,
               waka_time_api_key=waka_api_key, format=format))
    loop.close()
