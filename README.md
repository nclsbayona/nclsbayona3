<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Catch, then, O catch the transient hour; Improve each moment as it flies! ' was translated to klingon language, and the result is: 'Suq,  vaj,  O suq the transient rep; dub ngiq moment as 'oh flies!'
        </h5>
