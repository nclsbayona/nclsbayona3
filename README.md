<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Great ambition is the passion of a great character. Those endowed with it may perform very good or very bad acts. All depends on the principals which direct them.' was translated to mandalorian language, and the result is: 'Great copad is te passion be a great character. Those endowed ti bic may perform ori jate ra ori dush acts. An depends bat te principals megin direct them.'
        </h5>
