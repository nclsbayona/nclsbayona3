<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Wishing to be friends is quick work, but friendship is a slow ripening fruit.' was translated to oldenglish language, and the result is: ' {Wishing} toward sý frîend {is} wær handgewinn, heonu frêondlufu {is} hlêg besolcen rîpung ofet.'
        </h5>
