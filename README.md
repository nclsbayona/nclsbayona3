<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'There is no one giant step that does it. It's a lot of little steps.' was translated to oldenglish language, and the result is: ' {There} {is} nân n¯ænne swegle gîgant treddian ðe {does} man. {It's} wýscan hlýte râd and in {steps}.'
        </h5>
