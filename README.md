<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'True it is, we only hate those whom we do not know.' was translated to oldenglish language, and the result is: ' {True} hê {is}, we ânga lâðettan ðâs {whom} attraction with pron ðe ic drîfan n¯ænig pro oncunnan.'
        </h5>
