<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Humor isn't for everyone. It's only for people who want to have fun, enjoy life, and feel alive.' was translated to sindarin language, and the result is: 'Humor isn't an everyone. Ha's onlui an núr who anír- na gar- fun,  enjoui cuil,  a feel cuin.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                15.34°C, however it feels like 15.07°C, climate is
                <i>light rain</i>
            .
            Min. temperature: 15.34°C
            Max. temperature: 15.34°C
        </p>
    </div>
    <div id="wakatime">
        <p>
