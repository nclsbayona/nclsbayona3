<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you love somebody, let them go, for if they return, they were always yours. If they don't, they never were.' was translated to oldenglish language, and the result is: ' {If} êow sibgeornes {somebody}, lîhting ðâs eftcyrran, eornostlîce gif hîe onhweorfan, ðæge pro {were} middangeard êower. {If} ðæge pro {don't}, man nân n¯ænne {were}.'
        </h5>
