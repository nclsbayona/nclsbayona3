<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Never allow someone to be your priority while allowing yourself to be their option.' was translated to oldenglish language, and the result is: ' {Never} forgiefnes {someone} into bêo êower {priority} mid {allowing} {yourself} ðêon sîe sîn wîse.'
        </h5>
