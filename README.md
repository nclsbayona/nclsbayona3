<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'From morning till night, we should never rely on a single thing.' was translated to oldenglish language, and the result is: ' {From} morgen {till} niht, attraction with pron ðe ic {should} nâ {rely} uppan bêga su oftost m¯ægwlite.'
        </h5>
