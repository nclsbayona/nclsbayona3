<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Failure is the condiment that gives success its flavor.' was translated to oldenglish language, and the result is: ' {Failure} {is} wægn inwise landriht 'land−right {gives} forðsîð sîn {flavor}.'
        </h5>
