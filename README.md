<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Your life is already a miracle of chance waiting for you to shape its destiny' was translated to oldenglish language, and the result is: ' {Your} môd {is} wiðforan wýscan wundorweorc of wyrd {waiting} ac êower oðferian ednîwian sîn wyrd'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                10.32°C, however it feels like 9.84°C, climate is
                <i>broken clouds</i>
            .
            Min. temperature: 10.32°C
            Max. temperature: 10.32°C
        </p>
    </div>
    <div id="wakatime">
        <p>
