<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Starting is the most difficult step - but you can do it' was translated to oldenglish language, and the result is: ' {Starting} {is} wægn m¯æst earfoðlic bestæppan {-} ge êow canne lufian hê'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                11.66°C, however it feels like 11.31°C, climate is
                <i>overcast clouds</i>
            .
