<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Life is like a camera: just focus on what is important, capture good times, develop from negative, and if things do not work out, take another shot!' was translated to valyrian language, and the result is: 'Glaeson iksos raqagon nykeā camera: sepār focus va skoros iksos important,  capture sȳz jēdi,  develop hen negative,  se lo things gaomagon daor mirre hen,  gūrogon another shot!'
        </h5>
