<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Don't wait for the right opportunity: create it.' was translated to gungan language, and the result is: 'Don't wait for dha right opportunity: create it.'
        </h5>
