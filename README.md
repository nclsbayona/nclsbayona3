<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'From morning till night, we should never rely on a single thing.' was translated to sith language, and the result is: 'Sulig ausra kaza naktis,  mes setup niekada rely ant zo fazien thing.'
        </h5>
