<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Great ambition is the passion of a great character. Those endowed with it may perform very good or very bad acts. All depends on the principals which direct them.' was translated to oldenglish language, and the result is: ' {Great} rîceter {is} duguð wêamêtto orgilde tîma ungrund môdsefa. {Those} môdwelig wið hê mægðmann æfnan torne rûmmôd ge earfoðlic earglic {acts}. {All} {depends} bûtan ðone as {principals} ðêos endebyrdnes ðâs.'
        </h5>
