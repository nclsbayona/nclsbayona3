<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'It's not what you pay a man, but what he costs you that counts.' was translated to dothraki language, and the result is: 'Anna's vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) fini yeri pay a mahrazh,  vosma fini anna costs yeri ki counts.'
        </h5>
