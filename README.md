<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The secret of life isn't what happens to you, but what you do with what happens to you.' was translated to minion language, and the result is: 'ta idsleg mud levo sup Whaaat?  dalgad da to, pelo Whaaat, yikai? . to batooay wat Whaaat?  dalgad da to.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                14.66°C, however it feels like 14.27°C, climate is
                <i>light rain</i>
            .
            Min. temperature: 14.66°C
            Max. temperature: 14.66°C
        </p>
    </div>
    <div id="wakatime">
        <p>
