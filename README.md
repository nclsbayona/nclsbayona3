<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The heart wants what it wants - or else it does not care.' was translated to oldenglish language, and the result is: ' {The} hreðer {wants} {what} hîe {wants} {-} sam elcora ðæge pro {does} ne broc.'
        </h5>
