<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The first step toward getting somewhere is to decide that you are not going to stay where you are.' was translated to gungan language, and the result is: 'Dha first step toward gett somewhere is to decide dat yousa not goen to stay where yousa.'
        </h5>
