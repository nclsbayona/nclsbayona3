<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'You know the more one does the more one can do.' was translated to dothraki language, and the result is: 'Yeri know the alikh ato does the alikh ato laz hash.'
        </h5>
