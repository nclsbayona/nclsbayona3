<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Perfection is not attainable, but if we chase perfection we can catch excellence..' was translated to cheunh language, and the result is: 'Taskavcas carcir nah attainable,  rab rah nah ren'musi taskavcas nah can vit'cah bun'as.'
        </h5>
