<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The moment you doubt whether you can fly, you cease for ever to be able to do it.' was translated to minion language, and the result is: 'ta tadfox to rom kupa to pudum jee, to cease nunu rib da be lap da batooay pik.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                11.37°C, however it feels like 10.96°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 11.37°C
            Max. temperature: 11.37°C
        </p>
    </div>
    <div id="wakatime">
        <p>
