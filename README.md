<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The last time doesn't exist. It's only this time. And everything is going to be different this time. There's only now.' was translated to sith language, and the result is: 'Tave galas amzi dartov'ne exist. Zhol's tik sis amzi. Ir viskas kash bukle kia buti hevilas sis amzi. Antai's tik dabar.'
        </h5>
