<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Life should be touched, not strangled.  ' was translated to dothraki language, and the result is: 'Atthirar jif be touched,  vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) strangled.'
        </h5>
