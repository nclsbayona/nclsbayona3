<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you do not change direction, you may end up where you are heading.' was translated to pirate language, and the result is: 'If ye dern't change direction, ye may end up whar ye be headin'.'
        </h5>
