<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The things you learn in maturity aren't simple things such as acquiring information and skills. You learn not to engage in self-destructive behavior. You learn not to burn up energy in anxiety. You discover how to manage your tensions. You learn that self-pity and resentment are among the most toxic of drugs. You find that the world loves talent but pays off on character.' was translated to oldenglish language, and the result is: ' {The} {things} êow ofâcsian oð rîpung {aren't} ungemenged {things} swilc oð {acquiring} {information} ðâ {skills}. {You} leornian nealles oð weddian birihte {self-destructive} {behavior}. {You} fricgan n¯ænig pro to lêafleoht uppe arodscipe ongêanweard ðr¯æstnes. {You} infindan hû settan {manage} êower {tensions}. {You} ongietan ðæt {self-pity} ðêana {resentment} meðrian betwisc dôð fyrmest su of forma {toxic} of {drugs}. {You} l¯æstan landriht 'land−right ðone as woruldgesceaft {loves} cræft ¯ægðand {pays} d¯ællêas of môdsefa.'
        </h5>
