<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'From error to error one discovers the entire truth.' was translated to oldenglish language, and the result is: ' {From} dolscipe âstellan misgedwield wuldorfæst {discovers} duguð un−swicende sôðes.'
        </h5>
