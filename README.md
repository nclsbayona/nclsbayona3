<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'All courses of action are risky, so prudence is not in avoiding danger (it's impossible), but calculating risk and acting decisively. Make mistakes of ambition and not mistakes of sloth. Develop the strength to do bold things, not the strength to suffer.' was translated to oldenglish language, and the result is: ' {All} {courses} of onginnes meðrian {risky}, adverbial phrases snyttru {is} hnot ætrihte {avoiding} pliht {(it's} {impossible)}, ðe {calculating} nêðan lôca in {acting} {decisively}. {Make} {mistakes} râd rîcetere swâðêah nealles {mistakes} un−l¯æd iergðu. {Develop} dôð strengð ûtâðýdan drîfan ðrîstiglic {things}, hnot wægn hêahstrengðu to winnan.'
        </h5>
