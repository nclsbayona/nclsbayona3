<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Doing what you love is the cornerstone of having abundance in your life. ' was translated to oldenglish language, and the result is: ' {Doing} {what} êower siblufu {is} ðone as {cornerstone} un−l¯æd twihynde rûmgifulnes un−feor êower brêostgehygd. '
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                12.76°C, however it feels like 12.52°C, climate is
                <i>light rain</i>
            .
            Min. temperature: 12.76°C
            Max. temperature: 12.76°C
        </p>
    </div>
    <div id="wakatime">
        <p>
