<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The last time doesn't exist. It's only this time. And everything is going to be different this time. There's only now.' was translated to oldenglish language, and the result is: ' {The} hlæst m¯æl {doesn't} w¯æren. {It's} ânstreces ðætte ontimber. {And} æthwâ {is} stæpe unnon w¯æren ungelîc tôhwon dôgor−gerîm. {There's} further ðêah.'
        </h5>
