<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'You are the only problem you will ever have and you are the only solution.' was translated to pirate language, and the result is: 'ye be th' only problem ye will e'er have and ye be th' only solution.'
        </h5>
