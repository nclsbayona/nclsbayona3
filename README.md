<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Attitude drives actions. Actions drive results. Results drive lifestyles.' was translated to cheunh language, and the result is: 'Ren'can'ibi drives actions. Actions drive results. Results drive lifestyles.'
        </h5>
