<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Twenty years from now you will be more disappointed by the things that you didn't do than by the ones you did do. So throw off the bowlines. Sail away from the safe harbor. Catch the trade winds in your sails. Explore. Dream. Discover.' was translated to oldenglish language, and the result is: ' {Twenty} {years} hêan ðon êower fers cûð more {disappointed} fullan duguð {things} ' right to own or occupy land or connected with its occupation êow {didn't} timbran {than} forð forðbie sê {ones} êow {did} historical aorist of the second. {So} bescûfan of sê {bowlines}. {Sail} heonon forniman sê beorglic {harbor}. {Catch} wægn mangung {winds} inne êower {sails}. {Explore}. {Dream}. {Discover}.'
        </h5>
