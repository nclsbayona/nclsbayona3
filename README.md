<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Everything is created twice, first in the mind and then in reality.' was translated to cheunh language, and the result is: 'Sei carcir created twice,  can'a can ch'at rt'eseci vim cseo can csaitasi.'
        </h5>
