<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Patience is a bitter plant, but its fruit is sweet.' was translated to oldenglish language, and the result is: ' {Patience} {is} dimf b¯æm eced plantian, gên sîn wæstm {is} wêðe.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                8.93°C, however it feels like 8.93°C, climate is
                <i>scattered clouds</i>
            .
            Min. temperature: 8.93°C
            Max. temperature: 8.93°C
        </p>
    </div>
    <div id="wakatime">
        <p>
