<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If it is not right, do not do it, if it is not true, do not say it.' was translated to klingon language, and the result is: 'If 'oh is not nih,  do not ruch,  if 'oh is not hislah,  do not jatlh 'oh.'
        </h5>
