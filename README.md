<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Everyone can rise above their circumstances and achieve success if they are dedicated to and passionate about what they do.' was translated to valyrian language, and the result is: 'Everyone kostagon sīmonagon toliot pōja circumstances se achieve success lo pōnta issi dedicated naejot se passionate bē skoros pōnta gaomagon.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                12.33°C, however it feels like 12.02°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 12.33°C
            Max. temperature: 12.33°C
        </p>
    </div>
    <div id="wakatime">
        <p>
