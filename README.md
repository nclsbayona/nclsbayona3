<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If everything was easy you'd be bored' was translated to oldenglish language, and the result is: ' {If} form and with a {was} gearolîce {you'd} w¯ære {bored}'
        </h5>
