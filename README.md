<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'I am always doing that which I can not do, in order that I may learn how to do it.' was translated to klingon language, and the result is: 'Jih am reh doing 'e' which jih can not do,  in 'obe' 'e' jih may ghoj chay' to ruch.'
        </h5>
