<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you want peace, you won't get it with violence.' was translated to pig-latin language, and the result is: 'If-way ou-yay ant-way eace-pay, ou-yay won't et-gay it-way ith-way iolence-vay. '
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                10.13°C, however it feels like 9.6°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 10.13°C
            Max. temperature: 10.13°C
        </p>
    </div>
    <div id="wakatime">
        <p>
