<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'It is truth that liberates, not your effort to be free.' was translated to oldenglish language, and the result is: ' {It} {is} sôðsagu ' right to own or occupy land or connected with its occupation {liberates}, hnot êower hyht âîeðan w¯ære æt−bregdan.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                20.73°C, however it feels like 19.35°C, climate is
                <i>few clouds</i>
            .
