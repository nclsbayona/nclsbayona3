<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Never argue with ignorance. It only leads to frustration.' was translated to gungan language, and the result is: 'Never argue with ignorance. It only leads to frustration.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                18.21°C, however it feels like 17.47°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 18.21°C
            Max. temperature: 18.21°C
        </p>
    </div>
    <div id="wakatime">
        <p>
