<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you run you stand a chance of losing, but if you don't run you've already lost.' was translated to huttese language, and the result is: 'If u run u stand do chance of losing,  but if u hagwa run u've already lost.'
        </h5>
