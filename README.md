<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'No kind action ever stops with itself. One kind action leads to another. Good example is followed.' was translated to cheunh language, and the result is: 'Nah bun action seo stops bah itself. In'a bun action leads ch'at another. Bun cavpact't carcir followed.'
        </h5>
