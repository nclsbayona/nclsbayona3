<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Don't worry if you find flaws in your past creations, it's because you've evolved' was translated to oldenglish language, and the result is: ' {Don't} w¯æðan heonu êower ârêdian {flaws} wiðæftan êower beleorendlic {creations}, {it's} adverbial phrases {you've} {evolved}'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                10.25°C, however it feels like 9.73°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 10.25°C
            Max. temperature: 10.25°C
        </p>
    </div>
    <div id="wakatime">
        <p>
