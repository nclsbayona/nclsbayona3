<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If the happiness and prosperity of other people depend on you, you have nothing to fear anymore.' was translated to oldenglish language, and the result is: ' {If} ðone as sibgeornes sôðlic êadnes orgilde oððe woruld hangian fornêah êower, êower rômian nâht f¯ætan âgrîsan {anymore}.'
        </h5>
