<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Do not fight with pigs - you will be smeared in mud but the pig will like it.' was translated to gungan language, and the result is: 'Do not fight with pigs - yousa will be smeared in mud but dha pig will like it.'
        </h5>
...
Stir well.
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                20.18°C, however it feels like 19.53°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 20.18°C
            Max. temperature: 20.18°C
        </p>
    </div>
    <div id="wakatime">
        <p>
