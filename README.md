<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you can consciously let yourself get taken and see where you go, that's an exercise. That's discipline. To follow the scent. Let yourself go and see what happens, that takes a bit of courage.' was translated to sindarin language, and the result is: 'If cin tur- consciouslui let yourself get taken a see where cin glenn-,  i's an exercise. I's discipline. Na afad- i scent. Let yourself glenn- a see what happens,  i takes a bit -o huor.'
        </h5>
