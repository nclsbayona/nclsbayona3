<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Every failure brings with it the seed of an equivalent success.' was translated to yoda language, and the result is: 'With it the seed of an equivalent success,  every failure brings.'
        </h5>
