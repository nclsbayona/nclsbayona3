<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Don't be afraid to see what you see.' was translated to vulcan language, and the result is: 'Ri tor nam-tor kwes tor gla-tor ra gla-tor du.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                15.59°C, however it feels like 15.27°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 15.59°C
            Max. temperature: 15.59°C
        </p>
    </div>
    <div id="wakatime">
        <p>
