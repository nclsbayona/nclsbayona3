<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Dance first. Think later. It's the natural order.' was translated to oldenglish language, and the result is: ' {Dance} frymð−lic. {Think} siððon. {It's} ðone as ðungen wissian.'
        </h5>
