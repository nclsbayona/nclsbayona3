<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The best way to predict the future is to create it.' was translated to gungan language, and the result is: 'Dha best way to predict dha future is to create it.'
        </h5>
