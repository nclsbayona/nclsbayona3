<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Winning is nice if you don't lose your integrity in the process.' was translated to oldenglish language, and the result is: ' {Winning} {is} {nice} yonder êower {don't} ârian êower trumnes birihte ðone as {process}.'
        </h5>
