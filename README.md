<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Success is not to be pursued, it is to be attracted by the person you become.' was translated to oldenglish language, and the result is: ' {Success} {is} nâteðæshwôn oðferian w¯ære {pursued}, sê {is} stêpan bêo {attracted} forð forðbie duguð hâd êow byrian.'
        </h5>
