<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'It doesn't matter if the glass is half empty or half full. Be grateful you have a glass - you're the only person that can decide what's in it.' was translated to valyrian language, and the result is: 'Daoriot jemas lo se glass iksos half doru nykeā half lēda. Sagon grateful ao emagon nykeā glass - ao sagon se mērī issaros bona kostagon decide skoros's isse ziry.'
        </h5>
