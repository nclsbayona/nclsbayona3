<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'It wasn't raining when Noah built the ark..' was translated to oldenglish language, and the result is: ' {It} {wasn't} {raining} yonder {Noah} {built} wægn ðellfæsten.'
        </h5>
