<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'In all chaos there is a cosmos, in all disorder a secret order.' was translated to vulcan language, and the result is: 'Svi' ek' nezhak tra' nam-tor wuh stukhtra,  svi' ek' disorder wuh tsat zek.'
        </h5>
