<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'In order to carry a positive action, we must develop here a positive vision.' was translated to sith language, and the result is: 'Kash tvarka kia gaben zo dozitvus zygis,  mes must develop stai zo dozitvus vaizdas.'
        </h5>
