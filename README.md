<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'It doesn't matter if the glass is half empty or half full. Be grateful you have a glass - you're the only person that can decide what's in it.' was translated to sindarin language, and the result is: 'Ha doesn't ron if i heled na- pher lost ben pher pant. N- grateful cin gar- a heled - cin're i onlui gweg i tur- decide what's in ha.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                21.95°C, however it feels like 21.9°C, climate is
                <i>broken clouds</i>
            .
