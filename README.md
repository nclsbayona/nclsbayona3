<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you are going to achieve excellence in big things, you develop the habit in little matters.' was translated to minion language, and the result is: 'asa to nama pata da nampip excellence een boma errec, to kaypac ta habit een ipo myeh.'
        </h5>
