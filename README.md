<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The shoe that fits one person pinches another; there is no recipe for living that suits all cases.' was translated to gungan language, and the result is: 'Dha shoe dat fits una person pinches another; dalee is nosa recipe for liv dat suits all cases.'
        </h5>
