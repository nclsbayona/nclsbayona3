<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Ancient Rule of Twenty-one: if you do anything for twenty-one days in a row, it will be installed as a habit.' was translated to yoda language, and the result is: 'Anything for twenty-one days in a row,  ancient rule of twenty-one: if you do,Installed as a habit,  it will be.'
        </h5>
...
Garnish with a couple of lavender sprigs
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                16.08°C, however it feels like 15.65°C, climate is
                <i>broken clouds</i>
            .
