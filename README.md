<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Your success will not be determined by your gender or your ethnicity, but only on the scope of your dreams and your hard work to achieve them.' was translated to gungan language, and the result is: 'Yous success will not be determined by yous gender or yous ethnicity,  but only on dha scope of yous dreams and yous hard work to achieve them-sa.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                13.11°C, however it feels like 12.77°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 13.11°C
            Max. temperature: 13.11°C
        </p>
    </div>
    <div id="wakatime">
        <p>
