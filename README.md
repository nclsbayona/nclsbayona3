<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'When you say yes to change, you are choosing to navigate that path peacefully and happily and see where it takes you.' was translated to cheunh language, and the result is: 'Veo vah ber mar ch'at lin'tah'ah,  vah are choosing ch'at ch'iszacosah csei vum tis vim happily vim veb veah hah takes vah.'
        </h5>
