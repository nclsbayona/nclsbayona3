<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'To lose your temper is only useful once a year.' was translated to pirate language, and the result is: 'To lose yer temper be only useful once a year.'
        </h5>
