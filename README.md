<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'What would life be if we had no courage to attempt anything? ' was translated to yoda language, and the result is: 'Be if we had no courage to attempt anything,  what would life?'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                11.47°C, however it feels like 11.18°C, climate is
                <i>overcast clouds</i>
            .
