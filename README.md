<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'No man is free who is not master of himself.' was translated to dothraki language, and the result is: 'Vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) mahrazh is seris fin is vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) master ki himself.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                15.35°C, however it feels like 15°C, climate is
                <i>broken clouds</i>
            .
            Min. temperature: 15.35°C
            Max. temperature: 15.35°C
        </p>
    </div>
    <div id="wakatime">
        <p>
