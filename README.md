<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Any fool can paint a picture, but it takes a wise man to be able to sell it.' was translated to pirate language, and the result is: 'Any addlepate can paint a picture, but it takes a wise lubber t' be able t' sell it.'
        </h5>
