<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Don't bother people for help without first trying to solve the problem yourself.' was translated to sith language, and the result is: 'Virt'ne listi tauta nuo tarnas lauke karuvis trying kia solve tave kezjumas tu'saen.'
        </h5>
