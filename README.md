<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Just do what must be done. This may not be happiness but it is greatness.' was translated to dothraki language, and the result is: 'Disse hash fini eth be done. Jinak may vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) be happiness vosma anna is athvezhvenar.'
        </h5>
