<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'We have more possibilities available in each moment than we realize.' was translated to ferblatin language, and the result is: 'We ave-herb ore-merb ossibilities-perb vailable-aerb in ach-eerb oment-merb han-terb we realize. '
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                14.23°C, however it feels like 13.93°C, climate is
                <i>light rain</i>
            .
            Min. temperature: 14.23°C
            Max. temperature: 14.23°C
        </p>
    </div>
    <div id="wakatime">
        <p>
