<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'A good master leads you to the true master within. Only that master, who is your own higher self, can adequately answer all questions.' was translated to minion language, and the result is: 'a leelas abaqi uh to da ta ods abaqi wopa.  solo pak abaqi, yob tis tu mio diflax sok, pudum nthwap simpli tadda twocot.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                15.95°C, however it feels like 15.74°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 15.95°C
            Max. temperature: 15.95°C
        </p>
    </div>
    <div id="wakatime">
        <p>
