<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Life is a succession of lessons, which must be lived to be understood.' was translated to huttese language, and the result is: 'Life sa do succession of lessons,  which must be lived tah be understood.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                10.04°C, however it feels like 9.58°C, climate is
                <i>overcast clouds</i>
            .
