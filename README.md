<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'It's the job that's never started that takes the longest to finish.' was translated to vulcan language, and the result is: 'Ish-veh's wuh job ik's worla palikau ik nem-tor wuh longest tor shaht.'
        </h5>
