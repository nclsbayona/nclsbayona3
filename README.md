<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you're changing the world, you're working on important things. You're excited to get up in the morning.' was translated to pirate language, and the result is: 'If ye're changin' th' world, ye're workin' on important thin's.  ye're excited t' get up in th' mornin'.'
        </h5>
...
Served In a chilled, salt-rimmed glass
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                12.84°C, however it feels like 12.43°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 12.84°C
            Max. temperature: 12.84°C
        </p>
    </div>
    <div id="wakatime">
        <p>
    ...
    <tbody>
        <tr>
            ...
            <td style="padding-left: 1em; padding-right: 1em; text-align: center; vertical-align: top">4 hours and 51 minutes</td>
        </tr>
        <tr>
