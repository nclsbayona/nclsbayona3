<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Show kindness but never expect it. Show authenticity but never expect it. Only the wise are indifferent to things they can't control.' was translated to gungan language, and the result is: 'Show kindness but never expect it. Show authenticity but never expect it. Only dha wise are indifferent to things desa can't control.'
        </h5>
