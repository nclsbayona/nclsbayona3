<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The past does not equal the future' was translated to klingon language, and the result is: 'The past does not equal the future'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                15.33°C, however it feels like 14.98°C, climate is
                <i>broken clouds</i>
            .
            Min. temperature: 15.33°C
            Max. temperature: 15.33°C
        </p>
    </div>
    <div id="wakatime">
        <p>
