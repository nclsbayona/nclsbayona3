<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'All courses of action are risky, so prudence is not in avoiding danger (it's impossible), but calculating risk and acting decisively. Make mistakes of ambition and not mistakes of sloth. Develop the strength to do bold things, not the strength to suffer.' was translated to oldenglish language, and the result is: ' {All} {courses} un−l¯æd âtyhting rôðres {risky}, adverbial phrases wærscipe {is} ne fram orde oð ende {avoiding} wôda {(it's} {impossible)}, ge {calculating} nêðan fullan {acting} {decisively}. {Make} {mistakes} of rîcetere eornostlîce ne {mistakes} orgilde sl¯æwð. {Develop} dôð strengu ben¯æman timbran ofermôdlic {things}, ne duguð trymð f¯ætan âlibban.'
        </h5>
