<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Everything has cracks - that's how the light gets in' was translated to oldenglish language, and the result is: ' {Everything} {has} {cracks} {-} {that's} tôhwega and sê lêohtlic {gets} into'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                18.73°C, however it feels like 17.23°C, climate is
                <i>broken clouds</i>
            .
