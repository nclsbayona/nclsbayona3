<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'It’s what you practice in private that you will be rewarded for in public' was translated to yoda language, and the result is: 'Rewarded for in public,  it’s what you practice in private that you will be'
        </h5>
...
Do Ahead: Rosé can be frozen 1 week ahead.
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                14.88°C, however it feels like 14.49°C, climate is
                <i>light rain</i>
            .
            Min. temperature: 14.88°C
            Max. temperature: 14.88°C
        </p>
    </div>
    <div id="wakatime">
        <p>
