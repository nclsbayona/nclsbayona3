<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Many roads lead to the path, but basically there are only two: reason and practice. ' was translated to gungan language, and the result is: 'Many roads lead to dha path,  but basically dalee are only duey: reason and practice.'
        </h5>
