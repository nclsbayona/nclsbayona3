<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The last time doesn't exist. It's only this time. And everything is going to be different this time. There's only now.' was translated to minion language, and the result is: 'ta tepo veela hapire cut.  pik's solo ba veela.  yee midoo tis pata da be filava ba veela.  bada's solo prompo.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                15.56°C, however it feels like 14.76°C, climate is
                <i>few clouds</i>
            .
