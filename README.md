<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Life is about choice. You can choose to be a victim or anything else you like to be.' was translated to klingon language, and the result is: 'Yin is about wiv. Tlhih can wiv to qu' a victim qoj vay' else tlhih parha' to qu'.'
        </h5>
