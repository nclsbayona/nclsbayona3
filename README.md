<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If the plan doesn't work, change the plan, but never the goal.' was translated to minion language, and the result is: 'asa ta eth hapire traba, greebo ta eth, pelo nopa ta up.'
        </h5>
