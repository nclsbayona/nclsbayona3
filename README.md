<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Failure is just another way to learn how to do something right' was translated to oldenglish language, and the result is: ' {Failure} {is} rihtlic {another} sîðfat wiðtêon onfindan hwæt−hwugu stellan âðrôwian sum inde rihtwîs righteous'
        </h5>
