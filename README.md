<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you want to make your dreams come true, the first thing you have to do is wake up.' was translated to yoda language, and the result is: 'To make your dreams come true,  if you want,To do is wake up,  the first thing you have.'
        </h5>
