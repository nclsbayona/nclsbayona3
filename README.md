<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Whenever we’re afraid, it’s because we don’t know enough. If we understood enough, we would never be afraid' was translated to oldenglish language, and the result is: ' {Whenever} {we’re} fyrht, {it’s} hûru we {don’t} forcunnian nôg. {If} attraction with pron ðe ic {understood} nôg, we {would} nâ bêo fyrht'
        </h5>
