<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Perfection is not attainable, but if we chase perfection we can catch excellence..' was translated to pig-latin language, and the result is: 'erfection-Pay is-way ot-nay attainable-way, ut-bay if-way e-way ase-chay erfection-pay e-way an-cay atch-cay excellence.. '
        </h5>
