<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'When I was a little kid, I was really scared of the dark. But then I came to understand, dark just means the absence of photons in the visible wavelength 400 to 700 nanometers. Then I thought, well it's really silly to be afraid of a lack of photons. Then I wasn't afraid of the dark anymore after that.' was translated to pirate language, and the result is: 'When I were bein' a little kid, I were bein' really scared o' th' dark, ye scurvey dog.  But then I came t' understand, dark just means th' absence o' photons in th' visible wavelength 400 t' 700 nanometers.  Splice the mainbrace!  Walk the plank! Then I thought, well 'tis really silly t' be afraid o' a lack o' photons.  Then I weren't afraid o' th' dark anymore aft that.'
        </h5>
