<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'You must find the place inside yourself where nothing is impossible.' was translated to oldenglish language, and the result is: ' {You} must  duguð sciftan læppa {yourself} thither nân n¯ænne {is} unêaðelic.'
        </h5>
