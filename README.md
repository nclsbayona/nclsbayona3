<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If everything was easy you'd be bored' was translated to oldenglish language, and the result is: ' {If} ðý {was} gearolîce {you'd} sý {bored}'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                15.39°C, however it feels like 14.81°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 15.39°C
            Max. temperature: 15.39°C
        </p>
    </div>
    <div id="wakatime">
        <p>
