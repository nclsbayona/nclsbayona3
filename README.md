<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'An empty head is not really empty; it is stuffed with rubbish. Hence the difficulty of forcing anything into an empty head.' was translated to cheunh language, and the result is: 'An ch'itt'csin vit carcir nah var ch'itt'csin; hah carcir stuffed bah csob. Bah na ch'at ch'itkisetasi bah forcing ei can (bah accusative) an ch'itt'csin vit.'
        </h5>
