<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Better to have, and not need, than to need, and not have.' was translated to pig-latin language, and the result is: 'etter-Bay o-tay ave-hay, and-way ot-nay eed-nay, an-thay o-tay eed-nay, and-way ot-nay ave-hay. '
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                15.72°C, however it feels like 15.07°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 15.72°C
            Max. temperature: 15.72°C
        </p>
    </div>
    <div id="wakatime">
        <p>
