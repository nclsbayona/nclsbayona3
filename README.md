<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Either you run the day or the day runs you.' was translated to klingon language, and the result is: 'Ghap tlhih qet the jaj qoj the jaj runs tlhih.'
        </h5>
