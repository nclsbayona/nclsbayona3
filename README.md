<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you can't feed a hundred people, then feed just one.' was translated to oldenglish language, and the result is: ' {If} êow {can't} underberan a hund hero, ðonne and oncennan dômfæst ðurhscînendlic.'
        </h5>
