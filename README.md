<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Even if our home burns down we can rebuild it. But the things that we got for nothing, we can never replace.' was translated to sindarin language, and the result is: 'Even if mín bar burns dad mín tur- rebuild ha. But i things i mín got an nothing,  mín tur- never replace.'
        </h5>
