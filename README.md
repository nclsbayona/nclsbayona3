<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'It is only depth of character that determines the profundity with which we face life.' was translated to oldenglish language, and the result is: ' {It} {is} forð forth dêopnes un−l¯æd môdstaðol landriht 'land−right {determines} wægn smêalicnes wið ðês we blêoum willa.'
        </h5>
