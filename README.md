<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Beyond a certain point there is no return. This point has to be reached.' was translated to vulcan language, and the result is: 'Mesakh wuh ac'ruth sfek tra' nam-tor rai fun. Nash sfek has tor nam-tor pulau.'
        </h5>
