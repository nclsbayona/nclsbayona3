<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Humor isn't for everyone. It's only for people who want to have fun, enjoy life, and feel alive.' was translated to mandalorian language, and the result is: 'Humor isn't par anade. Bic's shi par droten tion'ad copaanir ganar nuhur,  haili cetare life,  bal aalar oyayc.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                17.48°C, however it feels like 17.01°C, climate is
                <i>broken clouds</i>
            .
            Min. temperature: 17.48°C
            Max. temperature: 17.48°C
        </p>
    </div>
    <div id="wakatime">
        <p>
