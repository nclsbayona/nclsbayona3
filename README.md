<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Keep a positive mind. Remember, a failed attempt doesn't make you a failure-giving up does.' was translated to oldenglish language, and the result is: ' {Keep} tîma {positive} hygd. {Remember}, dimf b¯æm {failed} beginnan {doesn't} r¯æran êower tîma {failure-giving} uppe {does}.'
        </h5>
