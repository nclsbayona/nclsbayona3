<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'All courses of action are risky, so prudence is not in avoiding danger (it's impossible), but calculating risk and acting decisively. Make mistakes of ambition and not mistakes of sloth. Develop the strength to do bold things, not the strength to suffer.' was translated to mandalorian language, and the result is: 'An courses be nari are risky,  bid prudence is not o'r avoiding buruk (bic's impossible),  al calculating risk bal acting decisively. Gotal'ur mistakes be copad bal not mistakes be sloth. Develop te kot brokar vaabir bold kebise,  not te kot brokar suffer.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                14.06°C, however it feels like 13.82°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 14.06°C
            Max. temperature: 14.06°C
        </p>
    </div>
    <div id="wakatime">
        <p>
