<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'What's right is what's left if you do everything else wrong.' was translated to pirate language, and the result is: 'What's right be what's left if ye do everythin' else wrong.'
        </h5>
