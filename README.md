<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Stress is like a pulse, if you have it you are alive.' was translated to pig-latin language, and the result is: 'ess-Stray is-way ike-lay a-way ulse-pay, if-way ou-yay ave-hay it-way ou-yay are-way alive-way. '
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                11.44°C, however it feels like 11.12°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 11.44°C
            Max. temperature: 11.44°C
        </p>
    </div>
    <div id="wakatime">
        <p>
