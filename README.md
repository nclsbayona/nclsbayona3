<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'When there is no distraction, there is clarity.' was translated to dothraki language, and the result is: 'Kash rekke is vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) distraction,  rekke is clarity.'
        </h5>
