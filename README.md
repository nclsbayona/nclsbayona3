<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Would you rather learn to deal with the truth now than be forced to do so later on?' was translated to vulcan language, and the result is: 'Would du rather oren-tor tor deal k' wuh yeht'es i' do nam-tor punekwitau tor tor ni later fi'?'
        </h5>
