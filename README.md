<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The last time doesn't exist. It's only this time. And everything is going to be different this time. There's only now.' was translated to gungan language, and the result is: 'Dha last time doesn't exist. It's only disa time. And everyth is goen besa different disa time. Dalee's only now.'
        </h5>
