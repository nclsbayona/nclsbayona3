<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you run you stand a chance of losing, but if you don't run you've already lost.' was translated to dothraki language, and the result is: 'If yeri run yeri stand a chance ki losing,  vosma if yeri don't run yeri've ray lei.'
        </h5>
