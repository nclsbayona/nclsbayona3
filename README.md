<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Vision without action is daydream. Action without vision is nightmare..' was translated to oldenglish language, and the result is: ' {Vision} ûte ingehygdnes {is} {daydream}. {Action} ð¯ærûte lêorednes {is} ælfâdl.'
        </h5>
