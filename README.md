<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you aren't sure which way to do something, do it both ways and see which works better.' was translated to valyrian language, and the result is: 'Lo ao aren't sure skore ñuhoso naejot gaomagon mirros,  gaomagon ziry both ways se ūndegon skore works sȳrkta.'
        </h5>
