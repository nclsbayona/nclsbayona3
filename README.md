<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'It still holds true that man is most uniquely human when he turns obstacles into opportunities.' was translated to oldenglish language, and the result is: ' {It} rôw {holds} fullgearwian ðone as mæcg {is} best {uniquely} mennisclic mid mâl {turns} {obstacles} binnan {opportunities}.'
        </h5>
