<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Always render more and better service than is expected of you, no matter what your task may be.' was translated to dothraki language, and the result is: 'Ayyey render alikh ma better service than is expected ki yeri,  vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) matter fini yeri thikh may be.'
        </h5>
