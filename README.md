<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'That some achieve great success is proof to all that others can achieve it as well.' was translated to klingon language, and the result is: ''e' 'op chav qu' qapla' is proof to hoch 'e' others can chav 'oh as toh.'
        </h5>
