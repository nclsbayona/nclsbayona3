<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'I learned that courage was not the absence of fear, but the triumph over it. The brave man is not he who does not feel afraid, but he who conquers that fear.' was translated to oldenglish language, and the result is: ' ic pro scearp sharp landriht 'land−right ðrýð {was} ne wægn æfweardnes of wênan, forð¯æm sê sîgefæstnes burgtûn hit hê. {The} swîðmôd sund−bûende {is} nâ swilc ðe {does} ne frêdan fyrht, swâðêana mâl ðêos {conquers} ðætte fyrht−an.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                9.24°C, however it feels like 9.24°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 9.24°C
            Max. temperature: 9.24°C
        </p>
    </div>
    <div id="wakatime">
        <p>
