<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'You can do it' was translated to oldenglish language, and the result is: ' {You} canne timbrian ðæge pro'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                15.47°C, however it feels like 15.27°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 15.47°C
            Max. temperature: 15.47°C
        </p>
    </div>
    <div id="wakatime">
        <p>
