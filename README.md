<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'You make a difference in the world by simply existing in it' was translated to vulcan language, and the result is: 'Du tor wuh natyan svi' wuh panu k' veling existing svi' ish-veh'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                12.11°C, however it feels like 11.7°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 12.11°C
            Max. temperature: 12.11°C
        </p>
    </div>
    <div id="wakatime">
        <p>
