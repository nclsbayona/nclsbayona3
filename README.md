<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Remove the temptation to settle for anything short of what you deserve.' was translated to pirate language, and the result is: 'Remove th' temptation t' settle fer anythin' short o' what ye deserve.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                17.52°C, however it feels like 17.08°C, climate is
                <i>light rain</i>
            .
            Min. temperature: 17.52°C
            Max. temperature: 17.52°C
        </p>
    </div>
    <div id="wakatime">
        <p>
    ...
    <tbody>
        <tr>
            ...
            <td style="padding-left: 1em; padding-right: 1em; text-align: center; vertical-align: top">7 hours and 17 minutes</td>
        </tr>
        <tr>
            <td style="padding-left: 1em; padding-right: 1em; text-align: center; vertical-align: top">Dart</td>
            <td style="padding-left: 1em; padding-right: 1em; text-align: center; vertical-align: top">3 hours and 7 minutes</td>
        </tr>
        <tr>
    ...
    <tbody>
        <tr>
            ...
            <td style="padding-left: 1em; padding-right: 1em; text-align: center; vertical-align: top">11 hours and 46 minutes</td>
        </tr>
    </tbody>
</table>
        <hr>
