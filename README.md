<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Success is doing what you want to do, when you want, where you want, with whom you want, as much as you want.' was translated to dothraki language, and the result is: 'Success is doing fini yeri want to hash,  kash yeri want,  finne yeri want,  ma whom yeri want,  ven san ven yeri want.'
        </h5>
