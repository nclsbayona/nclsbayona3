<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'You cannot control the behavior of others, but you can always choose how you respond to it.' was translated to oldenglish language, and the result is: ' {You} {cannot} âge ðone as {behavior} râd {others}, lôca in êower canne forðgesceaft cêosan hû êower {respond} wîte ðæge pro.'
        </h5>
