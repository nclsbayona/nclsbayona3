<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'We must not be afraid of dreaming the seemingly impossible if we want the seemingly impossible to become a reality.' was translated to minion language, and the result is: 'alsmiklo non be telwab mud dreaming ta edskoi alaoh asa alsquer ta edskoi alaoh da phidue a tajpen.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                12.66°C, however it feels like 12.41°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 12.66°C
            Max. temperature: 12.66°C
        </p>
    </div>
    <div id="wakatime">
        <p>
