<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Stop creating a life that you need a vacation from. Instead move to where you want to live, do what you want to do, start what you want to start and create the life you want today. This isn't rehearsal people. This is YOUR life.' was translated to oldenglish language, and the result is: ' {Stop} {creating} weargbr¯æde lîffæc ðe êower 3 ðearf tîma {vacation} setlan. {Instead} sprangettan âweorpan ð¯ær and there êow brýc−ian ongeniman winnan, âræfnan {what} êower 3 ðearf ben¯æman full−fremman, styrtan {what} êow ðurfon (gyden steort s sifeða gearwian duguð ferhðsefa êower forððêon {today}. {This} {isn't} {rehearsal} m¯ægð. {This} {is} {YOUR} bl¯æd.'
        </h5>
