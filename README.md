<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Living a life that has a greater purpose and living up to it is the ultimate degree that we should strive for.' was translated to oldenglish language, and the result is: ' {Living} twihynde brêostsefa ðætte {has} hlêg {greater} seht êac lîfwelle ûpweardes âîeðan sê {is} sê {ultimate} tôendebyrdnes landriht 'land−right we {should} hogian sifeða.'
        </h5>
