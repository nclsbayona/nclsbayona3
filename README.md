<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'When you win, say nothing. When you lose, say less.' was translated to oldenglish language, and the result is: ' {When} êow wyrht, forcweðan —. {When} êow belêosan, forhycgan l¯æs.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                18.02°C, however it feels like 17.42°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 18.02°C
            Max. temperature: 18.02°C
        </p>
    </div>
    <div id="wakatime">
        <p>
