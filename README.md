<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'A little progress each day adds up to big results.' was translated to vulcan language, and the result is: 'Wuh pi' progress tik gad hau abru tor suk' results.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                8.68°C, however it feels like 8.68°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 8.68°C
            Max. temperature: 8.68°C
        </p>
    </div>
    <div id="wakatime">
        <p>
