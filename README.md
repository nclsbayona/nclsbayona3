<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Whenever we’re afraid, it’s because we don’t know enough. If we understood enough, we would never be afraid' was translated to oldenglish language, and the result is: ' {Whenever} {we’re} forht, {it’s} witodlic attraction with pron ðe ic {don’t} sêon +nðh. {If} attraction with pron ðe ic {understood} nôg, attraction with pron ðe ic {would} n¯æfre cûð forhtlic'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                16.12°C, however it feels like 16.01°C, climate is
                <i>overcast clouds</i>
            .
