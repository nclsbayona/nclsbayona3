<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'To handle yourself, use your head; to handle others, use your heart.' was translated to oldenglish language, and the result is: ' {To} hilte {yourself}, nêotan êower hafela; st¯ælan mistûcian {others}, nytt êower hiertan.'
        </h5>
