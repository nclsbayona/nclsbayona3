<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'When it comes to winning, you need the skill and the will.' was translated to minion language, and the result is: 'yeh pik oda da boses, to con ta sh yee ta sama.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                16.67°C, however it feels like 16.01°C, climate is
                <i>broken clouds</i>
            .
            Min. temperature: 16.67°C
            Max. temperature: 16.67°C
        </p>
    </div>
    <div id="wakatime">
        <p>
