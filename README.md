<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The goal of an artist is to create the definitive work that cannot be surpassed.' was translated to sith language, and the result is: 'Tave goal iv jri artist kash kia evita tave definitive savaka anas galetis buti surpassed.'
        </h5>
