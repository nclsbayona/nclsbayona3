<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you want to test your memory, try to recall what you were worrying about one year ago today.' was translated to ferblatin language, and the result is: 'If ou-yerb ant-werb to est-terb our-yerb emory-merb, ry-terb to ecall-rerb hat-werb ou-yerb ere-werb orrying-werb bout-aerb ne-oerb ear-yerb go-aerb today. '
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                11.64°C, however it feels like 11.16°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 11.64°C
            Max. temperature: 11.64°C
        </p>
    </div>
    <div id="wakatime">
        <p>
