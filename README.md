<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Life is like playing the violin in public and learning the instrument as one goes on.' was translated to yoda language, and the result is: 'Like playing the violin in public and learning the instrument as one goes on,  life is.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                15.89°C, however it feels like 15.75°C, climate is
                <i>moderate rain</i>
            .
            Min. temperature: 15.89°C
            Max. temperature: 15.89°C
        </p>
    </div>
    <div id="wakatime">
        <p>
