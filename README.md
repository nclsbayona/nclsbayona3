<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'In all chaos there is a cosmos, in all disorder a secret order.' was translated to minion language, and the result is: 'een tadda elm bada tis a cosmos, een tadda disorder a idsleg fog.'
        </h5>
