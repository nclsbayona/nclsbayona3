<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Learn from the rejection and turn it into an opportunity!' was translated to huttese language, and the result is: 'Learn tuta doe rejection um moova it into an opportunity!'
        </h5>
