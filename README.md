<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Numbing the pain for a while will only make it worse when you finally feel it.' was translated to pig-latin language, and the result is: 'umbing-Nay e-thay ain-pay or-fay a-way ile-whay ill-way only-way ake-may it-way orse-way en-whay ou-yay inally-fay eel-fay it-way. '
        </h5>
...
Garnish with 5 drops habanero tincture.
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                14.4°C, however it feels like 13.98°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 14.4°C
            Max. temperature: 14.4°C
        </p>
    </div>
    <div id="wakatime">
        <p>
