<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'A quitter never wins and a winner never quits' was translated to oldenglish language, and the result is: ' oferhlýp {quitter} nese {wins} ðêah−hwæðere bêgra {winner} nese {quits}'
        </h5>
