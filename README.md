<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Many roads lead to the path, but basically there are only two: reason and practice. ' was translated to pirate language, and the result is: 'Many seas lead t' th' path, but basically there be only two: reason and practice.  '
        </h5>
