<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'In nature there is no alienation. Everything belongs.' was translated to dothraki language, and the result is: 'She nature rekke is vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) alienation. Everything belongs.'
        </h5>
