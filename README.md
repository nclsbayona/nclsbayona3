<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'In youth we run into difficulties. In old age difficulties run into us. ' was translated to oldenglish language, and the result is: ' {In} swân attraction with pron ðe ic hlêapan wiðinnan {difficulties}. {In} hâr ealdung {difficulties} ðr¯ægan sb ûs of pro ic. '
        </h5>
