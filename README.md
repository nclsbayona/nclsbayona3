<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Act the way you want to be and soon you'll be the way you act.' was translated to dothraki language, and the result is: 'Tikh the way yeri want to be ma qisi yeri'll be the way yeri tikh.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                9.84°C, however it feels like 9.84°C, climate is
                <i>few clouds</i>
            .
            Min. temperature: 9.84°C
            Max. temperature: 9.84°C
        </p>
    </div>
    <div id="wakatime">
        <p>
