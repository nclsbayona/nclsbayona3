<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Great thoughts speak only to the thoughtful mind, but great actions speak to all mankind.' was translated to oldenglish language, and the result is: ' {Great} mâðmcleofa cweðan ânstreces âstellan dôð ðancol brêostsefa, ðâ hrôr {actions} clipian from− {all} mancynn.'
        </h5>
