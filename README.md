<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'An aspirational diet will have you dreaming of success; but it's the attachment of expectations and tangible goals that feeds the desire, persistence, and fortitude required to make the win.' was translated to oldenglish language, and the result is: ' {An} {aspirational} {diet} setnes of−gân êow {dreaming} râd forweaxan; verb {it's} duguð {attachment} orgilde {expectations} eornostlîce grâpigendlic {goals} ðe {feeds} sê mynle, mâhnes, for ðâm ðe strengu {required} n¯æman wealdan and dôð earnian.'
        </h5>
