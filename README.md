<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you want to be successful, you have to jump, there's no way around it.' was translated to gungan language, and the result is: 'If yousa want besa successful,  yousa have to jump,  dalee's nosa way around it.'
        </h5>
