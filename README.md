<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'You can do it' was translated to sith language, and the result is: 'Tu gal isar zhol'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                10.71°C, however it feels like 10.16°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 10.71°C
            Max. temperature: 10.71°C
        </p>
    </div>
    <div id="wakatime">
        <p>
