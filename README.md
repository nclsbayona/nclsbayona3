<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The best way to predict your future is to create it.' was translated to dothraki language, and the result is: 'The best way to predict yeri future is to create anna.'
        </h5>
