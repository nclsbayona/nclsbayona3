<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'You are not the drop in the ocean, but the ocean in the drop.' was translated to dothraki language, and the result is: 'Yeri are vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) the drop she the ocean,  vosma the ocean she the drop.'
        </h5>
