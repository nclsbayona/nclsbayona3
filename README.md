<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Don't use all-or-nothing thinking. Take each day as its own day, and don't worry about it if you mess up one day. The most important thing you can do is just get back up on the horse.' was translated to oldenglish language, and the result is: ' {Don't} nêotan {all-or-nothing} {thinking}. {Take} ân tôdæge samðe in phrase samðsamð sîn âl¯ætan dægtîma, for ðâm ðe {don't} wyrgan of ðæge pro yonder êow {mess} ûpweardes wuldorfæst dôgor. {The} best hêalic wafung êower canne cwylmian {is} rihtlic overtake bæclinga ûpweardes âdôn wægn blanca.'
        </h5>
