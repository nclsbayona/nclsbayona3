<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The shoe that fits one person pinches another; there is no recipe for living that suits all cases.' was translated to oldenglish language, and the result is: ' {The} calc ðæt {fits} ûphêah hâd {pinches} {another}; {there} {is} nâh−w¯ær {recipe} meltan feorhlic ' right to own or occupy land or connected with its occupation {suits} {all} {cases}.'
        </h5>
