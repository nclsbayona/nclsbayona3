<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'A mistake is only an error, it becomes a mistake when you fail to correct it.' was translated to pirate language, and the result is: 'A mistake be only an error, it becomes a mistake when ye fail t' correct it.'
        </h5>
