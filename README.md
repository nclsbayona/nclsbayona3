<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'I begin with an idea and then it becomes something else.' was translated to pirate language, and the result is: 'I begin with an idea and then it becomes somethin' else.'
        </h5>
