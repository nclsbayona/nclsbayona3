<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Hope is not a strategy. Luck is not a factor. Fear is not an option.' was translated to dothraki language, and the result is: 'Athzalar is vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) a strategy. Luck is vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) a factor. Athrokhar is vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) an option.'
        </h5>
