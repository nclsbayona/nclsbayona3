<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Happiness can be found, even in the darkest of times, if one only remembers to turn on the light.' was translated to vulcan language, and the result is: 'Happiness mokuhlek nam-tor afer-tor,  kauk svi' wuh darkest t' wak,  kuv veh goh vokau tor da-tor fi' wuh ta'hal.'
        </h5>
