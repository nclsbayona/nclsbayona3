<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Every defeat, every heartbreak every loss, contains its own seed, its own lesson on how to improve your performance the next time.' was translated to pirate language, and the result is: 'Every defeat, every heartbreak every loss, contains its own seed, its own lesson on how t' improve yer performance th' next time.'
        </h5>
