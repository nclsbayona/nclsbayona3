<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'A good master leads you to the true master within. Only that master, who is your own higher self, can adequately answer all questions.' was translated to oldenglish language, and the result is: ' âbêcêdê weorðscipe âgniend {leads} êower setlan wægn swêg hlâford wiðinnan. {Only} ðæt âgniend, ðês {is} êower self yferra self, canne {adequately} ûtlagian {all} {questions}.'
        </h5>
