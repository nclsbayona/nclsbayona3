<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'You just can't beat the person who never gives up. ' was translated to pig-latin language, and the result is: 'ou-Yay ust-jay can't eat-bay e-thay erson-pay o-whay ever-nay ives-gay up-way.  '
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                16.13°C, however it feels like 15.7°C, climate is
                <i>broken clouds</i>
            .
            Min. temperature: 16.13°C
            Max. temperature: 16.13°C
        </p>
    </div>
    <div id="wakatime">
        <p>
