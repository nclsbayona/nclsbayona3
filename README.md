<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you don't like something, change it. If you can't change it, change your attitude.' was translated to oldenglish language, and the result is: ' {If} êower {don't} onlic âhwæðer, onwendan hit hê. {If} êower {can't} onwendan man, ymbwendnes êower {attitude}.'
        </h5>
