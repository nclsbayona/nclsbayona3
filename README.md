<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The only problem we really have is we think we're not supposed to have problems! Problems call us to higher level- - face &amp; solve them now!' was translated to dothraki language, and the result is: 'The disse problem kisha sekke hash is kisha think kisha're vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) supposed to hash problems! Problems call us to higher level- - hatif'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                18.56°C, however it feels like 17.93°C, climate is
                <i>broken clouds</i>
            .
