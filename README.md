<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Have the courage to be ignorant of a great number of things, in order to avoid the calamity of being ignorant of everything.' was translated to sindarin language, and the result is: 'Gar- i huor na n- ignorant -o a beleg gwanod -o things,  in conn- na avoid i calamitui -o being ignorant -o everything.'
        </h5>
