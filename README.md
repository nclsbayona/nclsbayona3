<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Stop acting so small. You are the universe in ecstatic motion.' was translated to oldenglish language, and the result is: ' {Stop} {acting} adverbial phrases min. {You} m¯æðrian dôð têoh hwonne {ecstatic} tyht.'
        </h5>
