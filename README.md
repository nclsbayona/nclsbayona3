<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Everything has cracks - that's how the light gets in' was translated to oldenglish language, and the result is: ' {Everything} {has} {cracks} {-} {that's} medmicel ðone as beorht {gets} fram orde oð ende'
        </h5>
