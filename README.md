<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'When I was a little kid, I was really scared of the dark. But then I came to understand, dark just means the absence of photons in the visible wavelength 400 to 700 nanometers. Then I thought, well it's really silly to be afraid of a lack of photons. Then I wasn't afraid of the dark anymore after that.' was translated to oldenglish language, and the result is: ' {When} attraction with pron ðe ic {was} wýscan lýtel hêcen, ic pro {was} sôðe {scared} râd sê blind. {But} siððan ic pro {came} f¯ætan forcýðan, lêohtlêas sôðfæst scildnes ðone as for−l¯ætennes orgilde {photons} ongêanweard duguð sewenlic {wavelength} {400} ongen¯æman {700} {nanometers}. {Then} ic pro , tela {it's} sôðe un−nyt frambringan w¯ære forhtlic orgilde a wana orgilde {photons}. {Then} ic pro {wasn't} forhtlic râd sê ðêostorlic {anymore} lang landriht 'land−right.'
        </h5>
