<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Alone we can do so little; together we can do so much.' was translated to sindarin language, and the result is: 'Eriol mín tur- ceri- so dilthen; go- mín tur- ceri- so limb.'
        </h5>
