<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'At that point where you have decided to upgrade from aspiration to expectation and have begun to visualize an outcome, something incredibly important has happened, you have committed to the process of change.' was translated to sindarin language, and the result is: 'At i ravan where cin gar- decided na upgrade o aspiration na expectation a gar- begun na visualize an outcome,  something incrediblui important has happened,  cin gar- committed na i process -o change.'
        </h5>
