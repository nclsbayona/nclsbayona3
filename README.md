<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Happiness can be found, even in the darkest of times, if one only remembers to turn on the light.' was translated to dothraki language, and the result is: 'Happiness laz be found,  akka she the darkest ki times,  if ato disse remembers to turn she the shekhikh.'
        </h5>
