<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The best way to predict the future is to create it.' was translated to pirate language, and the result is: 'th' best way t' predict th' future be t' create it.'
        </h5>
