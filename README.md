<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'You must have a positive self perception in order to transcend anything.' was translated to klingon language, and the result is: 'Tlhih must ghaj a positive self perception in 'obe' to transcend vay'.'
        </h5>
