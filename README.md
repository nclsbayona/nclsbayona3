<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Have a vision, trust yourself, break some rules, ignore the naysayers, don't be afraid to fail.' was translated to klingon language, and the result is: 'Ghaj a vision,  voq yourself,  len 'op rules,  busha' the naysayers,  don't qu' afraid to luj.'
        </h5>
