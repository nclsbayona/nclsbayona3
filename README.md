<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Somewhere between the bottom of the climb and the summit is the answer to the mystery why we climb.' was translated to oldenglish language, and the result is: ' {Somewhere} onmiddan ðone as staðolfæstnung orgilde duguð climban meltan sê hnoll {is} sê wiernan forwards duguð rûn only found in adverbial phrases like 'tô hwon attraction with pron ðe ic clymmian.'
        </h5>
    ...
    <tbody>
        <tr>
            ...
            <td style="padding-left: 1em; padding-right: 1em; text-align: center; vertical-align: top">15 hours and 34 minutes</td>
        </tr>
        <tr>
    ...
    <tbody>
        <tr>
            ...
            <td style="padding-left: 1em; padding-right: 1em; text-align: center; vertical-align: top">15 hours and 46 minutes</td>
        </tr>
    </tbody>
</table>
        <hr>
