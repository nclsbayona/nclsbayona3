<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Vulnerability is not winning or losing; it's having the courage to show up and be seen when we have no control over the outcome.' was translated to oldenglish language, and the result is: ' {Vulnerability} {is} hnot {winning} oððon {losing}; {it's} twihynde duguð gielping besettan bemeldian uppe adverbial phrases cunnon sîene sôna attraction with pron ðe ic âgnod n¯æfre eorðwela bufan dôð ûtan−cumen.'
        </h5>
