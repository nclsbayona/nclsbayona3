<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'You are a function of what the whole universe is doing in the same way that a wave is a function of what the whole ocean is doing.' was translated to sindarin language, and the result is: 'Cin are a function -o what i whole universe na- doing in i same té i a falf na- a function -o what i whole aear na- doing.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                0.73°C, however it feels like -0.98°C, climate is
                <i>fog</i>
            .
            Min. temperature: 0.73°C
            Max. temperature: 0.73°C
        </p>
    </div>
    <div id="wakatime">
        <p>
