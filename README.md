<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'While we may not be able to control all that happens to us, we can control what happens inside us.' was translated to mandalorian language, and the result is: 'Vaal vi may not cuyir liser control an megin happens brokar mhi,  vi liser control me'ven? Happens inside mhi.'
        </h5>
