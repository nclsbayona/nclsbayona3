<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The last time doesn't exist. It's only this time. And everything is going to be different this time. There's only now.' was translated to huttese language, and the result is: 'Doe last tee-tocky doesn't exist. Soong only this tee-tocky. Um everything sa koona tah be different this tee-tocky. Ya's only ateema.'
        </h5>
