<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Know the rules well, so you can break them effectively.' was translated to huttese language, and the result is: 'Know doe rules well,  so u can break hoohah effectively.'
        </h5>
