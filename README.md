<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you do not conquer self, you will be conquered by self.' was translated to huttese language, and the result is: 'If u ap-xmasi conquer self,  u will be conquered by self.'
        </h5>
