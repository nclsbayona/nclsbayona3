<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If everything was easy you'd be bored' was translated to oldenglish language, and the result is: ' {If} incer {was} lustsumlic {you'd} openian {bored}'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                13.01°C, however it feels like 12.59°C, climate is
                <i>overcast clouds</i>
            .
