<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Today is plenty; right now is enough. Tomorrow will come in good time. Until it does, live the depth of now.' was translated to oldenglish language, and the result is: ' {Today} {is} nyhtsumnes; rihtlic sôðlic {is} nôg. {Tomorrow} wîtword underberan toward fremung stund. {Until} ðæge pro {does}, yfelian sê cêap râd gên.'
        </h5>
