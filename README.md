<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Vulnerability is not winning or losing; it's having the courage to show up and be seen when we have no control over the outcome.' was translated to oldenglish language, and the result is: ' {Vulnerability} {is} ne {winning} ofðe {losing}; {it's} twihynde sê herelof forwards stâlian ûpweard ðe weorðan sîene hwonne we winnan n¯æfre hæfen bufan ðone as ûtan−cumen.'
        </h5>
