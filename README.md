<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Do not allow your inner doubts to keep you from achieving what you can do.' was translated to dothraki language, and the result is: 'Hash vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) allow yeri inner doubts to keep yeri ha achieving fini yeri laz hash.'
        </h5>
