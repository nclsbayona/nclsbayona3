<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'From error to error one discovers the entire truth.' was translated to pirate language, and the result is: 'From error t' error one discovers th' entire truth.'
        </h5>
