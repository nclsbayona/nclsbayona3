<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'We are all works in progress' was translated to oldenglish language, and the result is: ' {We} meðrian {all} {works} mid forðgang'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                10.79°C, however it feels like 10.38°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 10.79°C
            Max. temperature: 10.79°C
        </p>
    </div>
    <div id="wakatime">
        <p>
