<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The greatest work that kindness does to others is that it makes them kind themselves.' was translated to dothraki language, and the result is: 'The greatest work ki kindness does to others is ki anna makes them erin themselves.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                7.44°C, however it feels like 7.44°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 7.44°C
            Max. temperature: 7.44°C
        </p>
    </div>
    <div id="wakatime">
        <p>
