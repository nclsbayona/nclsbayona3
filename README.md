<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Live in each season as it passes; breathe the air, drink the drink, taste the fruit, and resign yourself to the influence of the earth.' was translated to pig-latin language, and the result is: 'ive-Lay in-way each-way eason-say as-way it-way passes; eathe-bray e-thay air-way, ink-dray e-thay ink-dray, aste-tay e-thay uit-fray, and-way esign-ray ourself-yay o-tay e-thay influence-way of-way e-thay earth-way. '
        </h5>
