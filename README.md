<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Walking with a friend in the dark is better than walking alone in the light.' was translated to oldenglish language, and the result is: ' {Walking} wið dimf b¯æm wine under ðone as wann {is} beterian {than} str¯æde syndrige un−feor wægn bærnan.'
        </h5>
