<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Know the rules well, so you can break them effectively.' was translated to pirate language, and the result is: 'be knowin' th' rules well, so ye can break them effectively.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                11.08°C, however it feels like 10.75°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 11.08°C
            Max. temperature: 11.08°C
        </p>
    </div>
    <div id="wakatime">
        <p>
