<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'I skate to where the puck is going to be, not where it has been.' was translated to dothraki language, and the result is: 'Anha skate to finne the puck is going to be,  vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) finne anna has been.'
        </h5>
