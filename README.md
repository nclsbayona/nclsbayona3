<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'You can, you should, and if you're brave enough to start, you will.' was translated to huttese language, and the result is: 'U can,  u should,  um if u're brave enough tah start,  u will.'
        </h5>
