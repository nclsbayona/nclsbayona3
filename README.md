<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you want to achieve greatness stop asking for permission.' was translated to dothraki language, and the result is: 'If yeri want to achieve athvezhvenar nakho asking ha permission.'
        </h5>
