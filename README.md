<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Everyone has the right to make his own decisions, but none has the right to force his decision on others.' was translated to sindarin language, and the result is: 'Everyone has i foeir na ech- hon own decisions,  but none has i foeir na force hon decision bo others.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                17.05°C, however it feels like 16.53°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 17.05°C
            Max. temperature: 17.05°C
        </p>
    </div>
    <div id="wakatime">
        <p>
