<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'I always advice people - Don't wait ! Do something when you are young, when you have no responsibilities. Invest time in yourself to have great Experiences that are going to enrich you, then you can't possibly lose.' was translated to oldenglish language, and the result is: ' ic pro wang r¯æd dryhtweras {-} {Don't} nesan {}! {Do} âwiht yonder êower brêman geonglic, ðâ êower stealdan ðêos {responsibilities}. {Invest} stund ætrihte {yourself} toward sîn stôr {Experiences} ðæt weorðung faru frambringan gôdian êow, ð¯ærrihte êow {can't} ) âl¯ætan.'
        </h5>
