<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Where there is ruin, there is hope for a treasure.' was translated to oldenglish language, and the result is: ' {Where} {there} {is} forwyrcan, {there} {is} wênan ðêah−hwæðere weargbr¯æde sincgestrêon.'
        </h5>
