<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'We live only now. Everything else is either passed or is unknown.' was translated to minion language, and the result is: 'alsvivo solo prompo, Yi kai yai yai!  midoo eko tis sora ummgip sif tis itism.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                12.58°C, however it feels like 12.37°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 12.58°C
            Max. temperature: 12.58°C
        </p>
    </div>
    <div id="wakatime">
        <p>
