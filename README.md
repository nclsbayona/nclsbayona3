<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If we are not stretching, we are not growing. If we are not growing, we are probably not fulfilling our potential. The only person in this room that knows your potential is you.' was translated to pirate language, and the result is: 'If we be not stretchin', we be not growin'.  If we be not growin', we be probably not fulfillin' our potential.  th' only person in this room that knows yer potential be ye.'
        </h5>
