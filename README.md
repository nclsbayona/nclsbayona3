<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'People who say it cannot be done should not interrupt those who are doing it.' was translated to pirate language, and the result is: 'People who say it cannot be done should not interrupt those who be doin' it.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                10.34°C, however it feels like 9.62°C, climate is
                <i>overcast clouds</i>
            .
