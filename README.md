<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Numbing the pain for a while will make it worse when you finally feel it.' was translated to klingon language, and the result is: 'Numbing the 'oy' for a while will vut 'oh worse ghorgh tlhih tagha' hot 'oh.'
        </h5>
