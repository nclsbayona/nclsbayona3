<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Hope itself is like a star- not to be seen in the sunshine of prosperity, and only to be discovered in the night of adversity.' was translated to yoda language, and the result is: 'Like a star- not to be seen in the sunshine of prosperity,  hope itself is,Discovered in the night of adversity,  and only to be.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                10.07°C, however it feels like 9.64°C, climate is
                <i>overcast clouds</i>
            .
