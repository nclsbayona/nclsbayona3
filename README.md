<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'It is hard to fail, but it is worse never to have tried to succeed.' was translated to mandalorian language, and the result is: 'Bic is urakto brokar trattok'or,  al bic is doshishya draar brokar ganar tried brokar bralir.'
        </h5>
