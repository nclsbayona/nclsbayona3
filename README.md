<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'You know more than you knew yesterday' was translated to oldenglish language, and the result is: ' {You} understandan more {than} êower {knew} giestran'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                9.57°C, however it feels like 9.57°C, climate is
                <i>scattered clouds</i>
            .
            Min. temperature: 9.57°C
            Max. temperature: 9.57°C
        </p>
    </div>
    <div id="wakatime">
        <p>
