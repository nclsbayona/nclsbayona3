<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Alone we can do so little; together we can do so much.' was translated to huttese language, and the result is: 'Solo jee-jee can do so little; weeteebah jee-jee can do so much.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                15.93°C, however it feels like 15.54°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 15.93°C
            Max. temperature: 15.93°C
        </p>
    </div>
    <div id="wakatime">
        <p>
