<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'You need to be doing fewer things for more effect instead of doing more things with side effects.' was translated to sith language, and the result is: 'Tu adata kia buti isarian keletis things nuo vel effect instead iv isarian vel things su garthaz effects.'
        </h5>
