<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Successful people appear to be traveling along one continual, successful road. What is not apparent is the perseverance it takes following each defeat to keep you on that road. No one I know of has ever experienced one success after another without defeats, failures, disappointments, and frustrations galore along the way. Learning to overcome those times of agony is what separates the winners from the losers.' was translated to oldenglish language, and the result is: ' {Successful} woruld blîcan hebban bêon {traveling} bæc tîrfæst âwunigende, forðgenge str¯æt. {What} {is} nâteðæshwôn {apparent} {is} wægn ðurhwunenes man {takes} leoðu form and with a oferdrîfan hand hafenian êower toward landriht 'land−right weg. {No} cýme ic pro wiste râd {has} woruld ancient man sigespêd siððan {another} ût {defeats}, {failures}, {disappointments}, mid {frustrations} {galore} âlangian wægn lâd. {Learning} fyllan ofersettan ðâs {times} râd dêaðcwalu {is} {what} {separates} ðone as {winners} wîte duguð {losers}.'
        </h5>
