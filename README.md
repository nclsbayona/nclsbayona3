<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The tennis ball doesn't know how old I am. The ball doesn't know if I'm a man or a woman or if I come from a communist country or not. Sport has always broken down these barriers.' was translated to minion language, and the result is: 'ta proboo jugo hapire cono amee hap ka am, Yi kai yai yai, Yi kai yai yai! ta jugo hapire cono asa ka'm a ka sif a kea sif asa ka po da a ifbio placo sif non.  tin hego adtut alshin koop les weedaw.'
        </h5>
...
Do Ahead: Rosé can be frozen 1 week ahead.
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                18.86°C, however it feels like 18.19°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 18.86°C
            Max. temperature: 18.86°C
        </p>
    </div>
    <div id="wakatime">
        <p>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="padding-left: 1em; padding-right: 1em; text-align: center; vertical-align: top">3 hours and 8 minutes</td>
        </tr>
        <tr>
    ...
    <tbody>
        <tr>
            ...
            <td style="padding-left: 1em; padding-right: 1em; text-align: center; vertical-align: top">8 hours and 50 minutes</td>
        </tr>
        <tr>
            <td style="padding-left: 1em; padding-right: 1em; text-align: center; vertical-align: top">Windows</td>
            <td style="padding-left: 1em; padding-right: 1em; text-align: center; vertical-align: top">5 hours and 35 minutes</td>
        </tr>
    </tbody>
</table>
        <hr>
