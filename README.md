<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'There are few reasons for telling the truth, but for lying the number is infinite.' was translated to yoda language, and the result is: 'Few reasons for telling the truth,  there are,Infinite,  but for lying the number is.'
        </h5>
