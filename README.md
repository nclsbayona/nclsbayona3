<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Anything you may hold firmly in your imagination can be yours.' was translated to sindarin language, and the result is: 'Anything cin lothron gar- firmlui in cín imagination tur- n- yours.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                17.44°C, however it feels like 16.88°C, climate is
                <i>scattered clouds</i>
            .
            Min. temperature: 17.44°C
            Max. temperature: 17.44°C
        </p>
    </div>
    <div id="wakatime">
        <p>
