<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The last time doesn't exist. It's only this time. And everything is going to be different this time. There's only now.' was translated to dothraki language, and the result is: 'The ha nakhaan kashi doesn't exist. Anna's disse jinak kashi. Ma everything is going to be esina jinak kashi. Rekke's disse ajjin.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                10.07°C, however it feels like 9.46°C, climate is
                <i>overcast clouds</i>
            .
