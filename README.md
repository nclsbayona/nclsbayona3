<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'When it comes to winning, you need the skill and the will.' was translated to mandalorian language, and the result is: 'Tion'tuur bic comes brokar winning,  gar ne'waadas te skill bal te will.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                12.24°C, however it feels like 11.74°C, climate is
                <i>scattered clouds</i>
            .
            Min. temperature: 12.24°C
            Max. temperature: 12.24°C
        </p>
    </div>
    <div id="wakatime">
        <p>
