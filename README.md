<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you can consciously let yourself get taken and see where you go, that's an exercise. That's discipline. To follow the scent. Let yourself go and see what happens, that takes a bit of courage.' was translated to oldenglish language, and the result is: ' {If} êower canne {consciously} onlîesan {yourself} begietan scrêpe swâðêana lôca in thither êow ferian, {that's} cyning feald. {That's} ðêodscipe. {To} fylgan or ðone as smæc. {Let} {yourself} wuton 1 of wîtan eornostlîce scêawian {what} {happens}, ðæt {takes} dimf b¯æm wriða of dômweorðung.'
        </h5>
