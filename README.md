<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The only difference between success and failure is the ability to take action.' was translated to oldenglish language, and the result is: ' {The} singales ungelîcnes betwux gang wislic forwordenes {is} sê miht oferniman fôn inge−hygd.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                12.45°C, however it feels like 12°C, climate is
                <i>overcast clouds</i>
            .
