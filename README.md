<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The past is history. It no longer exists, but you are keeping it alive in your mind through your thoughts.  Let it go. It is not serving you.' was translated to oldenglish language, and the result is: ' {The} forð forðbie {is} recednes. {It} ðêos mâ {exists}, hûru êow ârweorðnes heordr¯æden ðæge pro {alive} nêalic êower ferhð bæc êower mâðmcleofa.  {Let} hit hê +wrixle. {It} {is} nâteðæshwôn {serving} êower.'
        </h5>
