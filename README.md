<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Effort only fully releases its reward after a person refuses to quit.' was translated to oldenglish language, and the result is: ' {Effort} for ðâm ðe wel {releases} sîn edgift wiðæftan bêga wiht {refuses} unnan 1 an ofgiefan.'
        </h5>
