<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Life is like a camera: just focus on what is important, capture good times, develop from negative, and if things do not work out, take another shot!' was translated to oldenglish language, and the result is: ' {Life} {is} efengelic twihynde {camera}: ferhtlic fustra nêan {what} {is} ûphêah, for−dilgian tilmôdig {times}, {develop} stellan {negative}, swâðêana gif {things} temian nâ un¯æmta ûpâtêon, môt {another} wierp!'
        </h5>
