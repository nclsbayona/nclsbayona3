<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'All you need is the plan, the road map, and the courage to press on to your destination.' was translated to huttese language, and the result is: 'All u need sa doe plan,  doe road map,  um doe courage tah press on tah do destination.'
        </h5>
