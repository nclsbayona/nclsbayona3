<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Logic is like the sword - those who appeal to it shall perish by it.' was translated to oldenglish language, and the result is: ' {Logic} {is} onlic dôð wîgbill {-} ðâs ðês foresêcan forwards hit hê {shall} onbrosnung forð forðbie man.'
        </h5>
