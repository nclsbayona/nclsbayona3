<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'No problem can be solved from the same level of consciousness that created it.' was translated to oldenglish language, and the result is: ' {No} {problem} canne swîcan {solved} f¯ætan sê self efenlîca of  ðe {created} man.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                10.92°C, however it feels like 10.52°C, climate is
                <i>overcast clouds</i>
            .
