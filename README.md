<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Insanity: doing the same thing over and over again and expecting different results.' was translated to klingon language, and the result is: 'Insanity: doing the same doch over 'ej over again 'ej expecting different results.'
        </h5>
