<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you only knew the magnificence of the 3, 6, and 9, then you would have a key to the universe.' was translated to sindarin language, and the result is: 'If cin onlui knew i magnificence -o i 3,  6,  a 9,  then cin would gar- a keui na i universe.'
        </h5>
