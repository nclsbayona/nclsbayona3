<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Thought is so cunning, so clever, that it distorts everything for its own convenience.' was translated to sindarin language, and the result is: 'Ind na- so coru,  so maen,  i ha distorts everything an its own convenience.'
        </h5>
