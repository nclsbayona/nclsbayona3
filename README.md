<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Absorb what is useful, discard what is not, add what is uniquely your own.' was translated to dothraki language, and the result is: 'Absorb fini is davra,  discard fini is vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.),  add fini is uniquely yeri zhorre.'
        </h5>
