<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'By failing to prepare, you are preparing to fail.' was translated to klingon language, and the result is: 'By failing to vut,  tlhih are preparing to luj.'
        </h5>
    ...
    <tbody>
        ...
        <h4>
            <font color="#F0A0FF">
                Instructions: Mix the beer with tomato juice, freshly squeezed lime juice, and Worcestershire sauce, teriyaki sauce, soy sauce, or hot sauce.
