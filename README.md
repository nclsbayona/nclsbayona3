<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The greatest value of a picture is when it forces us to notice what we never expected to see.' was translated to oldenglish language, and the result is: ' {The} {greatest} lofian râd dimf b¯æm tîfrung {is} ðonne and hê fultum ûs of pro ic hand hâwian {what} we n¯ænig pro {expected} stêpan lôc.'
        </h5>
