<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Life is not meant to be easy my child, but take courage: it can be delightful.' was translated to minion language, and the result is: 'levo tis non ya da be sim sim mi lip, pelo nupi courage: pik pudum be delightful.'
        </h5>
