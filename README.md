<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Insanity: doing the same thing over and over again and expecting different results.' was translated to sindarin language, and the result is: 'Insanitui: doing i same nad nia a nia ad- a expecting different results.'
        </h5>
