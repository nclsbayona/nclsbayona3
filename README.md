<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'You are worthy and deserving of respect' was translated to oldenglish language, and the result is: ' {You} weorðnes medemlic for ðý ðe {deserving} un−l¯æd m¯æð'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                18.39°C, however it feels like 17.9°C, climate is
                <i>few clouds</i>
            .
            Min. temperature: 18.39°C
            Max. temperature: 18.39°C
        </p>
    </div>
    <div id="wakatime">
        <p>
