<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Great things are done by a series of small things brought together. ' was translated to oldenglish language, and the result is: ' {Great} {things} coper {done} forð forðbie a lîne un−l¯æd hw¯æde {things} {brought} gadertang. '
        </h5>
