<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Life can be the scariest and most beautiful thing simultaneously.' was translated to pirate language, and the result is: 'Life can be th' scariest and most beautiful thin' simultaneously.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                11.95°C, however it feels like 11.66°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 11.95°C
            Max. temperature: 11.95°C
        </p>
    </div>
    <div id="wakatime">
        <p>
