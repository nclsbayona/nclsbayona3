<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'For the things we have to learn before we can do them, we learn by doing them.' was translated to gungan language, and the result is: 'For dha things wesa have to learn before wesa can do them-sa,  wesa learn by do them-sa.'
        </h5>
