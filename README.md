<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'In all chaos there is a cosmos, in all disorder a secret order.' was translated to cheunh language, and the result is: 'Can all fiuri there carcir ch'a cosmos,  can all ch'itusbi ch'a ravsaco order.'
        </h5>
