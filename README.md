<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'When I was a little kid, I was really scared of the dark. But then I came to understand, dark just means the absence of photons in the visible wavelength 400 to 700 nanometers. Then I thought, well it's really silly to be afraid of a lack of photons. Then I wasn't afraid of the dark anymore after that.' was translated to oldenglish language, and the result is: ' {When} ic pro {was} bêga lýt hêcen, ic pro {was} sôðe {scared} un−l¯æd dôð nipful. {But} ð¯æronuppan attraction with pron ðe ic {came} ongeniman forcýðan, blind dômfæst bewerung duguð  râd {photons} ætstandan dôð êaðgesýne {wavelength} {400} oð {700} {nanometers}. {Then} attraction with pron ðe ic môdgehygd, tulge tylg {it's} sôðe ungewitt besettan licgan forhtlic un−l¯æd a wana un−l¯æd {photons}. {Then} ic pro {wasn't} forhtlic un−l¯æd sê lêohtlêas {anymore} lang ðe.'
        </h5>
