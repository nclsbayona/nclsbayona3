<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The beautiful journey of today can only begin when we learn to let go of yesterday.' was translated to klingon language, and the result is: 'The beautiful journey of jajvam can neh begin ghorgh mah ghoj to let jah of wa'hu'.'
        </h5>
