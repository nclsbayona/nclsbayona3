<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Every day is an opportunity to a make a new happy ending.' was translated to oldenglish language, and the result is: ' {Every} tîdd¯æg {is} cyning dafenlîcnes (gyden bêga stefnian a geong s¯ælig endung.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                11.98°C, however it feels like 11.66°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 11.98°C
            Max. temperature: 11.98°C
        </p>
    </div>
    <div id="wakatime">
        <p>
