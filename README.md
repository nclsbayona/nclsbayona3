<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'It is better to change an opinion than to persist in a wrong one.' was translated to sindarin language, and the result is: 'Ha na- better na change an opinion than na persist in a roeg er.'
        </h5>
...
Divide the mango purée between the glasses and add 30ml white rum and a handful of crushed ice to each one, stirring well to mix everything together. Top up with soda water to serve and garnish with extra mint, if you like.
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                17.43°C, however it feels like 16.69°C, climate is
                <i>broken clouds</i>
            .
