<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'In all chaos there is a cosmos, in all disorder a secret order.' was translated to valyrian language, and the result is: 'Isse ry qrīdronnor konīr iksos nykeā cosmos,  isse ry disorder nykeā secret order.'
        </h5>
