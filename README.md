<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Success in any endeavor depends on the degree to which it is an expression of your true self. ' was translated to sith language, and the result is: 'Klotis kash jok endeavor depends ant tave degree kia which zhol kash jri expression iv tu'iea tiesa ja'vie.'
        </h5>
