<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'You may be one person in this world, but to one person you may mean the world.' was translated to valyrian language, and the result is: 'Ao kostagon sagon mēre issaros isse bisa vys,  yn naejot mēre issaros ao kostagon nūmāzma se vys.'
        </h5>
