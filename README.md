<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you want to make your dreams come true, the first thing you have to do is wake up.' was translated to gungan language, and the result is: 'If yousa want to maken yous dreams comin true,  dha first th yousa have to do is wake up.'
        </h5>
