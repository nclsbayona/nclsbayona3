<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The important thing is not to stop questioning. Curiosity has its own reason for existing.' was translated to vulcan language, and the result is: 'Wuh yauluhk vel nam-tor ri tor pehkaya questioning. Curiosity has its sha' utvau na' existing.'
        </h5>
