<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'A real decision is measured by the fact that you've taken a new action. If there's no action, you haven't truly decided.' was translated to sith language, and the result is: 'Zo fashis nutarisas kash metrajia by tave fact anas tu've vyktija zo kitok zygis. Ar antai's nie zygis,  tu zinoui tiesanu nutarijas.'
        </h5>
    ...
    <tbody>
        <tr>
            ...
            <td style="padding-left: 1em; padding-right: 1em; text-align: center; vertical-align: top">8 hours and 43 minutes</td>
        </tr>
        <tr>
    ...
    <tbody>
        <tr>
            ...
            <td style="padding-left: 1em; padding-right: 1em; text-align: center; vertical-align: top">9 hours and 51 minutes</td>
        </tr>
    </tbody>
</table>
        <hr>
