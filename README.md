<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Don't use all-or-nothing thinking. Take each day as its own day, and don't worry about it if you mess up one day. The most important thing you can do is just get back up on the horse.' was translated to minion language, and the result is: 'domo uso tadda-sif-secmop awnyok, yikai. . nupi seeko dia sim sew mio dia, yee domo vox cama pik asa to mo aka da dia.  ta meja poden tipa to pudum batooay tis sola ref bok aka lib ta cama.'
        </h5>
