<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Mistakes don't make you less capable' was translated to oldenglish language, and the result is: ' {Mistakes} {don't} fremman êower l¯æs tælwîs'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                15.79°C, however it feels like 15.33°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 15.79°C
            Max. temperature: 15.79°C
        </p>
    </div>
    <div id="wakatime">
        <p>
