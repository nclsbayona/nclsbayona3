<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Go for it now. The future is promised to no one.' was translated to pirate language, and the result is: 'Go fer it now.  th' future be promised t' no one.'
        </h5>
