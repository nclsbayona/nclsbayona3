<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'There is no excuse for not trying.' was translated to dothraki language, and the result is: 'Rekke is vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) excuse ha vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) trying.'
        </h5>
