<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'It only takes a split second to smile and forget, yet to someone that needed it, it can last a lifetime.' was translated to huttese language, and the result is: 'It only takes do split second tah smeeleeya um forget,  yet tah someone da needed it,  it can last do lifetime.'
        </h5>
