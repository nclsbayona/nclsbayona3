<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Elegance does not consist in putting on a new dress.' was translated to pig-latin language, and the result is: 'Elegance-way oes-day ot-nay onsist-cay in-way utting-pay on-way a-way ew-nay ess-dray. '
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                14.47°C, however it feels like 14.14°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 14.47°C
            Max. temperature: 14.47°C
        </p>
    </div>
    <div id="wakatime">
        <p>
