<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Humor isn't for everyone. It's only for people who want to have fun, enjoy life, and feel alive.' was translated to pig-latin language, and the result is: 'umor-Hay isn't or-fay everyone-way. It's only-way or-fay eople-pay o-whay ant-way o-tay ave-hay un-fay, enjoy-way ife-lay, and-way eel-fay alive-way. '
        </h5>
...
Stir well.
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                15.94°C, however it feels like 15.52°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 15.94°C
            Max. temperature: 15.94°C
        </p>
    </div>
    <div id="wakatime">
        <p>
