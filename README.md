<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Better the cottage where one is merry than the palace where one weeps.' was translated to valyrian language, and the result is: 'Sȳrkta se cottage skoriot mēre iksos merry than se palace skoriot mēre weeps.'
        </h5>
