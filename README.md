<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Obstacles don't block the path, they are the path.' was translated to klingon language, and the result is: 'Obstacles don't ngogh the path,  chah are the path.'
        </h5>
