<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'A mistake is only an error, it becomes a mistake when you fail to correct it.' was translated to vulcan language, and the result is: 'Wuh lafosh nam-tor goh wuh lafosh,  ish-veh shetau wuh lafosh lu du vravshau tor yeht ish-veh.'
        </h5>
