<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The truth... It is a beautiful and terrible thing, and should therefore be treated with great caution.' was translated to oldenglish language, and the result is: ' {The} trêowð. {It} {is} dimf b¯æm wynlic ðêah−hwæðere frêcendlic +siht, ðêana {should} stræclic weorðan {treated} mid grêatian wærlicnes.'
        </h5>
