<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'We don't have to do all of it alone. We were never meant to.' was translated to oldenglish language, and the result is: ' {We} {don't} stealdan n¯æman macian {all} of ðæge pro ânum. {We} {were} twêgen nu {meant} oð.'
        </h5>
