<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'An empty head is not really empty; it is stuffed with rubbish. Hence the difficulty of forcing anything into an empty head.' was translated to ferblatin language, and the result is: 'An mpty-eerb ead-herb is ot-nerb eally-rerb empty; it is tuffed-serb ith-werb rubbish. ence-Herb he-terb ifficulty-derb of orcing-ferb nything-aerb nto-ierb an mpty-eerb head. '
        </h5>
