<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'In order to attain the impossible, one must attempt the absurd.' was translated to mandalorian language, and the result is: 'O'r ke'gyce brokar attain te impossible,  solus enteyor kebbur te absurd.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                13.6°C, however it feels like 13.24°C, climate is
                <i>light rain</i>
            .
            Min. temperature: 13.6°C
            Max. temperature: 13.6°C
        </p>
    </div>
    <div id="wakatime">
        <p>
