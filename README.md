<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Winners lose much more often than losers. So if you keep losing but you're still trying, keep it up! You.. Re right on track.' was translated to oldenglish language, and the result is: ' {Winners} lêafnes micle forwards oftr¯æde {than} {losers}. {So} thither êower besettan {losing} lôca in {you're} stilnes {trying}, bewitan hîe ûpweardes! {You}. {Re} rihtlic âbûtan sîðstapel.'
        </h5>
