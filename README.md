<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The more you are focused on time - past and future - the more you miss the Now, the most precious thing there is.' was translated to minion language, and the result is: 'ta mas to nama recvim lib veela - lego yee tegpul - ta mas to missa ta prompo, ta meja revoho tipa bada tis.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                9.07°C, however it feels like 9.07°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 9.07°C
            Max. temperature: 9.07°C
        </p>
    </div>
    <div id="wakatime">
        <p>
