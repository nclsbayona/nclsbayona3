<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Peace is not absence of conflict, it is the ability to handle conflict by peaceful means.' was translated to oldenglish language, and the result is: ' {Peace} {is} nealles æfweardnes un−l¯æd hn¯æst, man {is} ðone as ðegnscipe oferniman handlian +hnâst of môd fore−spr¯æc.'
        </h5>
