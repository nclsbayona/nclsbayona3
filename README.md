<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Do not let what you cannot do interfere with what you can do.' was translated to gungan language, and the result is: 'Do not let what yousa cannot do interfere with what yousa can do.'
        </h5>
