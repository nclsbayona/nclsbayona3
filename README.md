<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Note that this journey is uniquely yours, no one elses. So the path has to be your own.' was translated to dothraki language, and the result is: 'Note ki jinak journey is uniquely yours,  vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) ato elses. Sekke the os has to be yeri zhorre.'
        </h5>
