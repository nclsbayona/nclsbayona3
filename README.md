<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'A man who dares to waste one hour of time has not discovered the value of life.' was translated to vulcan language, and the result is: 'Wuh sasu vi dares tor thinoi veh wadan t' wak has ri discovered wuh tala t' ha'kiv.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                17.75°C, however it feels like 17.2°C, climate is
                <i>broken clouds</i>
            .
            Min. temperature: 17.75°C
            Max. temperature: 17.75°C
        </p>
    </div>
    <div id="wakatime">
        <p>
