<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Failure is not fatal, but failure to change might be.' was translated to gungan language, and the result is: 'Failure is not fatal,  but failure to change might be.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                7.26°C, however it feels like 7.26°C, climate is
                <i>few clouds</i>
            .
            Min. temperature: 7.26°C
            Max. temperature: 7.26°C
        </p>
    </div>
    <div id="wakatime">
        <p>
