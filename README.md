<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'There exists only the present instant; a Now which always and without end is itself new.' was translated to huttese language, and the result is: 'Ya exists only doe present instant; do ateema which always um without end sa itself newpa.'
        </h5>
