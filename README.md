<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Kindness is a language which the deaf can hear and the blind can see.' was translated to oldenglish language, and the result is: ' {Kindness} {is} hlêg ðêodisc sê duguð dêaf canne oferhîeran forðý sê bedydrian canne lôc.'
        </h5>
