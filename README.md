<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The one who praises you is a thief. The one who criticizes you is your true friend.' was translated to oldenglish language, and the result is: ' {The} geatolic ðætte {praises} êow {is} tîma wealdgenga. {The} unforcûð ðêos {criticizes} êow {is} êower hâlfæst lêof.'
        </h5>
