<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Don't be tempted to break momentum-work through it.' was translated to oldenglish language, and the result is: ' {Don't} w¯ære {tempted} later forwyrcan {momentum-work} wiðæftan man.'
        </h5>
