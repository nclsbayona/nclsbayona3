<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'For the things we have to learn before we can do them, we learn by doing them.' was translated to huttese language, and the result is: 'Che doe things jee-jee have tah learn before jee-jee can do hoohah,  jee-jee learn by doing hoohah.'
        </h5>
