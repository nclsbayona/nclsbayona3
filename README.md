<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Even if our home burns down we can rebuild it. But the things that we got for nothing, we can never replace.' was translated to oldenglish language, and the result is: ' {Even} gif ûser gæstlîðnes {burns} height attraction with pron ðe ic canne {rebuild} hit hê. {But} dôð {things} ðætte we {got} mid nâht, attraction with pron ðe ic canne ðêos {replace}.'
        </h5>
