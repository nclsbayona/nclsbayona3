<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Either write something worth reading or do something worth writing.' was translated to oldenglish language, and the result is: ' {Either} âwrîtan âhwæðer weorðnes ymbeaht ðe ðritig âðrôwian âhwæðer medemnes wrîting.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                10.39°C, however it feels like 9.94°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 10.39°C
            Max. temperature: 10.39°C
        </p>
    </div>
    <div id="wakatime">
        <p>
