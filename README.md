<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Don't use all-or-nothing thinking. Take each day as its own day, and don't worry about it if you mess up one day. The most important thing you can do is just get back up on the horse.' was translated to oldenglish language, and the result is: ' {Don't} benotian {all-or-nothing} {thinking}. {Take} æthwâ tôdæge lêo sîn âgnod gêardagas, adverbial phrases {don't} hunta nêalic hê yonder êow {mess} uppe ân dægtîma. {The} best ûplic sîen êower canne forberan {is} rihtlic r¯æcan reach hinderling uppe to duguð wicg.'
        </h5>
