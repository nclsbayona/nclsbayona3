<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Don't bother people for help without first trying to solve the problem yourself.' was translated to valyrian language, and the result is: 'ȳdra daor jenigon people syt dohaeragon mijegon ēlī trying naejot solve se problem aōla.'
        </h5>
