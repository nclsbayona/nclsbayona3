<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Do Something. If it works, do more of it. If it doesn't, do something else.' was translated to oldenglish language, and the result is: ' {Do} {Something}. {If} man {works}, âdrêogan swîðe of ðæge pro. {If} hit hê {doesn't}, fremman edwihte elles.'
        </h5>
