<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The only thing we have to fear is fear itself.' was translated to huttese language, and the result is: 'Doe only thing jee-jee have tah fear sa fear itself.'
        </h5>
