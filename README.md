<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The world only exists in your eyes. You can make it as big or as small as you want.' was translated to oldenglish language, and the result is: ' {The} simble ðrâge {exists} ongêanweard êower {eyes}. {You} canne âscieppan man same only in swâ {big} oððon same only in swâ medmicel samðe in phrase samðsamð êower nyttung.'
        </h5>
