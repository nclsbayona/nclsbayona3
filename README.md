<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Money is only a tool. It will take you wherever you wish, but it will not replace you as the driver.' was translated to pirate language, and the result is: 'doubloons be only a tool.  It will take ye wherever ye wish, but it will not replace ye as th' driver.'
        </h5>
