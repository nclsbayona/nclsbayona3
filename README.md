<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The right thing to do and the hard thing to do are usually the same.' was translated to valyrian language, and the result is: 'Se paktot mirre naejot gaomagon se se qopsa mirre naejot gaomagon issi usually keskydoso.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                11.15°C, however it feels like 10.75°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 11.15°C
            Max. temperature: 11.15°C
        </p>
    </div>
    <div id="wakatime">
        <p>
