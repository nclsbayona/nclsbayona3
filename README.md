<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'To live outside the law, you must be honest. ' was translated to gungan language, and the result is: 'To live outside dha law,  yousa must be honest.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                11.56°C, however it feels like 11.2°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 11.56°C
            Max. temperature: 11.56°C
        </p>
    </div>
    <div id="wakatime">
        <p>
