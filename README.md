<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'From now on we live in a world where man has walked on the Moon. It's not a miracle; we just decided to go.' was translated to oldenglish language, and the result is: ' {From} ðâgîet hû−hwega we ræfn−an inne bêga forweard ð¯ær and there esne {has} {walked} fullan duguð {Moon}. {It's} nâteðæshwôn wýscan wundorweorc; we sôðfæst stranglic toward tearflian.'
        </h5>
