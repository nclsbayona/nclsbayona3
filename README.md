<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Your visions will become clear only when you can look into your own heart. Who looks outside, dreams; who looks inside, awakes.' was translated to klingon language, and the result is: 'Your visions will moj clear neh ghorgh tlhih can look into your own tiq. 'iv looks hur,  dreams; 'iv looks qod,  awakes.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                14.67°C, however it feels like 14.23°C, climate is
                <i>few clouds</i>
            .
            Min. temperature: 14.67°C
            Max. temperature: 14.67°C
        </p>
    </div>
    <div id="wakatime">
        <p>
