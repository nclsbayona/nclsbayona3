<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'It is often safer to be in chains than to be free. ' was translated to mandalorian language, and the result is: 'Bic is often safer brokar cuyir o'r chains than brokar cuyir mav.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                8.65°C, however it feels like 8.65°C, climate is
                <i>few clouds</i>
            .
            Min. temperature: 8.65°C
            Max. temperature: 8.65°C
        </p>
    </div>
    <div id="wakatime">
        <p>
