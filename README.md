<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you want to test your memory, try to recall what you were worrying about one year ago today.' was translated to oldenglish language, and the result is: ' {If} êower tilð forwards fandian êower mynd, âcostnian ûtâðýdan eftgecîgan {what} êower {were} {worrying} ætrihte ænlic gêar {ago} {today}.'
        </h5>
