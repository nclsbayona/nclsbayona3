<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Living a life that has a greater purpose and living up to it is the ultimate degree that we should strive for.' was translated to klingon language, and the result is: 'Living a yin 'e' has a greater ngoq 'ej living up to 'oh is the ultimate degree 'e' mah should strive for.'
        </h5>
