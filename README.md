<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Don't bother people for help without first trying to solve the problem yourself.' was translated to oldenglish language, and the result is: ' {Don't} {bother} folc hwæðere l¯æstan  fyrst {trying} n¯æman {solve} dôð {problem} {yourself}.'
        </h5>
