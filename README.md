<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'You're never given a dream without also being given the power to make it true.' was translated to yoda language, and the result is: 'It true,  you're never given a dream without also being given the power to make.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                19.28°C, however it feels like 18.7°C, climate is
                <i>scattered clouds</i>
            .
            Min. temperature: 19.28°C
            Max. temperature: 19.28°C
        </p>
    </div>
    <div id="wakatime">
        <p>
