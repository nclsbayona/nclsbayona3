<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Be where your enemy is not.' was translated to dothraki language, and the result is: 'Be finne yeri dozgo is vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.).'
        </h5>
