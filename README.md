<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Outstanding people have one thing in common: an absolute sense of mission.  ' was translated to oldenglish language, and the result is: ' {Outstanding} nîððas âgan torhtmôd syge tô m¯æne: wiðerbreca {absolute}  un−l¯æd sand.  '
        </h5>
