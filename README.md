<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'We should not look back unless it is to derive useful lessons from past errors.' was translated to oldenglish language, and the result is: ' {We} {should} hnot scîr hinder swâðêah ðæge pro {is} forwards {derive} brýce {lessons} ongeniman forð forðbie {errors}.'
        </h5>
