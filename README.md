<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Your success will not be determined by your gender or your ethnicity, but only on the scope of your dreams and your hard work to achieve them.' was translated to vulcan language, and the result is: 'Ish-veh navun dungi ri nam-tor satalau k' ish-veh guv il ish-veh ne-koshtri'es,  tonk'peh goh fi' wuh scope t' ish-veh sahr-tor-tor heh ish-veh lerash ar'kadan tor achieve au.'
        </h5>
    ...
    <div id="drink">
        ...
        <img src="https://www.thecocktaildb.com/images/media/drink/yhzvk91643821739.jpg">
        <h4>
            <font color="#F0A0FF">
                Name: Gin Lemon
            </font>
