<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Success is the progressive realization of a worthy goal' was translated to oldenglish language, and the result is: ' {Success} {is} wægn {progressive} {realization} of bêga weorðfullic {goal}'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                13.42°C, however it feels like 12.85°C, climate is
                <i>broken clouds</i>
            .
            Min. temperature: 13.42°C
            Max. temperature: 13.42°C
        </p>
    </div>
    <div id="wakatime">
        <p>
