<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'You must have a positive self perception in order to transcend anything.' was translated to pirate language, and the result is: 'ye must have a positive self perception in order t' transcend anythin'.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                12.34°C, however it feels like 11.95°C, climate is
                <i>broken clouds</i>
            .
            Min. temperature: 12.34°C
            Max. temperature: 12.34°C
        </p>
    </div>
    <div id="wakatime">
        <p>
