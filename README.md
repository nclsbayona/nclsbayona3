<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Keep on going and the chances are you will stumble on something, perhaps when you are least expecting it. I have never heard of anyone stumbling on something sitting down.' was translated to oldenglish language, and the result is: ' {Keep} ætrihte wadung  sê {chances} bydel êow setnes âglîdan onuppan edwihte, wene hwænne êower ârweorðnes l¯æst {expecting} hit hê. attraction with pron ðe ic besittan nâwa {heard} un−l¯æd {anyone} {stumbling} æthwôn wiht setlung hi mountain.'
        </h5>
