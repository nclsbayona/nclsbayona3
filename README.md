<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'There exists only the present instant; a Now which always and without end is itself new.' was translated to yoda language, and the result is: 'Only the present instant; a now which always and without end is itself new,  there exists.'
        </h5>
