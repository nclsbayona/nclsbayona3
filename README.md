<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Learn to sit back and observe, not everything needs a reaction.' was translated to klingon language, and the result is: 'Ghoj to ba' dub 'ej tu',  not hoch needs a reaction.'
        </h5>
