<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The idea that everyone should slavishly work so they do something inefficiently so they keep their job - that just doesn't make any sense to me. That can't be the right answer.' was translated to sindarin language, and the result is: 'I naw i everyone should slavishlui work so hain ceri- something inefficientlui so hain cheb- their job - i just doesn't ech- anui sense na nin. I tur-'t n- i foeir answer.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                11.75°C, however it feels like 11.46°C, climate is
                <i>light rain</i>
            .
            Min. temperature: 11.75°C
            Max. temperature: 11.75°C
        </p>
    </div>
    <div id="wakatime">
        <p>
