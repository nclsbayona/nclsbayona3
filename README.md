<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'A mistake is only an error, it becomes a mistake when you fail to correct it.' was translated to klingon language, and the result is: 'A qagh is neh an qagh,  'oh becomes a qagh ghorgh tlhih luj to correct 'oh.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                11.33°C, however it feels like 10.97°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 11.33°C
            Max. temperature: 11.33°C
        </p>
    </div>
    <div id="wakatime">
        <p>
