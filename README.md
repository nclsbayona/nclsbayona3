<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Confidence is like a dragon where, for every head cut off, two more heads grow back.' was translated to gungan language, and the result is: 'Confidence is like a dragon where,  for every head cut off,  duey more heads grow back.'
        </h5>
