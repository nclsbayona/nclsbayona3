<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Only when one allows themself the right to die, do they then give yourself the permission to live.' was translated to yoda language, and the result is: 'Themself the right to die,  only when one allows,They then give yourself the permission to live,  do.'
        </h5>
