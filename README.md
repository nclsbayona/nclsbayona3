<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Do the difficult things while they are easy and do the great things while they are small.' was translated to oldenglish language, and the result is: ' {Do} wægn slîðe {things} mid hit hê wuldor su hraðost ðêana drêogan ðone as êacen {things} fæc hê rôðres hwônlic.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                17.17°C, however it feels like 16.54°C, climate is
                <i>broken clouds</i>
            .
            Min. temperature: 17.17°C
            Max. temperature: 17.17°C
        </p>
    </div>
    <div id="wakatime">
        <p>
