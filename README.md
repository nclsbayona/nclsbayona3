<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If it is not right, do not do it, if it is not true, do not say it.' was translated to vulcan language, and the result is: 'Kuv ish-veh nam-tor ri gas'rak,  ri tor tor ish-veh,  kuv ish-veh nam-tor ri yeht,  ri tor leralmin ish-veh.'
        </h5>
