<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Each path to knowledge involves different rules and these rules are not interchangeable.' was translated to yoda language, and the result is: 'Different rules and these rules are not interchangeable,  each path to knowledge involves.'
        </h5>
