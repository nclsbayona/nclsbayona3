<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Starting is the most difficult step - but you can do it' was translated to oldenglish language, and the result is: ' {Starting} {is} wægn best unêaðe sîðstapel {-} nymðe êow canne ðafian sê'
        </h5>
