<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Growing up is losing some illusions, in order to acquire others.' was translated to oldenglish language, and the result is: ' {Growing} ûpweardes {is} {losing} hwilc−hwene {illusions}, ofer wîsian oðtêon bycgan {others}.'
        </h5>
