<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Genius is the ability to act rightly without precedent - the power to do the right thing the first time.' was translated to pirate language, and the result is: 'Genius be th' ability t' act rightly without precedent - th' power t' do th' right thin' th' first time.'
        </h5>
