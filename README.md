<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Those who bring sunshine into the lives of others cannot keep it from themselves.' was translated to oldenglish language, and the result is: ' {Those} ðætte fercian sunnanscîma wiðinnan ðone as {lives} of {others} {cannot} friðian sê âweorpan {themselves}.'
        </h5>
