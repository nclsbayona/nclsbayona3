<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Values are like fingerprints. Nobody's are the same, but you leave 'em all over everything you do.' was translated to sith language, and the result is: 'Values aras kais fingerprints. Nobody's aras tave monot,  kad tu mezdi 'em visa prie viskas tu isar.'
        </h5>
