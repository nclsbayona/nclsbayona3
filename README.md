<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Vulnerability is not winning or losing; it's having the courage to show up and be seen when we have no control over the outcome.' was translated to oldenglish language, and the result is: ' {Vulnerability} {is} nâteðæshwôn {winning} ofðe {losing}; {it's} twihynde sê hrêð âsettan unwrêon uppe ðigen cunnan 1 and 3 can sîene thither attraction with pron ðe ic forsacan nân n¯ænne fêo ôfer duguð ûtan−cumen.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                9.17°C, however it feels like 8.28°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 9.17°C
            Max. temperature: 9.17°C
        </p>
    </div>
    <div id="wakatime">
        <p>
