<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'It's the unknown we fear when we look upon death and darkness, nothing more.' was translated to vulcan language, and the result is: 'Ish-veh's wuh ri-fainu etek pthak lu etek glazhau fi-tor tevakh heh mu'khlup'es,  nothing weht.'
        </h5>
