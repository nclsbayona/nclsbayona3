<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you respect yourself in stressful situations, it will help you see the positive… It will help you see the message in the mess.' was translated to mandalorian language, and the result is: 'Meh gar respect yourself o'r stressful situations,  bic will gaa'taylir gar haa'taylir te positive… bic will gaa'taylir gar haa'taylir te message o'r te mess.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                10.87°C, however it feels like 10.39°C, climate is
                <i>broken clouds</i>
            .
            Min. temperature: 10.87°C
            Max. temperature: 10.87°C
        </p>
    </div>
    <div id="wakatime">
        <p>
    ...
    <tbody>
        <tr>
            ...
            <td style="padding-left: 1em; padding-right: 1em; text-align: center; vertical-align: top">7 hours and 33 minutes</td>
        </tr>
        <tr>
            <td style="padding-left: 1em; padding-right: 1em; text-align: center; vertical-align: top">C</td>
            <td style="padding-left: 1em; padding-right: 1em; text-align: center; vertical-align: top">2 hours and 48 minutes</td>
        </tr>
        <tr>
    ...
    <tbody>
        <tr>
            ...
            <td style="padding-left: 1em; padding-right: 1em; text-align: center; vertical-align: top">17 hours and 53 minutes</td>
        </tr>
    </tbody>
</table>
        <hr>
