<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Everything has cracks - that's how the light gets in' was translated to oldenglish language, and the result is: ' {Everything} {has} {cracks} {-} {that's} tôhwega and wægn ontendan {gets} fram orde oð ende'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                13.7°C, however it feels like 13.27°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 13.7°C
            Max. temperature: 13.7°C
        </p>
    </div>
    <div id="wakatime">
        <p>
