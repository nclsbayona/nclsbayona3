<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text '10x engineers are a myth' was translated to oldenglish language, and the result is: ' {10x} {engineers} bydel tîma {myth}'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                15.74°C, however it feels like 15.09°C, climate is
                <i>light rain</i>
            .
            Min. temperature: 15.74°C
            Max. temperature: 15.74°C
        </p>
    </div>
    <div id="wakatime">
        <p>
