<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'We don't have to do all of it alone. We were never meant to.' was translated to oldenglish language, and the result is: ' {We} {don't} self ûtâðýdan l¯æstan {all} orgilde sê ânum. {We} {were} twêgen nu {meant} wîte.'
        </h5>
