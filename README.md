<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you do not conquer self, you will be conquered by self.' was translated to klingon language, and the result is: 'If tlhih do not chargh self,  tlhih will qu' conquered by self.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                12.72°C, however it feels like 12.37°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 12.72°C
            Max. temperature: 12.72°C
        </p>
    </div>
    <div id="wakatime">
        <p>
