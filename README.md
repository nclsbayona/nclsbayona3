<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Whatever you do,strive to do it so well that no man living and no man dead and no man yet to be born could do it any better.' was translated to valyrian language, and the result is: 'Whatever ao gaomagon, strive naejot gaomagon ziry sīr sȳrī bona daor vala living se daor vala morghe se daor vala yet naejot sagon āzma could gaomagon ziry mirre sȳrkta.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                10.59°C, however it feels like 10.19°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 10.59°C
            Max. temperature: 10.59°C
        </p>
    </div>
    <div id="wakatime">
        <p>
