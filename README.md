<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you want to test your memory, try to recall what you were worrying about one year ago today.' was translated to oldenglish language, and the result is: ' {If} êower fremung intô with frâsian êower ingemynd, sweotolian later eftgecîgan {what} êower {were} {worrying} lýtesne bl¯ædfæst gêar {ago} {today}.'
        </h5>
