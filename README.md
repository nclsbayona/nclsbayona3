<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The best way to predict the future is to create it.' was translated to yoda language, and the result is: 'The future is to create it,  the best way to predict.'
        </h5>
