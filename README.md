<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'I would rather be a little nobody, then to be an evil somebody.' was translated to oldenglish language, and the result is: ' ic pro {would} æror swîcan bêgra lýtel {nobody}, ð¯æræfter âîeðan stician ealdgenîðla gôdlêas {somebody}.'
        </h5>
