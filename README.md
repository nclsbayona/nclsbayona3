<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If your mind is empty, it is always ready for anything, it is open to everything.' was translated to pirate language, and the result is: 'If yer mind be empty, it be always ready fer anythin', it be open t' everythin'.'
        </h5>
