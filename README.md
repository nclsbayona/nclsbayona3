<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'It still holds true that man is most uniquely human when he turns obstacles into opportunities.' was translated to cheunh language, and the result is: 'Hah ran'cuzo holds k'itro csei vuhn carcir ttah uniquely vuhn veo tah turns obstacles can (bah accusative) opportunities.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                15.67°C, however it feels like 15.22°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 15.67°C
            Max. temperature: 15.67°C
        </p>
    </div>
    <div id="wakatime">
        <p>
