<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Poetry is written with tears, fiction with blood, and history with invisible ink.' was translated to ferblatin language, and the result is: 'oetry-Perb is ritten-werb ith-werb ears-terb, iction-ferb ith-werb lood-berb, nd-aerb istory-herb ith-werb nvisible-ierb ink. '
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                18.87°C, however it feels like 18.14°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 18.87°C
            Max. temperature: 18.87°C
        </p>
    </div>
    <div id="wakatime">
        <p>
