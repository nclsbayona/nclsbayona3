<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Don't forget to enjoy the journey' was translated to ferblatin language, and the result is: 'Don't orget-ferb to njoy-eerb he-terb ourney-jerb '
        </h5>
...
Then add 1 part of the syrup and 2 parts of fresh grapefruit juice together.
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                15.46°C, however it feels like 15.28°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 15.46°C
            Max. temperature: 15.46°C
        </p>
    </div>
    <div id="wakatime">
        <p>
