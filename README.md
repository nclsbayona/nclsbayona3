<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Do not go where the path may lead, go instead where there is no path and leave a trail.' was translated to valyrian language, and the result is: 'Gaomagon daor jikagon skoriot se path kostagon jemagon,  jikagon instead skoriot konīr iksos daor path se henujagon nykeā trail.'
        </h5>
