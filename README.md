<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'To seek greatness is the only righteous vengeance.' was translated to sindarin language, and the result is: 'Na seek greatness na- i onlui righteous vengeance.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                16.64°C, however it feels like 16.06°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 16.64°C
            Max. temperature: 16.64°C
        </p>
    </div>
    <div id="wakatime">
        <p>
