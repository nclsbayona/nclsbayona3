<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Great things are done by a series of small things brought together.' was translated to oldenglish language, and the result is: ' {Great} {things} m¯æran {done} by dimf b¯æm tôendebyrdnes un−l¯æd unmycel {things} {brought} ðw¯ære.'
        </h5>
