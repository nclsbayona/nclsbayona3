<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Stop creating a life that you need a vacation from. Instead move to where you want to live, do what you want to do, start what you want to start and create the life you want today. This isn't rehearsal people. This is YOUR life.' was translated to oldenglish language, and the result is: ' {Stop} {creating} bêgra winde ðæt êower feormian a {vacation} ±unnen and thing. {Instead} onhrêran oðferian ð¯ær and there êow wan¯æht hêan fremian, ðrôwian {what} êower êaca æthebban lufian, styrtan {what} êower winn cuman steort s ðâ âtýdran dôð sâwolhord êow ðurfe {today}. {This} {isn't} {rehearsal} mennisc. {This} {is} {YOUR} ferhðsefa.'
        </h5>
