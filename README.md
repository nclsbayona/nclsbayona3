<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Life can only be understood backwards; but it must be lived forwards.' was translated to pig-latin language, and the result is: 'ife-Lay an-cay only-way e-bay understood-way backwards; ut-bay it-way ust-may e-bay ived-lay orwards-fay. '
        </h5>
