<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'At that point where you have decided to upgrade from aspiration to expectation and have begun to visualize an outcome, something incredibly important has happened, you have committed to the process of change.' was translated to oldenglish language, and the result is: ' {At} ' right to own or occupy land or connected with its occupation ord thither êow benohte stîðlic later {upgrade} on−dr¯ædan {aspiration} æthebban hyht heonu imp hafa {begun} intô with {visualize} ealdgenîðla ûtan−cumen, wiht {incredibly} hebbendlic {has} {happened}, êower brûcan {committed} lecgan sê {process} un−l¯æd ymbcyrran.'
        </h5>
