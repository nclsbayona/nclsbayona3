<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Stress is like a pulse, if you have it you are alive.' was translated to sindarin language, and the result is: 'Stress na- like a pulse,  if cin gar- ha cin are cuin.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                10.9°C, however it feels like 10.55°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 10.9°C
            Max. temperature: 10.9°C
        </p>
    </div>
    <div id="wakatime">
        <p>
