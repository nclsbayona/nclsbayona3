<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'For the things we have to learn before we can do them, we learn by doing them.' was translated to vulcan language, and the result is: 'Na' wuh vel etek ma tor oren-tor fa' etek mokuhlek tor au,  etek oren-tor k' doing au.'
        </h5>
