<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Everything has its beauty, but not everyone sees it. ' was translated to sindarin language, and the result is: 'Everything has its beautui,  but ú- everyone sees ha.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                13.67°C, however it feels like 13.36°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 13.67°C
            Max. temperature: 13.67°C
        </p>
    </div>
    <div id="wakatime">
        <p>
