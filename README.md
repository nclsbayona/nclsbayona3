<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'I skate to where the puck is going to be, not where it has been.' was translated to minion language, and the result is: 'ka skate da donde ta puck tis pata da be, non donde pik hego bem.'
        </h5>
