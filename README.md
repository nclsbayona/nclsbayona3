<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'You are the sky. Everything else - it's just the weather.' was translated to yoda language, and the result is: 'The sky,  you are.Everything else - it's just the weather.'
        </h5>
