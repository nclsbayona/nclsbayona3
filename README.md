<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'A leader is one who knows the way, goes the way, and shows the way.' was translated to yoda language, and the result is: 'One who knows the way,  a leader is,The way,  goes,The way,  and shows.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                15.76°C, however it feels like 15.45°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 15.76°C
            Max. temperature: 15.76°C
        </p>
    </div>
    <div id="wakatime">
        <p>
