<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'When you get up in the morning, you have two choices - either to be happy or to be unhappy. Just choose to be happy.' was translated to oldenglish language, and the result is: ' {When} êower fâcian uppe toward dôð morgenlic, êow âgen twi−prefix with meaning {choices} {-} âhwæðer âweorpan sîn gôdspêdig ðe ðritig n¯æman bêon f¯æge fey. {Just} âlesan stêpan weorðan sêl.'
        </h5>
