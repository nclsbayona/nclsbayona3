<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Vision without action is daydream. Action without vision is nightmare..' was translated to oldenglish language, and the result is: ' {Vision} ûte weorcd¯æd {is} {daydream}. {Action} ûte +siht {is} mare.'
        </h5>
