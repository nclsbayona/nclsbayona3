<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Whenever you find yourself on the side of the majority, it is time to reform.' was translated to oldenglish language, and the result is: ' {Whenever} êower begietan {yourself} in dôð sîdfeaxe râd sê {majority}, hîe {is} stund cuman hîwl¯æcan.'
        </h5>
