<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Only a man who knows what it is like to be defeated can reach down to the bottom of his soul and come up with the extra ounce of power it takes to win when the match is even.' was translated to oldenglish language, and the result is: ' {Only} a gumrinc sê ðâ ðe {knows} {what} hîe {is} mæc stellan weorðan sigelêas canne âwinnan  ben¯æman duguð ground orgilde sîn môdsefa to fêdan uppe mid duguð {extra} yndse orgilde handgeweald hê {takes} forniman earnian yonder ðone as efenl¯æcan {is} swîgtîma.'
        </h5>
