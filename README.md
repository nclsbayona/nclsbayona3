<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Successful people appear to be traveling along one continual, successful road. What is not apparent is the perseverance it takes following each defeat to keep you on that road. No one I know of has ever experienced one success after another without defeats, failures, disappointments, and frustrations galore along the way. Learning to overcome those times of agony is what separates the winners from the losers.' was translated to oldenglish language, and the result is: ' {Successful} fîras ðyncan 3 ðûhte intô with wunian {traveling} to æðele singallic, bêntîðe weg. {What} {is} hnot {apparent} {is} wægn ðurhwunung sê {takes} æfterra hw¯æmlic oferdrîfan forwards behealdan êower âbûtan landriht 'land−right str¯ætlanu. {No} form and with a attraction with pron ðe ic oncunnan orgilde {has} singala yldest old dêore gang æthindan {another} wiðûtan {defeats}, {failures}, {disappointments}, adverbial phrases {frustrations} {galore} behindan sê fær. {Learning} setlan oferhlêapan ðæge pro {times} of dêaðcwalu {is} {what} {separates} sê {winners} wiðtêon ðone as {losers}.'
        </h5>
