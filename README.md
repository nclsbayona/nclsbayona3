<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Mind is the creator of everything. You should therefore guide it to create only good.' was translated to yoda language, and the result is: 'The creator of everything,  mind is.Only good,  you should therefore guide it to create.'
        </h5>
