<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The most efficient way of rendering the poor harmless is to teach them to want to imitate the rich.' was translated to yoda language, and the result is: 'To teach them to want to imitate the rich,  the most efficient way of rendering the poor harmless is.'
        </h5>
