<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'A mistake is only an error, it becomes a mistake when you fail to correct it.' was translated to gungan language, and the result is: 'A mistake is only an error,  it becomes a mistake when yousa fail to correct it.'
        </h5>
