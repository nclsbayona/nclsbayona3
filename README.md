<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Time doesn't heal emotional pain, you need to learn how to let go.' was translated to dothraki language, and the result is: 'Kashi doesn't heal emotional athnithar,  yeri need to learn kirekosi to let gwe.'
        </h5>
