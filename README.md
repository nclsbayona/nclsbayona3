<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'While we may not be able to control all that happens to us, we can control what happens inside us.' was translated to vulcan language, and the result is: 'Du' etek lau ri nam-tor kup tor tash ek' ik pavesh-tor tor etek,  etek mokuhlek tash ra pavesh-tor svi'udish etek.'
        </h5>
