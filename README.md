<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The most efficient way of rendering the poor harmless is to teach them to want to imitate the rich.' was translated to gungan language, and the result is: 'Dha most efficient way of render dha poor harmless is to teach them-sa to want to imitate dha rich.'
        </h5>
