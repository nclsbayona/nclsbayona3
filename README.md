<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'When you judge another, you do not define them, you define yourself' was translated to valyrian language, and the result is: 'Skori ao judge another,  ao gaomagon daor define zirȳ,  ao define aōla'
        </h5>
