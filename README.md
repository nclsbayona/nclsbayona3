<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Darkness must pass. A new day will come. And when the sun shines, it will shine out the clearer.' was translated to vulcan language, and the result is: 'Mu'khlup'es bolau be' dvun. Wuh uzh gad dungi sarlah. Heh lu wuh yel min-tor,  ish-veh dungi min-tor si' wuh clearer.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                19.51°C, however it feels like 18.77°C, climate is
                <i>scattered clouds</i>
            .
            Min. temperature: 19.51°C
            Max. temperature: 19.51°C
        </p>
    </div>
    <div id="wakatime">
        <p>
