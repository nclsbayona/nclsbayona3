<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The single biggest problem in communication is the illusion that it has taken place.' was translated to sindarin language, and the result is: 'I minei biggest problem in communication na- i illusion i ha has taken near.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                17.07°C, however it feels like 16.48°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 17.07°C
            Max. temperature: 17.07°C
        </p>
    </div>
    <div id="wakatime">
        <p>
