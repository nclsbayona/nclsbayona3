<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Time to improve is limited. The clock is always on and doesn't care if you don't feel like it. Someone else does and they're passing you by.' was translated to oldenglish language, and the result is: ' {Time} besettan gôdian {is} tælfæst. {The} {clock} {is} at any time ætrihte ðêana {doesn't} broc gif êow {don't} onfindan efen hit hê. {Someone} ellor {does} from {they're} hwîlen êower fore.'
        </h5>
