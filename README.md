<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'In a world of change, the learners shall inherit the earth, while the learned shall find themselves perfectly suited for a world that no longer exists.' was translated to pirate language, and the result is: 'In a world o' change, th' learners shall inherit th' earth, while th' learned shall find themselves perfectly suited fer a world that no longer exists.'
        </h5>
