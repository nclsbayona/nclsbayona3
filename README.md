<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'When you have a dream, you've got to grab it and never let go.' was translated to oldenglish language, and the result is: ' {When} êower behealdan weargbr¯æde swefnian, {you've} {got} frambringan {grab} hit hê verb n¯æfre ðolian ongêanfêran.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                5.73°C, however it feels like 4.73°C, climate is
                <i>mist</i>
            .
