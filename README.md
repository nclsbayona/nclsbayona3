<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you cling to a certain thought with dynamic will power, it finally assumes a tangible outward form.' was translated to oldenglish language, and the result is: ' {If} êow clingan stellan bêgra I ðeaht mid {dynamic} tôdêman mægenðrymm, man sîð æt sîðestan {assumes} weargbr¯æde grâpigendlic ûtanweard m¯ægwlite.'
        </h5>
