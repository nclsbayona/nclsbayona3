<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'There can be no greater gift than that of giving one's time and energy to help others without expecting anything in return.' was translated to oldenglish language, and the result is: ' {There} canne cunnon n¯æfre {greater} forgifung {than} ðone as un−l¯æd tîð {one's} nêadðearfnes swâðêah arodscipe hêan help {others} bûtan {expecting} edwihte into hweorfan.'
        </h5>
