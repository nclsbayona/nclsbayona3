<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Don't forget to enjoy the journey' was translated to oldenglish language, and the result is: ' {Don't} ofergitolian (gyden benohte ðone as geondscrîðing'
        </h5>
