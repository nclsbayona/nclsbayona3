<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'When it comes to winning, you need the skill and the will.' was translated to oldenglish language, and the result is: ' {When} hîe {comes} into {winning}, êow ongehýðnes dôð l¯ærednes wislic sê willa.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                8.22°C, however it feels like 8.22°C, climate is
                <i>scattered clouds</i>
            .
            Min. temperature: 8.22°C
            Max. temperature: 8.22°C
        </p>
    </div>
    <div id="wakatime">
        <p>
