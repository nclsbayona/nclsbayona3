<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Men do not attract which they want but that which they are.' was translated to vulcan language, and the result is: 'Sasu ri tor skamau if au aitlun tonk'peh ik if au nam-tor.'
        </h5>
