<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Power is not what we do but what we do not - hasty and unwise actions that we repeat every day and which ultimately bring us into trouble.' was translated to pirate language, and the result is: 'Power be not what we do but what we dern't - hasty and unwise actions that we repeat every day and which ultimately brin' us into trouble.'
        </h5>
