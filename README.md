<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'I believe that potential is unlimited - success depends on daring to act on dreams.   ' was translated to oldenglish language, and the result is: ' attraction with pron ðe ic belýfan ðe {potential} {is} {unlimited} {-} fremming {depends} ætrihte nêðing oðtêon macian hû−hwega {dreams}.   '
        </h5>
