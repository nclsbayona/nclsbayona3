<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Not all of us can do great things. But we can do small things with great love.' was translated to oldenglish language, and the result is: ' {Not} {all} un−l¯æd ûs of pro ic canne cwylmian oferm¯ætlic {things}. {But} attraction with pron ðe ic canne eardian and smæll {things} mid ungrund môdlufu.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                22.53°C, however it feels like 22.12°C, climate is
                <i>few clouds</i>
            .
            Min. temperature: 19.73°C
            Max. temperature: 22.53°C
        </p>
    </div>
    <div id="wakatime">
        <p>
