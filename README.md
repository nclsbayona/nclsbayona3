<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The most wasted day of all is that on which we have not laughed.' was translated to oldenglish language, and the result is: ' {The} m¯æst ðynhl¯æne tîdd¯æg râd {all} {is} ðæt âbûtan tôhwon attraction with pron ðe ic ofercuman nâteðæshwôn {laughed}.'
        </h5>
