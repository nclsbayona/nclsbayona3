<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Don't be afraid of losing, be afraid of playing a game and not learning something.' was translated to oldenglish language, and the result is: ' {Don't} swîcan fyrht un−l¯æd {losing}, libban de forhtlic of plegende tîma gamenian ðigen nâ bôccræft sum inde.'
        </h5>
