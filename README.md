<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'When I was a little kid, I was really scared of the dark. But then I came to understand, dark just means the absence of photons in the visible wavelength 400 to 700 nanometers. Then I thought, well it's really silly to be afraid of a lack of photons. Then I wasn't afraid of the dark anymore after that.' was translated to oldenglish language, and the result is: ' {When} attraction with pron ðe ic {was} bêgra lýtel ticcen, attraction with pron ðe ic {was} sôðlic {scared} râd sê ðêostre. {But} ð¯ær and there attraction with pron ðe ic {came} unnon forcýðan, ðûhsian ferhtlic n¯æm duguð  orgilde {photons} samod sê sîenelic {wavelength} {400} oððicgan {700} {nanometers}. {Then} attraction with pron ðe ic môdgehygd, stîðe {it's} sôðe lêasferðnes besettan cunnon fyrht of weargbr¯æde forðolian orgilde {photons}. {Then} ic pro {wasn't} forht orgilde duguð dungr¯æg {anymore}  landriht 'land−right.'
        </h5>
