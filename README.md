<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Sometimes, the only way to evolve is to open ourselves fully.' was translated to yoda language, and the result is: 'Sometimes,Is to open ourselves fully,  the only way to evolve.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                11.79°C, however it feels like 11.56°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 11.79°C
            Max. temperature: 11.79°C
        </p>
    </div>
    <div id="wakatime">
        <p>
