<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Kindness is a language which the deaf can hear and the blind can see.' was translated to vulcan language, and the result is: 'Kindness nam-tor wuh gen-lis if wuh zhu-fam mokuhlek zhu-tor heh wuh glan-fam mokuhlek gla-tor.'
        </h5>
