<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Great ambition is the passion of a great character. Those endowed with it may perform very good or very bad acts. All depends on the principals which direct them.' was translated to oldenglish language, and the result is: ' {Great} rîcetere {is} ðone as wêamôdnes un−l¯æd a micel cynd. {Those} môdwelig mid ðæge pro mêowle full−gân 3 scearplic ungnýðe ge bitre fracoð {acts}. {All} {depends} ymbe dôð {principals} ðætte word ðæge pro.'
        </h5>
