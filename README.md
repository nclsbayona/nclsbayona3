<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'At first dreams seem impossible, then improbable, then inevitable.' was translated to huttese language, and the result is: 'At first dreams seem impossible,  then improbable,  then inevitable.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                17.33°C, however it feels like 16.87°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 17.33°C
            Max. temperature: 17.33°C
        </p>
    </div>
    <div id="wakatime">
        <p>
