<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Only when one allows themself the right to die, do they then give yourself the permission to live.' was translated to sindarin language, and the result is: 'Onlui ir er allows themself i foeir na bel-,  ceri- hain then on- yourself i dáf na guin-.'
        </h5>
