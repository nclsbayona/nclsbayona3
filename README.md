<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you can't feed a hundred people, then feed just one.' was translated to sindarin language, and the result is: 'If cin tur-'t feed a hoth núr,  then feed just er.'
        </h5>
