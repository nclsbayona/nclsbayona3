<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Setting goals is the first step in turning the invisible into the visible.' was translated to sith language, and the result is: 'Fonas goals kash tave karuvis step kash eilemas tave xratonas je'as tave matomas.'
        </h5>
