<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'When I was a little kid, I was really scared of the dark. But then I came to understand, dark just means the absence of photons in the visible wavelength 400 to 700 nanometers. Then I thought, well it's really silly to be afraid of a lack of photons. Then I wasn't afraid of the dark anymore after that.' was translated to oldenglish language, and the result is: ' {When} ic pro {was} a hwôn hêcen, ic pro {was} sôðe {scared} râd sê unandgytful. {But} ðærrihtes ic pro {came} n¯æman wiste, nifol sôðfæst scield wægn æfweardnes un−l¯æd {photons} in sê êaðgesýne {wavelength} {400} tôgêanes and {700} {nanometers}. {Then} attraction with pron ðe ic hygd (at, cyrten {it's} sôðe dysigdôm unnon swîcan fyrht orgilde tîma wana orgilde {photons}. {Then} ic pro {wasn't} forhtlic râd dôð ðêostorful {anymore} sîð æt sîðestan ðæt.'
        </h5>
