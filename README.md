<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'A dead thing can go with the stream, but only a living thing can go against it.' was translated to sindarin language, and the result is: 'A firn nad tur- glenn- with i old,  but onlui a living nad tur- glenn- dan ha.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                24.73°C, however it feels like 25.71°C, climate is
                <i>scattered clouds</i>
            .
            Min. temperature: 24.73°C
            Max. temperature: 24.73°C
        </p>
    </div>
    <div id="wakatime">
        <p>
