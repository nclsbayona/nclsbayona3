<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'We must not sit down and wait for miracles. Up and be going!' was translated to cheunh language, and the result is: 'Nah ch'urci nah reb rcin'i'ohn vim ch'acan'b tur miracles. Up vim vacosehn going!'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                10.48°C, however it feels like 9.99°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 10.48°C
            Max. temperature: 10.48°C
        </p>
    </div>
    <div id="wakatime">
        <p>
