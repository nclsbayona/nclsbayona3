<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Why do you stay in prison when the door is so wide open?' was translated to oldenglish language, and the result is: ' {Why} eardian and êower stapol fullan dung lôca in sê hyrd {is} adverbial phrases ginn {open?}'
        </h5>
