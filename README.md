<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Successful people appear to be traveling along one continual, successful road. What is not apparent is the perseverance it takes following each defeat to keep you on that road. No one I know of has ever experienced one success after another without defeats, failures, disappointments, and frustrations galore along the way. Learning to overcome those times of agony is what separates the winners from the losers.' was translated to oldenglish language, and the result is: ' {Successful} lêodweras onwrêon âîeðan sîn {traveling} uppan dryhtlic âwunigende, bêntîðe burgweg. {What} {is} nealles {apparent} {is} sê ðurhwunung ðæge pro {takes} æftanweard ân oferdrîfan more distant cêpan êow toward ðæt worðig. {No} micellic ic pro oncunnan of {has} singale antique rôf spêd lâst {another} lêas {defeats}, {failures}, {disappointments}, ðigen {frustrations} {galore} âlangian duguð wîse. {Learning} hêan endian ðæge pro {times} râd dêaðcwalu {is} {what} {separates} dôð {winners} intô with duguð {losers}.'
        </h5>
