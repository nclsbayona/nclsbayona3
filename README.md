<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The most efficient way of rendering the poor harmless is to teach them to want to imitate the rich.' was translated to vulcan language, and the result is: 'Wuh danik yeht-urgam yut t' rendering wuh ri donku-tor harmless nam-tor tor saven-tor au tor aitlun tor va'amau wuh don-ka.'
        </h5>
