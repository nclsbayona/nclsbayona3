<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Your only limitations are those you set up in your mind or permit others to set up for you.' was translated to pirate language, and the result is: 'Your only limitations be those ye set up in yer mind or permit others t' set up fer ye.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                11.67°C, however it feels like 11.27°C, climate is
                <i>overcast clouds</i>
            .
