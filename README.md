<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'You'll find a way' was translated to minion language, and the result is: 'to'll awa a piu'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                12.69°C, however it feels like 12.44°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 12.69°C
            Max. temperature: 12.69°C
        </p>
    </div>
    <div id="wakatime">
        <p>
