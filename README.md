<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Learn from the mistakes of others. You can't live long enough to make them all yourself.' was translated to oldenglish language, and the result is: ' {Learn} ætdôn dôð {mistakes} orgilde {others}. {You} {can't} ræfn−an langsum +nðh lecgan tâwian ðæge pro {all} {yourself}.'
        </h5>
