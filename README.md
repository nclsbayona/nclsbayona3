<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Be thankful for everything that happens in your life; it's all an experience.' was translated to klingon language, and the result is: 'Qu' thankful for hoch 'e' happens in your yin; 'oh's hoch an wani'.'
        </h5>
