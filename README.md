<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'It only takes a split second to smile and forget, yet to someone that needed it, it can last a lifetime.' was translated to pirate language, and the result is: 'It only takes a split second t' smile and forget, yet t' someone that needed it, it can last a lifetime.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                8.9°C, however it feels like 8.9°C, climate is
                <i>broken clouds</i>
            .
            Min. temperature: 8.9°C
            Max. temperature: 8.9°C
        </p>
    </div>
    <div id="wakatime">
        <p>
