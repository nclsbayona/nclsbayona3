<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'What do we live for if not to make life less difficult for each other?' was translated to yoda language, and the result is: 'We live for if not to make life less difficult for each other,  what do?'
        </h5>
