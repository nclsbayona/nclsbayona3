<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'There is only one way to happiness and that is to cease worrying about things which are beyond the power or our will.' was translated to klingon language, and the result is: 'Pa' is neh wa' way to happiness 'ej 'e' is to mev worrying about things which are beyond the ngup qoj our will.'
        </h5>
