<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Repetition does not transform a lie into a truth.' was translated to dothraki language, and the result is: 'Repetition does vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) transform a qosarvenikh mra a truth.'
        </h5>
