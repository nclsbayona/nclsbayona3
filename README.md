<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you have dreams it is your responsibility to make them happen.' was translated to sith language, and the result is: 'Ar tu zinot dreams zhol kash tu'iea responsibility kia fasona savimi rast.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                13.29°C, however it feels like 13.16°C, climate is
                <i>light rain</i>
            .
            Min. temperature: 13.29°C
            Max. temperature: 13.29°C
        </p>
    </div>
    <div id="wakatime">
        <p>
