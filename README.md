<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The meaning of life is just to be alive. It is so plain and so obvious and so simple.' was translated to oldenglish language, and the result is: ' {The} ongietenes orgilde ðanc {is} reðe oððicgan sý {alive}. {It} {is} adverbial phrases cûð wislic adverbial phrases {obvious} forð¯æm adverbial phrases scamfæst.'
        </h5>
