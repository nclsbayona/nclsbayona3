<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'No amount of regretting can change the past, and no amount of worrying can change the future.' was translated to yoda language, and the result is: 'No amount of regretting can change the past,And no amount of worrying can change the future.'
        </h5>
...
Garnish with 5 drops habanero tincture.
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                17.56°C, however it feels like 16.89°C, climate is
                <i>overcast clouds</i>
            .
