<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'It is only depth of character that determines the profundity with which we face life.' was translated to gungan language, and the result is: 'Isa only depth of character dat determines dha profundity with which wesa face life.'
        </h5>
