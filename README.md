<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The shoe that fits one person pinches another; there is no recipe for living that suits all cases.' was translated to huttese language, and the result is: 'Doe shoe da fits wompa person pinches andoba; ya sa noah recipe che living da suits all cases.'
        </h5>
