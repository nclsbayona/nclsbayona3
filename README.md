<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'When you say yes to change, you are choosing to navigate that path peacefully and happily and see where it takes you.' was translated to oldenglish language, and the result is: ' {When} êower rêsele gêse âlecgan fâgian, êow stêpan {choosing} ûtâðýdan {navigate} ðætte pæððan {peacefully} heonu s¯ælige for ðâm ðe sêon yonder hîe {takes} êow.'
        </h5>
