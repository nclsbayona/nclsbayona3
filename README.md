<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'You gotta commit. You've gotta go out there and improvise and you've gotta be completely unafraid to die. You've got to be able to take a chance to die. And you have to die lots. You have to die all the time.' was translated to oldenglish language, and the result is: ' {You} {gotta} onget¯æcan. {You've} {gotta} wendan âtêon {there} norðêast sb {improvise} forð¯æm {you've} {gotta} libban de onwealglîce {unafraid} unnon forðfaran. {You've} {got} æt−bregdan cûðe wr¯æst tôgêanes and grîpan bêgra wif scrift forðgewîtan. {And} êower warian (gyden dêadian {lots}. {You} forcuman hand forðgelêoran {all} dôð hwîl.'
        </h5>
