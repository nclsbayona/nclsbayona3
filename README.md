<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'One of the really tough things is figuring out what questions to ask. Once you figure out the question, then the answer is relatively easy.' was translated to yoda language, and the result is: 'Figuring out what questions to ask,  one of the really tough things is.Once you figure out the question,Relatively easy,  then the answer is.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                11.93°C, however it feels like 11.5°C, climate is
                <i>light rain</i>
            .
            Min. temperature: 11.93°C
            Max. temperature: 11.93°C
        </p>
    </div>
    <div id="wakatime">
        <p>
