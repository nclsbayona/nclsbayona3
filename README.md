<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If your mind is empty, it is always ready for anything, it is open to everything.' was translated to yoda language, and the result is: 'Empty,  if your mind is,Always ready for anything,  it is,Open to everything,  it is.'
        </h5>
