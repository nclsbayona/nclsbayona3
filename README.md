<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'We have more possibilities available in each moment than we realize.' was translated to vulcan language, and the result is: 'Etek ma weht possibilities la'ka-yehat svi' tik moment do etek realize.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                13.26°C, however it feels like 12.57°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 13.26°C
            Max. temperature: 13.26°C
        </p>
    </div>
    <div id="wakatime">
        <p>
