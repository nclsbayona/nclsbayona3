<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Time to improve is limited. The clock is always on and doesn't care if you don't feel like it. Someone else does and they're passing you by.' was translated to oldenglish language, and the result is: ' {Time} âweorpan beterian {is} âmetendlic. {The} {clock} {is} forweard uppan ðe {doesn't} sorgian heonu êow {don't} handlian efen hit hê. {Someone} elcra {does} fullan {they're} hwîlen êow by.'
        </h5>
