<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Forever is composed of now's.' was translated to vulcan language, and the result is: 'Ek'wak nam-tor tertitau t' i''s.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                13.4°C, however it feels like 12.7°C, climate is
                <i>light rain</i>
            .
            Min. temperature: 13.4°C
            Max. temperature: 13.4°C
        </p>
    </div>
    <div id="wakatime">
        <p>
