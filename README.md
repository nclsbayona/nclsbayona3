<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Alone we can do so little; together we can do so much.' was translated to gungan language, and the result is: 'Alone wesa can do so little; together wesa can do so mui.'
        </h5>
