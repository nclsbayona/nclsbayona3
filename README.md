<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you don't have confidence, you'll always find a way not to win' was translated to valyrian language, and the result is: 'Lo ao ȳdra daor emagon confidence,  ao'll va moriot find nykeā ñuhoso daor naejot ērinagon'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                14.15°C, however it feels like 13.79°C, climate is
                <i>light rain</i>
            .
            Min. temperature: 14.15°C
            Max. temperature: 14.15°C
        </p>
    </div>
    <div id="wakatime">
        <p>
