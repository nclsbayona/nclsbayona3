<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'This is the real secret of life - to be completely engaged with what you are doing in the here and now. And instead of calling it work, realize it is play.' was translated to valyrian language, and the result is: 'Bisa iksos se real secret hen glaeson - naejot sagon completely engaged rūsīr skoros ao issi doing isse se kesīr se sir. Se instead hen calling ziry mirre,  realize ziry iksos tymagon.'
        </h5>
