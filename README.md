<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Kindness is a language which the deaf can hear and the blind can see.' was translated to gungan language, and the result is: 'Kindness is a language which dha deaf can hear and dha blind can see.'
        </h5>
