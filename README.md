<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Vulnerability is not winning or losing; it's having the courage to show up and be seen when we have no control over the outcome.' was translated to oldenglish language, and the result is: ' {Vulnerability} {is} nâteshwôn {winning} ge {losing}; {it's} twihynde duguð wlenc stellan âcýðan uppe eornostlîce w¯ære sîene attraction with pron ðe ic we underfôn nâ feohgestrêon ofer sê ûtan−cumen.'
        </h5>
