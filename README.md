<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Your life is about to be incredible' was translated to ferblatin language, and the result is: 'our-Yerb ife-lerb is bout-aerb to be ncredible-ierb '
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                15.52°C, however it feels like 15.22°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 15.52°C
            Max. temperature: 15.52°C
        </p>
    </div>
    <div id="wakatime">
        <p>
