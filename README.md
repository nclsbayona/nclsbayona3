<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The act of taking the first step is what separates the winners from the losers.' was translated to dothraki language, and the result is: 'The tikh ki taking the atte step is fini separates the winners ha the losers.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                16.28°C, however it feels like 15.79°C, climate is
                <i>broken clouds</i>
            .
