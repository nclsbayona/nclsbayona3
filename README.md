<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you cling to a certain thought with dynamic will power, it finally assumes a tangible outward form.' was translated to oldenglish language, and the result is: ' {If} êow clingan wîte tîma wislic môdgehygd wið {dynamic} scearpsmêawung cyneðrymm, sê lætemest {assumes} bâm grâpigendlic ûtanweard hîw.'
        </h5>
