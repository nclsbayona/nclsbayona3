<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If we know how to adapt, we end up being superior.' was translated to yoda language, and the result is: 'How to adapt,  if we know,We end up being superior.'
        </h5>
