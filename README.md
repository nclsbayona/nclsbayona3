<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'To be calm is the highest achievement of the self.' was translated to oldenglish language, and the result is: ' {To} licgan liðewâcian {is} dôð hîehst {achievement} of ðone as self.'
        </h5>
