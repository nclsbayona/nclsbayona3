<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'It will never rain roses: when we want to have more roses, we must plant more roses.' was translated to vulcan language, and the result is: 'Ish-veh dungi worla sov-masu roses: lu etek aitlun ki' weht roses,  etek bolau kastik weht roses.'
        </h5>
