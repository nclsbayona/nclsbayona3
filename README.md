<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Knowledge is a treasure, but practice is the key to it.' was translated to pirate language, and the result is: 'Knowledge be a booty, but practice be th' key t' it.'
        </h5>
