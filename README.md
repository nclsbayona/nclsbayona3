<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'In all human affairs there are efforts, and there are results, and the strength of the effort is the measure of the result.' was translated to sindarin language, and the result is: 'In all firen affairs ennas are efforts,  a ennas are results,  a i polod -o i effort na- i measure -o i result.'
        </h5>
