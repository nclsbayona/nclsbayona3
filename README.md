<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Successful people appear to be traveling along one continual, successful road. What is not apparent is the perseverance it takes following each defeat to keep you on that road. No one I know of has ever experienced one success after another without defeats, failures, disappointments, and frustrations galore along the way. Learning to overcome those times of agony is what separates the winners from the losers.' was translated to oldenglish language, and the result is: ' {Successful} _man bôgung setlan sý {traveling} into duguðlic âwunigende, bêntigðe sîðfæt. {What} {is} nealles {apparent} {is} sê singalnes hê {takes} fylignes welhwâ pro wîghryre forwards 3 3 êow of landriht 'land−right eorðbyrig. {No} ânlic attraction with pron ðe ic tôcnâwan of {has} synnes antique tîrfæst gang siððan {another} d¯ællêas {defeats}, {failures}, {disappointments}, sôðhweðere {frustrations} {galore} sîð æt sîðestan duguð lâd. {Learning} âstellan beswican ðæge pro {times} un−l¯æd dêaðcwalu {is} {what} {separates} ðone as {winners} ðêon ðone as {losers}.'
        </h5>
