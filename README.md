<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Only the hand that erases can write the true thing.' was translated to klingon language, and the result is: 'Neh the ghop 'e' erases can ghitlh the hislah doch.'
        </h5>
