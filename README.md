<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Success is often achieved by those who don't know that failure is inevitable.' was translated to oldenglish language, and the result is: ' {Success} {is} neahhelîce {achieved} fullan ðâs ðætte {don't} ongietan ' right to own or occupy land or connected with its occupation forwordenes {is} unâfeohtendlic.'
        </h5>
