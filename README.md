<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Successful people appear to be traveling along one continual, successful road. What is not apparent is the perseverance it takes following each defeat to keep you on that road. No one I know of has ever experienced one success after another without defeats, failures, disappointments, and frustrations galore along the way. Learning to overcome those times of agony is what separates the winners from the losers.' was translated to oldenglish language, and the result is: ' {Successful} cynn ðyncan 3 ðûhte âdôn w¯ære {traveling} wiðæftan æðellic singallic, bêntigðe lâd. {What} {is} nâteðæshwôn {apparent} {is} wægn wunenes hit hê {takes} æfterra welhwâ pro forhîenan intô with wîtan êow ymbûtan and ðætte sîðfat. {No} dêore ic pro oncunnan râd {has} fyrhð antique wuldrig ðyngo âlangian {another} wiðûtan {defeats}, {failures}, {disappointments}, adverbial phrases {frustrations} {galore} beæftan duguð færeld. {Learning} ûðe âlecgendlic word ðæge pro {times} un−l¯æd dêaðcwealm {is} {what} {separates} sê {winners} lecgan sê {losers}.'
        </h5>
