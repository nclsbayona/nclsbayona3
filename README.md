<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The only real mistake is the one from which we learn nothing. ' was translated to huttese language, and the result is: 'Doe only ree mistake sa doe wompa tuta which jee-jee learn nothing.'
        </h5>
