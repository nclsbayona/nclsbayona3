<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If light is in your heart, you will find your way home.  ' was translated to pirate language, and the result is: 'If light be in yer heart, ye will find yer way home.  And swab the deck!  Aarrr!  '
        </h5>
...
Garnish with a slice of lemon…Enjoy!
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                10.15°C, however it feels like 9.7°C, climate is
                <i>broken clouds</i>
            .
            Min. temperature: 10.15°C
            Max. temperature: 10.15°C
        </p>
    </div>
    <div id="wakatime">
        <p>
