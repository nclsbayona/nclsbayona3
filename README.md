<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you don't have confidence, you'll always find a way not to win' was translated to minion language, and the result is: 'asa to domo kaylay dabich, to'll adtut awa a piu non da toop'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                16.42°C, however it feels like 16.13°C, climate is
                <i>broken clouds</i>
            .
            Min. temperature: 16.42°C
            Max. temperature: 16.42°C
        </p>
    </div>
    <div id="wakatime">
        <p>
    ...
    <tbody>
        <tr>
            ...
            <td style="padding-left: 1em; padding-right: 1em; text-align: center; vertical-align: top">33 hours and 4 minutes</td>
        </tr>
        <tr>
    ...
    <tbody>
        <tr>
            ...
            <td style="padding-left: 1em; padding-right: 1em; text-align: center; vertical-align: top">35 hours and 37 minutes</td>
        </tr>
    </tbody>
</table>
        <hr>
