<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If we ever stop thinking about the person we want to become, we stop learning and taking risks.' was translated to oldenglish language, and the result is: ' {If} attraction with pron ðe ic wîde−ferhð oflinnan {thinking} wel ðone as hâd we hafenlêast ætniman limpan, we âstyntan bôclâr ge bewerung {risks}.'
        </h5>
