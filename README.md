<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Predicting Rain Doesn't Count. Building Arks Does.' was translated to huttese language, and the result is: 'Predicting rain doesn't count. Building arks does.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                11.52°C, however it feels like 11.26°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 11.52°C
            Max. temperature: 11.52°C
        </p>
    </div>
    <div id="wakatime">
        <p>
