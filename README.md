<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The journey, not the destination matters.' was translated to gungan language, and the result is: 'Dha journey,  not dha destination matters.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                14.03°C, however it feels like 13.86°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 14.03°C
            Max. temperature: 14.03°C
        </p>
    </div>
    <div id="wakatime">
        <p>
