<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Any fool can paint a picture, but it takes a wise man to be able to sell it.' was translated to oldenglish language, and the result is: ' {Any} wanhoga canne onmêtan bêga tîfrung, sifeða sê {takes} dimf b¯æm ðanc−snotor woruldbearn from− w¯æren important hêan bebycgan sê.'
        </h5>
