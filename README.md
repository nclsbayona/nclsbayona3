<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Do you have the patience to wait until your mud settles and the water is clear?' was translated to oldenglish language, and the result is: ' {Do} êower besittan ðone as ðyld to lettan nêah êower clâm {settles} for ðâm ðe duguð hwearfian {is} {clear?}'
        </h5>
