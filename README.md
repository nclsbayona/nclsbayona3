<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you want work well done, select a busy man; the other kind has no time.' was translated to minion language, and the result is: 'asa to quer traba lam pin, regbo a doe ka; ta orto nace hego no veela.'
        </h5>
