<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Small progress is still progress' was translated to oldenglish language, and the result is: ' {Small} forðsîð {is} âcêlan ðyngo'
        </h5>
...
Garnish with fresh pineapple or lime.
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                14.76°C, however it feels like 14.38°C, climate is
                <i>light rain</i>
            .
            Min. temperature: 14.76°C
            Max. temperature: 14.76°C
        </p>
    </div>
    <div id="wakatime">
        <p>
