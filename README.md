<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you're not making mistakes, you're not taking risks, and that means you're not going anywhere. The key is to make mistakes faster than the competition, so you have more changes to learn and win.' was translated to vulcan language, and the result is: 'Kuv du're ri tor lafosh,  du're ri taking risks,  heh ik tvai du're ri going sovek-wilat. Wuh tal-muv nam-tor tor tor lafosh faster do wuh kuhlaya,  ni du ma weht rubai tor oren-tor heh skil.'
        </h5>
    ...
    <div id="drink">
        ...
        <img src="https://www.thecocktaildb.com/images/media/drink/t5pv461606773026.jpg">
        <h4>
            <font color="#F0A0FF">
