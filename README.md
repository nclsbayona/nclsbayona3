<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The only real mistake is the one from which we learn nothing. ' was translated to dothraki language, and the result is: 'The disse tawak mistake is the ato ha which kisha learn vosi.'
        </h5>
