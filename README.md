<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If anything is worth doing, do it with all your heart.' was translated to yoda language, and the result is: 'Worth doing,  if anything is,It with all your heart,  do.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                15.6°C, however it feels like 15.17°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 15.6°C
            Max. temperature: 15.6°C
        </p>
    </div>
    <div id="wakatime">
        <p>
