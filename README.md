<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you can consciously let yourself get taken and see where you go, that's an exercise. That's discipline. To follow the scent. Let yourself go and see what happens, that takes a bit of courage.' was translated to oldenglish language, and the result is: ' {If} êower canne {consciously} lêafe {yourself} hr¯æcan and t¯æse verb lôc yonder êower hweorfan, {that's} ealdgenîðla ðêodland. {That's} ðêawfæstnes. {To} forðfolgian sê unstenc. {Let} {yourself} edcierr lôc scîr {what} {happens}, landriht 'land−right {takes} dimf b¯æm wealdleðer orgilde wuldor.'
        </h5>
