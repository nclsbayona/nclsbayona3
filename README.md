<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Don't let the noise of others' opinions drown out your own inner voice.' was translated to klingon language, and the result is: 'Don't let the wab of others' opinions drown out your own inner ghogh.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                13.49°C, however it feels like 13.04°C, climate is
                <i>broken clouds</i>
            .
            Min. temperature: 13.49°C
            Max. temperature: 13.49°C
        </p>
    </div>
    <div id="wakatime">
        <p>
