<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Catch, then, O catch the transient hour; Improve each moment as it flies! ' was translated to oldenglish language, and the result is: ' {Catch}, ðærrihtes, middangeard rif sê unstæððig tîd; {Improve} hwæðer prince samðe in phrase samðsamð hê mysci! '
        </h5>
