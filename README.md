<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Our greatest weakness lies in giving up. The most certain way to succeed is always to try just one more time.' was translated to yoda language, and the result is: 'In giving up,  our greatest weakness lies.Is always to try just one more time,  the most certain way to succeed.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                8.55°C, however it feels like 8.12°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 8.55°C
            Max. temperature: 8.55°C
        </p>
    </div>
    <div id="wakatime">
        <p>
