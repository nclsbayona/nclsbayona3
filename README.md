<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Not every day is going to offer us a chance to save somebody's life, but every day offers us an opportunity to affect one.' was translated to oldenglish language, and the result is: ' {Not} welhwilc pro lîf {is} faru ±unnen and thing bewægnan ûs of pro ic weargbr¯æde wif ûtâðýdan wiðl¯ædan {somebody's} witloca, ðêah welhwilc pro dægtîma {offers} ûs of pro ic ealdgenîðla limplicnes forwards {affect} beloved.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                15.05°C, however it feels like 14.86°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 15.05°C
            Max. temperature: 15.05°C
        </p>
    </div>
    <div id="wakatime">
        <p>
