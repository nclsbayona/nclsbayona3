<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you want to make your dreams come true, the first thing you have to do is wake up.' was translated to oldenglish language, and the result is: ' {If} êower unspêd ætniman onstellan êower {dreams} dîgan ælt¯æwe, sê ærest wlite êower forcuman verb ræfn−an {is} wæccan ûpweardes.'
        </h5>
