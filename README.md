<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Character is doing what you don't want to do but know you should do.' was translated to oldenglish language, and the result is: ' {Character} {is} macung {what} êow {don't} nîedðearfnes cuman timbrian from becnâwan êow {should} fremman.'
        </h5>
