<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'It is far easier to start something than it is to finish it.' was translated to klingon language, and the result is: ''oh is far easier to wa'dich vay' than 'oh is to finish 'oh.'
        </h5>
