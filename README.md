<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Perfection is not attainable, but if we chase perfection we can catch excellence..' was translated to klingon language, and the result is: 'Perfection is not attainable,  'ach if mah tlha' perfection mah can suq excellence.'
        </h5>
