<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'We lose ourselves in the things we love. We find ourselves there, too.' was translated to oldenglish language, and the result is: ' {We} âlecgan {ourselves} hwonne ðone as {things} we myne. {We} findan {ourselves} {there}, ðætte.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                16.74°C, however it feels like 16.48°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 16.74°C
            Max. temperature: 16.74°C
        </p>
    </div>
    <div id="wakatime">
        <p>
