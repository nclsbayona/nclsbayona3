<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Obstacles don't block the path, they are the path.' was translated to ferblatin language, and the result is: 'bstacles-Oerb don't lock-berb he-terb ath-perb, hey-terb re-aerb he-terb path. '
        </h5>
