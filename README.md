<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'From morning till night, we should never rely on a single thing.' was translated to valyrian language, and the result is: 'Hen tubis till bantis,  īlon should dōrī rely va nykeā single mirre.'
        </h5>
