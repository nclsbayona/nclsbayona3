<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Time doesn't heal emotional pain, you need to learn how to let go.' was translated to yoda language, and the result is: 'Emotional pain,  time doesn't heal,How to let go,  you need to learn.'
        </h5>
