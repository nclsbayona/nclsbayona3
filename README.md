<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The only time you run out of chances is when you stop taking them.' was translated to sith language, and the result is: 'Tave tik amzi tu kelias del iv chances kash tikazi tu akida vyktimas savimi.'
        </h5>
