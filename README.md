<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'At that point where you have decided to upgrade from aspiration to expectation and have begun to visualize an outcome, something incredibly important has happened, you have committed to the process of change.' was translated to oldenglish language, and the result is: ' {At} ðe prica ðider êower weardian stîðlic stellan {upgrade} hand {aspiration} ûtâðýdan weard lôc imp hafa {begun} forwards {visualize} wiðerbreca ûtan−cumen, edwihte {incredibly} m¯ære {has} {happened}, êower weardian {committed} ben¯æman dôð {process} un−l¯æd hwierfan.'
        </h5>
