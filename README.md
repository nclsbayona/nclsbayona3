<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Pleasure can be supported by an illusion; but happiness rests upon truth. ' was translated to klingon language, and the result is: 'Bel can qu' supported by an illusion; 'ach happiness rests upon vit.'
        </h5>
