<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Decide upon your major definite purpose in life and then organize all your activities around it.' was translated to sindarin language, and the result is: 'Decide upon cín major definite thel- in cuil a then organize all cín activities os- ha.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                13.17°C, however it feels like 13°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 13.17°C
            Max. temperature: 13.17°C
        </p>
    </div>
    <div id="wakatime">
        <p>
