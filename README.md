<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Whenever we’re afraid, it’s because we don’t know enough. If we understood enough, we would never be afraid' was translated to oldenglish language, and the result is: ' {Whenever} {we’re} fyrht, {it’s} by reason of we {don’t} cnâwan +nðh. {If} we {understood} +nðh, attraction with pron ðe ic {would} ne bêon fyrht'
        </h5>
