<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'You may be disappointed if you fail, but you are doomed if you don't try.' was translated to oldenglish language, and the result is: ' {You} mêowle sý {disappointed} ð¯ær and there êow wealwian, swâðêah êower mæstling {doomed} heonu êower {don't} sêðan.'
        </h5>
