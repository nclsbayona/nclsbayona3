<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Your very silence shows you agree.' was translated to minion language, and the result is: 'tu mupa diffly eth to zzz.'
        </h5>
...
Divide the mango purée between the glasses and add 30ml white rum and a handful of crushed ice to each one, stirring well to mix everything together. Top up with soda water to serve and garnish with extra mint, if you like.
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                16.47°C, however it feels like 16.05°C, climate is
                <i>broken clouds</i>
            .
            Min. temperature: 16.47°C
            Max. temperature: 16.47°C
        </p>
    </div>
    <div id="wakatime">
        <p>
