<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Even if you stumble and fall down, it doesn't mean you've chosen the wrong path.' was translated to sindarin language, and the result is: 'Even if cin stumble a dant- dad,  ha doesn't foeg cin've chosen i roeg lond.'
        </h5>
