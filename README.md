<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Quality is more important than quantity. One home run is much better than two doubles.' was translated to oldenglish language, and the result is: ' {Quality} {is} later ûphêah {than} met. {One} êðel m êðles strîcan {is} miclum bet {than} wit {doubles}.'
        </h5>
