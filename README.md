<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'No problem can be solved from the same level of consciousness that created it.' was translated to klingon language, and the result is: 'Qo' problem can qu' solved from the same patlh of consciousness 'e' created 'oh.'
        </h5>
