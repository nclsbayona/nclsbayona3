<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you want to be happy, do not dwell in the past, do not worry about the future, focus on living fully in the present.' was translated to dothraki language, and the result is: 'If yeri want to be happy,  hash vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) dwell she the past,  hash vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) worry qisi the future,  focus she living nakhaan she the present.'
        </h5>
