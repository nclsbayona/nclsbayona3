<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'To lose your temper is only useful once a year.' was translated to huttese language, and the result is: 'Tah lose do temper sa only useful once do year.'
        </h5>
