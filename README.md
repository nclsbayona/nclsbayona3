<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Always be a first-rate version of yourself, instead of a second-rate version of someone else.' was translated to yoda language, and the result is: 'A first-rate version of yourself,  always be,Instead of a second-rate version of someone else.'
        </h5>
