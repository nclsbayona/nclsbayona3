<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Successful people appear to be traveling along one continual, successful road. What is not apparent is the perseverance it takes following each defeat to keep you on that road. No one I know of has ever experienced one success after another without defeats, failures, disappointments, and frustrations galore along the way. Learning to overcome those times of agony is what separates the winners from the losers.' was translated to oldenglish language, and the result is: ' {Successful} cynn wafung unnon w¯æren {traveling}  ân−feald singallic, forðgenge worð. {What} {is} nâteshwôn {apparent} {is} ðone as hyððo hîe {takes} æfterweard æghwilc wîghryre n¯æman imp hafa êower hû−hwega ðæt stîg. {No} unforcûð attraction with pron ðe ic becnâwan râd {has} woruldrîce aged micellic spêd lang {another} ûte {defeats}, {failures}, {disappointments}, ðigen {frustrations} {galore} lang wægn færeld. {Learning} æthebban oferstîgan ðâs {times} of dêaðcwalu {is} {what} {separates} duguð {winners} of wægn {losers}.'
        </h5>
