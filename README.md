<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Every time you are tempted to react in the same old way, ask if you want to be a prisoner of the past or a pioneer of the future.' was translated to oldenglish language, and the result is: ' {Every} tîd êow ârweorðian {tempted} ætniman {react} ofer sê self gamolferhð foldweg, ofâcsian thither êower nîedðearf oð faran hlêg hæftend orgilde dôð beleorendlic ge wýscan {pioneer} râd dôð tôweard.'
        </h5>
