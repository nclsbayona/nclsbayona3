<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The primary point of this existence is to live, and all living things move and grow.' was translated to oldenglish language, and the result is: ' {The} {primary} pricels râd tôhwon ðurhwunung {is} into bebrûcan, ge {all} lîffæst {things} æthrînan verb âgân.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                17.39°C, however it feels like 16.91°C, climate is
                <i>light rain</i>
            .
            Min. temperature: 17.39°C
            Max. temperature: 17.39°C
        </p>
    </div>
    <div id="wakatime">
        <p>
