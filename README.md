<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you want to be happy, set a goal that commands your thoughts, liberates your energy, and inspires your hopes.' was translated to pirate language, and the result is: 'If ye want t' be grog-filled, set a goal that commands yer thoughts, liberates yer energy, and inspires yer hopes.'
        </h5>
