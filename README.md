<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The greatest value of a picture is when it forces us to notice what we never expected to see.' was translated to yoda language, and the result is: 'When it forces us to notice what we never expected to see,  the greatest value of a picture is.'
        </h5>
