<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Whenever you find yourself on the side of the majority, it is time to reform.' was translated to sith language, and the result is: 'Whenever tu xauti tu'saen ant tave garthaz iv tave diduma,  zhol kash amzi kia reform.'
        </h5>
