<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'A different result requires doing something different.' was translated to huttese language, and the result is: 'Do different result requires doing something different.'
        </h5>
