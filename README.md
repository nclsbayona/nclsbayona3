<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'All that a man achieves and all that he fails to achieve is the direct result of his own thoughts.' was translated to mandalorian language, and the result is: 'An megin a tratur achieves bal an megin kaysh fails brokar achieve is te direct result be kaysh own thoughts.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                12.98°C, however it feels like 12.53°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 12.98°C
            Max. temperature: 12.98°C
        </p>
    </div>
    <div id="wakatime">
        <p>
