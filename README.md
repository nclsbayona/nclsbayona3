<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Growing up is losing some illusions, in order to acquire others.' was translated to pig-latin language, and the result is: 'owing-Gray up-way is-way osing-lay ome-say illusions-way, in-way order-way o-tay acquire-way others-way. '
        </h5>
