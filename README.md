<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Engage in those actions and thoughts that nurture the good qualities you want to have.' was translated to yoda language, and the result is: 'In those actions and thoughts that nurture the good qualities you want to have,  engage.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                16.94°C, however it feels like 16.26°C, climate is
                <i>few clouds</i>
            .
