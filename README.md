<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'A pessimist sees the difficulty in every opportunity; an optimist sees the opportunity in every difficulty.' was translated to oldenglish language, and the result is: ' oferhlýp {pessimist} {sees} ðone as hêanhâd nêan ân dafenlîcnes; wiðerbreca {optimist} {sees} ðone as tîdlicnes under ân unêaðelicnes.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                18.73°C, however it feels like 18.54°C, climate is
                <i>broken clouds</i>
            .
