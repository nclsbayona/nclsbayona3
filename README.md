<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Values are like fingerprints. Nobody's are the same, but you leave 'em all over everything you do.' was translated to klingon language, and the result is: 'Values are parha' fingerprints. Nobody's are the same,  'ach tlhih mej 'em hoch over hoch tlhih do.'
        </h5>
