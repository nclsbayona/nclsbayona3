<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Without struggle, no progress and no result. Every breaking of habit produces a change in the machine.' was translated to dothraki language, and the result is: 'Oma struggle,  vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) progress ma vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) result. Ei breaking ki habit produces a change she the machine.'
        </h5>
