<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'No problem can be solved from the same level of consciousness that created it.' was translated to vulcan language, and the result is: 'Rai wat mokuhlek nam-tor kilau s' wuh ka volik t' hokni'es ik fereik-tor ish-veh.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                13.34°C, however it feels like 12.74°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 13.34°C
            Max. temperature: 13.34°C
        </p>
    </div>
    <div id="wakatime">
        <p>
