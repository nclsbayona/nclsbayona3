<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Core passions and aspirations should be consistent and in sync.' was translated to mandalorian language, and the result is: 'Core passions bal aspirations should cuyir consistent bal o'r sync.'
        </h5>
