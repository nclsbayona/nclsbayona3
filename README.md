<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you're not making mistakes, you're not taking risks, and that means you're not going anywhere. The key is to make mistakes faster than the competition, so you have more changes to learn and win.' was translated to yoda language, and the result is: 'If you're not making mistakes,You're not taking risks,You're not going anywhere,  and that means.To make mistakes faster than the competition,  the key is,More changes to learn and win,  so you have.'
        </h5>
