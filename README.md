<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Fear can hold you prisoner. Hope can set you free.' was translated to pirate language, and the result is: 'Fear can hold ye prisoner, and a bottle of rum!  Splice the mainbrace! Hope can set ye free.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                13.1°C, however it feels like 12.48°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 13.1°C
            Max. temperature: 13.1°C
        </p>
    </div>
    <div id="wakatime">
        <p>
