<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'You are not the drop in the ocean, but the ocean in the drop.' was translated to klingon language, and the result is: 'Tlhih are not the chagh in the biq'a',  'ach the biq'a' in the chagh.'
        </h5>
