<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Success in any endeavor depends on the degree to which it is an expression of your true self. ' was translated to klingon language, and the result is: 'Qapla' in any endeavor depends on the degree to which 'oh is an expression of your hislah self.'
        </h5>
