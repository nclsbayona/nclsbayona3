<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Success is the progressive realization of a worthy goal' was translated to oldenglish language, and the result is: ' {Success} {is} dôð {progressive} {realization} râd tîma weorðfullic {goal}'
        </h5>
