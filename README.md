<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you can't feed a hundred people, then feed just one.' was translated to gungan language, and the result is: 'If yousa can't feed a hundred people,  then feed just una.'
        </h5>
