<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Why do you stay in prison when the door is so wide open?' was translated to sindarin language, and the result is: 'Whui ceri- cin dorth- in gador ir i fen na- so pand edr-?'
        </h5>
