<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'There are no accidents... there is only some purpose that we haven't yet understood.' was translated to mandalorian language, and the result is: 'Ogir are nayc accidents. Ogir is shi some narser megin vi morut't su understood.'
        </h5>
