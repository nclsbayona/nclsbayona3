<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Only he who has no use for the empire is fit to be entrusted with it.' was translated to oldenglish language, and the result is: ' {Only} hê hê indicates laughter sê ðâ ðe {has} n¯æfre nêotan from wægn I {is} forrepen cuman bêon {entrusted} wið sê.'
        </h5>
