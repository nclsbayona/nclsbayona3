<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Optimism is the faith that leads to achievement. Nothing can be done without hope and confidence.' was translated to minion language, and the result is: 'coomyc tis ta phi pak uh da tuboil.  secmop pudum be pin ratpun leg yee dabich.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                15.57°C, however it feels like 14.78°C, climate is
                <i>scattered clouds</i>
            .
            Min. temperature: 15.57°C
            Max. temperature: 15.57°C
        </p>
    </div>
    <div id="wakatime">
        <p>
