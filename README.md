<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'My actions are my only true belongings. I cannot escape the consequences of my actions. My actions are the ground upon which I stand.' was translated to mandalorian language, and the result is: 'Ner actions are ner shi true belongings. Ni cannot eyaytir te consequences be ner actions. Ner actions are te ground upon megin ni motir.'
        </h5>
