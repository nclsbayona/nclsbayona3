<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Successful people appear to be traveling along one continual, successful road. What is not apparent is the perseverance it takes following each defeat to keep you on that road. No one I know of has ever experienced one success after another without defeats, failures, disappointments, and frustrations galore along the way. Learning to overcome those times of agony is what separates the winners from the losers.' was translated to oldenglish language, and the result is: ' {Successful} werðêod oðîewan hebban libban de {traveling} to ân unâhefendlic, forðgenge lanu. {What} {is} hnot {apparent} {is} wægn âstandennes ðæge pro {takes} fylignes hwæðer oferdrîfan ben¯æman friðian êow hûru ' right to own or occupy land or connected with its occupation weg. {No} wuldorfæst ic pro understandan orgilde {has} êce infrôd æðele ðêoging into {another} for−ûtan {defeats}, {failures}, {disappointments}, ac {frustrations} {galore} æfterweard duguð fôr. {Learning} on−dr¯ædan oferwîgan ðâs {times} orgilde dêaðcwalu {is} {what} {separates} sê {winners} of sê {losers}.'
        </h5>
