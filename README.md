<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Feeling grateful to or appreciative of someone or something in your life actually attracts more of the things that you appreciate and value into your life.' was translated to oldenglish language, and the result is: ' {Feeling} ðanc−weorð ûðe oððon {appreciative} râd {someone} hw¯æðer ððe âwiht inne êower feorh {actually} {attracts} gîet orgilde sê {things} ' right to own or occupy land or connected with its occupation êower eahtan nâðýl¯æs lofian innan êower blâwung.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                14.93°C, however it feels like 14.41°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 14.93°C
            Max. temperature: 14.93°C
        </p>
    </div>
    <div id="wakatime">
        <p>
