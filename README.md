<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'By failing to prepare, you are preparing to fail.' was translated to oldenglish language, and the result is: ' {By} âspringung fyllan hêahsetl, êow ârian {preparing} verb âlicgan.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                14.69°C, however it feels like 14.41°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 14.69°C
            Max. temperature: 14.69°C
        </p>
    </div>
    <div id="wakatime">
        <p>
