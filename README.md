<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Decide whether or not the goal is worth the risks involved. If it is, stop worrying.' was translated to yoda language, and the result is: 'Whether or not the goal is worth the risks involved,  decide.If it is,Worrying,  stop.'
        </h5>
