<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you do not push the boundaries, you will never know where they are.' was translated to dothraki language, and the result is: 'If yeri hash vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) push the boundaries,  yeri will avvos know finne mori are.'
        </h5>
