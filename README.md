<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Do Something. If it works, do more of it. If it doesn't, do something else.' was translated to pirate language, and the result is: 'Do Somethin'.  If it works, do more o' it.  If it doesn't, do somethin' else.'
        </h5>
