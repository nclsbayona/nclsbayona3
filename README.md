<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Everyone faces challenges in life. It's a matter of how you learn to overcome them and using them to your advantage.' was translated to dothraki language, and the result is: 'Eyak faces challenges she atthirar. Anna's a matter ki kirekosi yeri learn to overcome them ma using them to yeri advantage.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                8.69°C, however it feels like 8.69°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 8.69°C
            Max. temperature: 8.69°C
        </p>
    </div>
    <div id="wakatime">
        <p>
    ...
    <tbody>
        <tr>
            ...
            <td style="padding-left: 1em; padding-right: 1em; text-align: center; vertical-align: top">4 hours and 32 minutes</td>
        </tr>
    </tbody>
</table>
        <hr>
