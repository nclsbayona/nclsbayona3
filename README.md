<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Either you choose to stay in the shallow end of the pool or you go out into the ocean.' was translated to minion language, and the result is: 'sora to nahbit da aloo een ta radlox fin mud ta alb sif to go kapee enta ta din.'
        </h5>
