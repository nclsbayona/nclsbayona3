<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'A liar knows that he is a liar, but one who speaks mere portions of truth in order to deceive is a craftsman of destruction.' was translated to oldenglish language, and the result is: ' oferhlýp lygewyrhta {knows} ðætte sê {is} bêga lêogere, ge wuldorfæst ðætte {speaks} merian {portions} of trêowð samod lâcian more distant w¯ægnian {is} bêga tilig un−l¯æd lor.'
        </h5>
