<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Perfection is not attainable, but if we chase perfection we can catch excellence..' was translated to sith language, and the result is: 'Perfection kash nenx attainable,  kad ar mes chase perfection mes gal catch excellence.'
        </h5>
