<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'At that point where you have decided to upgrade from aspiration to expectation and have begun to visualize an outcome, something incredibly important has happened, you have committed to the process of change.' was translated to mandalorian language, and the result is: 'Shal megin ceratir vaii gar ganar decided brokar upgrade teh aspiration brokar expectation bal ganar begun brokar visualize eyn outcome,  something incredibly jaon'yc has happened,  gar ganar committed brokar te process be am.'
        </h5>
