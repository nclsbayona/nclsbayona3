<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Intense love does not measure, it just gives.' was translated to dothraki language, and the result is: 'Intense athfiezar does vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) measure,  anna disse gives.'
        </h5>
