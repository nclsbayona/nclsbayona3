<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'I thought how unpleasant it is to be locked out; and I thought how it is worse, perhaps, to be locked in.' was translated to oldenglish language, and the result is: ' attraction with pron ðe ic ðêaw medmicel unlêof man {is} settan openian {locked} 1; swâðêah ic pro hygd (at hwæt−hwugu sê {is} s¯æmra, ðýl¯æs, into libban de {locked} un−feor.'
        </h5>
