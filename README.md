<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you do not change direction, you may end up where you are heading.' was translated to yoda language, and the result is: 'Not change direction,  if you do,Heading,  you may end up where you are.'
        </h5>
