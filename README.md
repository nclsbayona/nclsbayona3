<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Try all things, hold fast that which is good.' was translated to oldenglish language, and the result is: ' {Try} {all} {things}, wreðian âfæstan ' right to own or occupy land or connected with its occupation ðe {is} fremung.'
        </h5>
