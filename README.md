<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Starting is the most difficult step - but you can do it' was translated to mandalorian language, and the result is: 'Starting is te most urakto step - al gar liser vaabir bic'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                16.1°C, however it feels like 15.62°C, climate is
                <i>broken clouds</i>
            .
            Min. temperature: 16.1°C
            Max. temperature: 16.1°C
        </p>
    </div>
    <div id="wakatime">
        <p>
