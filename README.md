<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Nature is pleased with simplicity. And nature is no dummy.' was translated to oldenglish language, and the result is: ' {Nature} {is} {pleased} mid efenheort?. {And} wyrt−ruma {is} ðêos {dummy}.'
        </h5>
