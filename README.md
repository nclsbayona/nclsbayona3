<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'A show of confidence raises the bar' was translated to oldenglish language, and the result is: ' oferhlýp onwrêon un−l¯æd bieldo {raises} wægn clûstor'
        </h5>
