<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Nothing is particularly hard if you divide it into small jobs. ' was translated to cheunh language, and the result is: 'Nan'ei carcir particularly ch'itcuto rah vah bezeb hah can (bah accusative) ch'ithsin'bo jobs.'
        </h5>
