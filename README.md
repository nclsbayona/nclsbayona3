<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Life is a succession of lessons, which must be lived to be understood.' was translated to yoda language, and the result is: 'A succession of lessons,  life is,Lived to be understood,  which must be.'
        </h5>
