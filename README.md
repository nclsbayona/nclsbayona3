<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'When the fish is caught we pay no more attention to the trap.' was translated to dothraki language, and the result is: 'Kash the eshina is caught kisha pay vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) alikh attention to the qosarvenikh.'
        </h5>
