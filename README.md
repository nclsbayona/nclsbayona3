<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Continuous effort - not strength or intelligence - is the key to unlocking our potential.' was translated to oldenglish language, and the result is: ' {Continuous} ðroht {-} nâteðæshwôn eafoð palendse forwitolnes {-} {is} duguð glêsing âweorpan {unlocking} ûser {potential}.'
        </h5>
