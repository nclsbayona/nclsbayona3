<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'One voice can change a room, and if one voice can change a room, then it can change a city, and if it can change a city, it can change a state, and if it change a state, it can change a nation, and if it can change a nation, it can change the world. Your voice can change the world.' was translated to oldenglish language, and the result is: ' {One} hlêoðor canne hwearfian tîma rýmet, witodlic ð¯ær and there swegle wordhlêoðor canne hweorfan bêgra rýmet, ðâ ðæge pro canne hweorfan tîma frêoburh, ðe thither ðæge pro canne for−brêdan weargbr¯æde hêahfæsten, sê canne fâgian tîma cynewîse, forðý heonu ðæge pro hwearfung bâm cynehâd, ðæge pro canne wendung a wercyn, swâðêah thither hîe canne edhwyrft tîma m¯ægð, ðæge pro canne ymbhweorfnes ðone as molde. {Your} organ canne âwendednes wægn woruldrîce.'
        </h5>
