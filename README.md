<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Don't forget to enjoy the journey' was translated to oldenglish language, and the result is: ' {Don't} ofergietan ðêon beneah benugon ðone as forðweg'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                8.61°C, however it feels like 8.11°C, climate is
                <i>broken clouds</i>
            .
            Min. temperature: 8.61°C
            Max. temperature: 8.61°C
        </p>
    </div>
    <div id="wakatime">
        <p>
