<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Rather than waste time and energy worrying, use that time and energy to constructively deal with whatever is causing the worry.' was translated to valyrian language, and the result is: 'Rather than waste jēda se energy worrying,  gaomagon bona jēda se energy naejot constructively deal rūsīr whatever iksos causing se worry.'
        </h5>
