<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The heart wants what it wants - or else it does not care.' was translated to klingon language, and the result is: 'The tiq wants nuqjatlh 'oh wants - qoj else 'oh does not sah.'
        </h5>
