<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'You should never view your challenges as a disadvantage. Instead, it's important for you to understand that your experience facing and overcoming adversity is actually one of your biggest advantages.' was translated to pirate language, and the result is: 'ye should ne'er view yer challenges as a disadvantage.  Instead, 'tis important fer ye t' understand that yer experience facin' and overcomin' adversity be actually one o' yer biggest advantages.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                18.58°C, however it feels like 18.14°C, climate is
                <i>broken clouds</i>
            .
            Min. temperature: 18.58°C
            Max. temperature: 18.58°C
        </p>
    </div>
    <div id="wakatime">
        <p>
