<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'My actions are my only true belongings. I cannot escape the consequences of my actions. My actions are the ground upon which I stand.' was translated to huttese language, and the result is: 'Myo actions are myo only true belongings. Mee cannot escape doe consequences of myo actions. Myo actions are doe ground upon which mee stand.'
        </h5>
