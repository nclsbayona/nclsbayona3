<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'You can, you should, and if you're brave enough to start, you will.' was translated to sindarin language, and the result is: 'Cin tur-,  cin should,  a if cin're brave farn na start,  cin will.'
        </h5>
