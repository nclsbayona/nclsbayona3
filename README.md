<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'It is very obvious that we are not influenced by 'facts' but by our interpretation of the facts.' was translated to oldenglish language, and the result is: ' {It} {is} firenum {obvious} ðone as we coper nâteðæshwôn {influenced} fullan {'facts'} gên fram from ûser bodung of ðone as {facts}.'
        </h5>
    ...
    <div id="drink">
        ...
        <img src="https://www.thecocktaildb.com/images/media/drink/4vo5651493068493.jpg">
        <h4>
            <font color="#F0A0FF">
