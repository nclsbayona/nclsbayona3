<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Those who bring sunshine into the lives of others cannot keep it from themselves.' was translated to yoda language, and the result is: 'Sunshine into the lives of others cannot keep it from themselves,  those who bring.'
        </h5>
    ...
    <tbody>
        ...
        <h4>
            <font color="#F0A0FF">
                Instructions: The kiwi martini is a very fun vodka cocktail and it is one of the best drinks that makes use of fresh fruit. Though there are a few recipes floating around, this is one of the easiest and it is an absolutely delightful green martini to drink.
...
For this recipe, you'll simply muddle slices of kiwi with simple syrup, then shake it with vodka. It's a drink that anyone can mix up in minutes and a perfect cocktail to show off your favorite vodka.
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                16.03°C, however it feels like 15.54°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 16.03°C
            Max. temperature: 16.03°C
        </p>
    </div>
    <div id="wakatime">
        <p>
