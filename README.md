<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Life is and will ever remain an equation incapable of solution, but it contains certain known factors. ' was translated to cheunh language, and the result is: 'Vez carcir vim csarcican't seo csarcah an cavzisei navit'can (bah accusative) bah rutzi,  rab hah contains certain known factors.'
        </h5>
