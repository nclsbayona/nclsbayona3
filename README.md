<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'We live only now. Everything else is either passed or is unknown.' was translated to oldenglish language, and the result is: ' {We} æfnan oft oftor sôðlic. {Everything} elcran {is} bêgra {passed} ge {is} uncûð.'
        </h5>
...
Garnish with Cucumer and Lime slice
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                7.85°C, however it feels like 7.24°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 7.85°C
            Max. temperature: 7.85°C
        </p>
    </div>
    <div id="wakatime">
        <p>
