<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The opportunity of defeating the enemy is provided by the enemy himself.' was translated to oldenglish language, and the result is: ' {The} tôwyrd un−l¯æd {defeating} wægn eoten {is} {provided} of ðone as hildegiest ðæge pro.'
        </h5>
