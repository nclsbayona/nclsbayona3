<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'When you want to be honored by others, you learn to honor them first.' was translated to dothraki language, and the result is: 'Kash yeri want to be honored ki others,  yeri learn to chomokh them atte.'
        </h5>
