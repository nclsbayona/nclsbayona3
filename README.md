<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'You are learning valuable lessons from yourself every day' was translated to oldenglish language, and the result is: ' {You} dômweorðung leornungcræft strêonful {lessons} on−dr¯ædan {yourself} æghwilc tôdæg'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                10.41°C, however it feels like 9.93°C, climate is
                <i>broken clouds</i>
            .
            Min. temperature: 10.41°C
            Max. temperature: 10.41°C
        </p>
    </div>
    <div id="wakatime">
        <p>
