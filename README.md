<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you are born poor, it is not your mistake. But if you die poor it is your mistake.' was translated to oldenglish language, and the result is: ' {If} êower m¯æran {born} w¯æd−lig, sê {is} nâteshwôn êower un−cyst. {But} ð¯ær and there êow lêoran m¯æte hit hê {is} êower un−cyst.'
        </h5>
