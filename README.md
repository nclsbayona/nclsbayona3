<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'At that point where you have decided to upgrade from aspiration to expectation and have begun to visualize an outcome, something incredibly important has happened, you have committed to the process of change.' was translated to yoda language, and the result is: 'Decided to upgrade from aspiration to expectation and have begun to visualize an outcome,  at that point where you have,Happened,  something incredibly important has,Committed to the process of change,  you have.'
        </h5>
