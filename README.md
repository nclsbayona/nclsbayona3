<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you don't give up, you still have a chance. And when you are small, you have to be very focused and rely on your brain, not your strength.' was translated to oldenglish language, and the result is: ' {If} êower {don't} bisenian ûpweard, êower gîet âsendan bêga wif. {And} ðanêcan êow cypren medmicel, êow weardian intô with bêo strange strangor {focused} hûru {rely} ûtan êower ex, n¯ænig pro êower hêahstrengðu.'
        </h5>
