<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'People are weird. When we find someone with weirdness that is compatible with ours, we team up and call it love.' was translated to minion language, and the result is: 'huma nama weird.  yeh alsawa mimo wat weirdness pak tis ukebid wat ours, alspas aka yee cora pik ern.'
        </h5>
