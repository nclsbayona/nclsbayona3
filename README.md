<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Keep a positive mind. Remember, a failed attempt doesn't make you a failure-giving up does.' was translated to oldenglish language, and the result is: ' {Keep} bâm {positive} ðôht. {Remember}, bêgra {failed} ðencan {doesn't} r¯æran êower bâm {failure-giving} ûpweardes {does}.'
        </h5>
