<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'No amount of regretting can change the past, and no amount of worrying can change the future.' was translated to dothraki language, and the result is: 'Vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) amount ki regretting laz change the past,  ma vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) amount ki worrying laz change the future.'
        </h5>
