<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Amateurs sit and wait for inspiration, the rest of us just get up and got to work.' was translated to klingon language, and the result is: 'Amateurs ba' 'ej los inspiration,  the les of mah neh hu' 'ej got to vum.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                12.29°C, however it feels like 11.95°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 12.29°C
            Max. temperature: 12.29°C
        </p>
    </div>
    <div id="wakatime">
        <p>
