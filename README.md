<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you build the guts to do something, anything, then you better save enough to face the consequences.' was translated to klingon language, and the result is: 'If tlhih build the guts to do vay',  vay',  vaj tlhih better tod mevyap to qad the consequences.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                10.51°C, however it feels like 10.02°C, climate is
                <i>broken clouds</i>
            .
            Min. temperature: 10.51°C
            Max. temperature: 10.51°C
        </p>
    </div>
    <div id="wakatime">
        <p>
