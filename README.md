<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Perfection is not attainable, but if we chase perfection we can catch excellence..' was translated to huttese language, and the result is: 'Perfection sa nopa attainable,  but if jee-jee chase perfection jee-jee can catch excellence.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                16.66°C, however it feels like 16.1°C, climate is
                <i>broken clouds</i>
            .
            Min. temperature: 16.66°C
            Max. temperature: 16.66°C
        </p>
    </div>
    <div id="wakatime">
        <p>
