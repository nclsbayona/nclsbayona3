<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Success is not what you do when you are on top.  Success is how high you bounce when you hit the bottom.' was translated to huttese language, and the result is: 'Success sa nopa choy? U do whao u are on top. Success sa kava high u bounce whao u hit doe bottom.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                20.48°C, however it feels like 19.76°C, climate is
                <i>broken clouds</i>
            .
            Min. temperature: 20.48°C
            Max. temperature: 20.48°C
        </p>
    </div>
    <div id="wakatime">
        <p>
