<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The consequences of today are determined by the actions of the past. To change your future, alter your decisions today.' was translated to oldenglish language, and the result is: ' {The} {consequences} orgilde {today} ârian hwætrêd forð forðbie duguð {actions} un−l¯æd wægn ofer. {To} onwendan êower tôweard, wendan êower {decisions} {today}.'
        </h5>
