<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Each time we don't say what we wanna say, we're dying.' was translated to pirate language, and the result is: 'Each time we dern't say what we wanna say, we're dyin'.'
        </h5>
