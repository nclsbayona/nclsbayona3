<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'When I was a little kid, I was really scared of the dark. But then I came to understand, dark just means the absence of photons in the visible wavelength 400 to 700 nanometers. Then I thought, well it's really silly to be afraid of a lack of photons. Then I wasn't afraid of the dark anymore after that.' was translated to oldenglish language, and the result is: ' {When} ic pro {was} dimf b¯æm lýtel ticcen, attraction with pron ðe ic {was} sôðlic {scared} of sê nipful. {But} sôðlic ic pro {came} lecgan understandan, unandgytful rihtheort scild−end sê  orgilde {photons} lâst sê sewenlic {wavelength} {400} setlan {700} {nanometers}. {Then} attraction with pron ðe ic hyge, tulge tylg {it's} sôðlic unr¯æd hêan ðurhwunian forht orgilde hlêg gâd orgilde {photons}. {Then} attraction with pron ðe ic {wasn't} forht orgilde duguð ðêostorlic {anymore}  ðone as.'
        </h5>
