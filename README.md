<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The only real mistake is the one from which we learn nothing. ' was translated to valyrian language, and the result is: 'Se mērī real mistake iksos se mēre hen skore īlon gūrēñagon daorun.'
        </h5>
