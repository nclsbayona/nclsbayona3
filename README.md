<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'When a man is an upright contender, only real people are bound to be around; but if he is a downright pretender, then fake people surround and always abound to be found.' was translated to cheunh language, and the result is: 'Veo ch'a vuhn carcir an upright contender,  nor var vucum are ritci ch'at vacosehn around; rab rah tah carcir ch'a downright pretender,  cseo fake vucum surround vim seo rokes'ahn ch'at vacosehn k'un'bah.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                11.83°C, however it feels like 11.34°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 11.83°C
            Max. temperature: 11.83°C
        </p>
    </div>
    <div id="wakatime">
        <p>
