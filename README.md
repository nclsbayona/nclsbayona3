<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'What do we live for if not to make life less difficult for each other?' was translated to pirate language, and the result is: 'What do we live fer if not t' make life less difficult fer each other?'
        </h5>
