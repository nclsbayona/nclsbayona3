<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Growing up is losing some illusions, in order to acquire others.' was translated to klingon language, and the result is: 'Growing up is losing 'op illusions,  in 'obe' to suq others.'
        </h5>
