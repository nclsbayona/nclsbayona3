<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Own 100 percent of your focus. The most challenging of endurance drills will bring you to a level of optimal mental and physical performance.' was translated to oldenglish language, and the result is: ' {Own} {100} {percent} of êower fustra. {The} m¯æst {challenging} orgilde ðolebyrdnes {drills} fordêman tôcuman êower of hlêg efnettan of {optimal} interior hwæðere {physical} tilung.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                13.69°C, however it feels like 13.44°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 13.69°C
            Max. temperature: 13.69°C
        </p>
    </div>
    <div id="wakatime">
        <p>
