<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'There is no absolute success in the world, only constant progress.' was translated to pig-latin language, and the result is: 'ere-Thay is-way o-nay absolute-way uccess-say in-way e-thay orld-way, only-way onstant-cay ogress-pray. '
        </h5>
