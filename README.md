<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'To create more positive results in your life, replace 'if only' with 'next time'.' was translated to oldenglish language, and the result is: ' {To} cennan more {positive} {results} binnan êower sâ−wol, {replace} {'if} {only'} mid {'next} {time'}.'
        </h5>
