<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Keep a positive mind. Remember, a failed attempt doesn't make you a failure-giving up does.' was translated to oldenglish language, and the result is: ' {Keep} hlêg {positive} faru. {Remember}, bêgra {failed} ðw¯ærl¯æcan {doesn't} myntan êower bêgra {failure-giving} uppe {does}.'
        </h5>
