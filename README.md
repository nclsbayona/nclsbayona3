<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'An approximate answer to the right question is worth a great deal more than a precise answer to the wrong question.' was translated to oldenglish language, and the result is: ' {An} {approximate} andswarian unnan 1 an duguð rihtwîs righteous be−frînan {is} weorðnes twihynde lîffæst {deal} môrbêam {than} hlêg {precise} wræclâstian intô with ðone as unriht frignes.'
        </h5>
