<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Life can only be understood backwards; but it must be lived forwards.' was translated to vulcan language, and the result is: 'Ha'kiv mokuhlek goh nam-tor ken-tor pla'rak; tonk'peh ish-veh bolau nam-tor ha-tor fa'rak.'
        </h5>
