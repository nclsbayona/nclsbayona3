<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'You must learn to let go. Release the stress. You were never in control anyway.' was translated to oldenglish language, and the result is: ' {You} must ongietan verb ofgiefan bewendan. {Release} duguð {stress}. {You} {were} ne ætstandan hæfen {anyway}.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                15.62°C, however it feels like 15.04°C, climate is
                <i>scattered clouds</i>
            .
            Min. temperature: 15.62°C
            Max. temperature: 15.62°C
        </p>
    </div>
    <div id="wakatime">
        <p>
