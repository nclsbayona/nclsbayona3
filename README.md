<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'A creative man is motivated by the desire to achieve, not by the desire to beat others.' was translated to oldenglish language, and the result is: ' stæfr¯æw {creative} guma {is} {motivated} fore ðone as hyht oferniman hêgan, nâteðæshwôn onemn duguð geornung hêan ðyddan {others}.'
        </h5>
