<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Happiness can be found, even in the darkest of times, if one only remembers to turn on the light.' was translated to yoda language, and the result is: 'Found,  happiness can be,Even in the darkest of times,To turn on the light,  if one only remembers.'
        </h5>
