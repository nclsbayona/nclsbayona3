<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'There are two primary choices in life: to accept conditions as they exist, or accept the responsibility for changing them.' was translated to mandalorian language, and the result is: 'Ogir are t'ad primary choices o'r life: brokar vorer conditions as. As val cuyir,  ra vorer te buirkan par changing them.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                20.28°C, however it feels like 19.64°C, climate is
                <i>scattered clouds</i>
            .
            Min. temperature: 20.28°C
            Max. temperature: 20.28°C
        </p>
    </div>
    <div id="wakatime">
        <p>
