<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'People who say it cannot be done should not interrupt those who are doing it.' was translated to vulcan language, and the result is: 'Sutra vi leralmin ish-veh fam yehat nam-tor ovsoh dang ri svi-shau eifa vi nam-tor doing ish-veh.'
        </h5>
