<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you don't give up, you still have a chance. And when you are small, you have to be very focused and rely on your brain, not your strength.' was translated to oldenglish language, and the result is: ' {If} êow {don't} reccan uppe, êower swîge sellan a hlîet. {And} mid êow dômweorðung unmycel, êower forgîemelêasian oð cunnan 1 and 3 can scearplic {focused} tôêacan and {rely} hw¯ær êower exe, hnot êower strengð.'
        </h5>
