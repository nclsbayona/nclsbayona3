<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The power of human thought grows exponentially with the number of minds that share that thought.' was translated to oldenglish language, and the result is: ' {The} strangnes of mennisc ðêaw {grows} {exponentially} wið dôð rîm orgilde {minds} ðone as hlýte ðe ðôht.'
        </h5>
