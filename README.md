<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Vision without action is daydream. Action without vision is nightmare..' was translated to oldenglish language, and the result is: ' {Vision} for−ûtan weorcd¯æd {is} {daydream}. {Action} ûtweard swefn {is} ælfsiden.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                11.82°C, however it feels like 11.43°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 11.82°C
            Max. temperature: 11.82°C
        </p>
    </div>
    <div id="wakatime">
        <p>
