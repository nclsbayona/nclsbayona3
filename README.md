<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'You don't need a weatherman to know which way the wind blows.' was translated to vulcan language, and the result is: 'Du ri tor bolaya wuh weatherman tor fai-tor if yut wuh salan salur.'
        </h5>
