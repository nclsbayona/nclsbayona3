<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The last time doesn't exist. It's only this time. And everything is going to be different this time. There's only now.' was translated to oldenglish language, and the result is: ' {The} latost ðrâg {doesn't} stician. {It's} âncyn tôhwon s¯æl. {And} ðætte {is} stepegong cuman sîe missenlic sê ðâ ðe hýðnes. {There's} form and with a once.'
        </h5>
    ...
    <tbody>
        <tr>
            ...
            <td style="padding-left: 1em; padding-right: 1em; text-align: center; vertical-align: top">9 hours and 6 minutes</td>
        </tr>
        <tr>
    ...
    <tbody>
        <tr>
            ...
            <td style="padding-left: 1em; padding-right: 1em; text-align: center; vertical-align: top">18 hours and 29 minutes</td>
        </tr>
        <tr>
