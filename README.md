<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you're not making mistakes, then you're not doing anything.' was translated to huttese language, and the result is: 'If u're nopa making mistakes,  then u're nopa doing anything.'
        </h5>
