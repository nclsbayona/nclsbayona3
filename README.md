<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The only way to 'find out if it will work out' is to do it.' was translated to gungan language, and the result is: 'Dha only way to 'find out if it will work out' is to do it.'
        </h5>
