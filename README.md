<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Time doesn't heal emotional pain, you need to learn how to let go.' was translated to klingon language, and the result is: 'Poh doesn't heal emotional 'oy',  tlhih need to ghoj chay' to let jah.'
        </h5>
