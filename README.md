<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Action is the foundational key to all success.' was translated to klingon language, and the result is: 'Action is the foundational ngaqha'mohwi' to hoch qapla'.'
        </h5>
