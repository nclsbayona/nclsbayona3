<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Each problem has a positive side.' was translated to yoda language, and the result is: 'A positive side,  each problem has.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                10.45°C, however it feels like 10.01°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 10.45°C
            Max. temperature: 10.45°C
        </p>
    </div>
    <div id="wakatime">
        <p>
