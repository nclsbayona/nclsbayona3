<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Respect other people's feelings. It might mean nothing to you, but it could mean everything to them.' was translated to yoda language, and the result is: 'Respect other people's feelings.Nothing to you,  it might mean,Everything to them,  but it could mean.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                12.87°C, however it feels like 12.59°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 12.87°C
            Max. temperature: 12.87°C
        </p>
    </div>
    <div id="wakatime">
        <p>
    ...
    <tbody>
        <tr>
            ...
            <td style="padding-left: 1em; padding-right: 1em; text-align: center; vertical-align: top">25 hours and 17 minutes</td>
        </tr>
        <tr>
            <td style="padding-left: 1em; padding-right: 1em; text-align: center; vertical-align: top">Python</td>
            <td style="padding-left: 1em; padding-right: 1em; text-align: center; vertical-align: top">1 hours and 50 minutes</td>
        </tr>
        <tr>
    ...
    <tbody>
        <tr>
            ...
            <td style="padding-left: 1em; padding-right: 1em; text-align: center; vertical-align: top">29 hours and 6 minutes</td>
        </tr>
    </tbody>
</table>
        <hr>
