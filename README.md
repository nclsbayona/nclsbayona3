<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Successful people appear to be traveling along one continual, successful road. What is not apparent is the perseverance it takes following each defeat to keep you on that road. No one I know of has ever experienced one success after another without defeats, failures, disappointments, and frustrations galore along the way. Learning to overcome those times of agony is what separates the winners from the losers.' was translated to oldenglish language, and the result is: ' {Successful} mennisc îewan intô with weorðan {traveling} sîð æt sîðestan æðellic unâhefendlic, forðgenge str¯æt. {What} {is} ne {apparent} {is} wægn singalnes hê {takes} leoðu form and with a wîghryre of friðian êower nêan ðætte foldweg. {No} dêore attraction with pron ðe ic oncunnan of {has} ealneg antique hlâfordlic tyht sîð æt sîðestan {another} wiðûtan {defeats}, {failures}, {disappointments}, hwæðere {frustrations} {galore} yferra wægn onwîcan. {Learning} æt−bregdan dîgan ðæge pro {times} râd dêaðcwalu {is} {what} {separates} sê {winners} verb sê {losers}.'
        </h5>
