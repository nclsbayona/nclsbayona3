<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Life is a journey, not a destination.' was translated to dothraki language, and the result is: 'Atthirar is a journey,  vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) a ovvethikh.'
        </h5>
