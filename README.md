<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The future doesn't belong to the faint-hearted; it belongs to the brave.' was translated to oldenglish language, and the result is: ' {The} uferra {doesn't} lengan scrift ðone as {faint-hearted}; hîe {belongs} æt−bregdan dôð môdhwæt.'
        </h5>
