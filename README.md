<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'To wish you were someone else is to waste the person you are.' was translated to gungan language, and the result is: 'To wish yousa were someone else is to waste dha person yousa.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                17.37°C, however it feels like 16.89°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 17.37°C
            Max. temperature: 17.37°C
        </p>
    </div>
    <div id="wakatime">
        <p>
