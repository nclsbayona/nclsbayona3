<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Vision without action is daydream. Action without vision is nightmare..' was translated to oldenglish language, and the result is: ' {Vision} ûtweard ingehygdnes {is} {daydream}. {Action} ûte bescêawodnes {is} ælfsiden.'
        </h5>
