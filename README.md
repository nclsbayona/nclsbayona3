<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'A single act of kindness throws out roots in all directions, and the roots spring up and make new trees.' was translated to huttese language, and the result is: 'Do single act of kindness throws nenoleeya roots noleeya all directions,  um doe roots spring tonka um make newpa trees.'
        </h5>
