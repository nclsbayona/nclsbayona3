<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'There are few reasons for telling the truth, but for lying the number is infinite.' was translated to valyrian language, and the result is: 'Konīr issi dorolvie reasons syt telling se truth,  yn syt lying se number iksos infinite.'
        </h5>
