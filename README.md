<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you throw away all thoughts of attainment, you will then come to see the real purpose of your quest.' was translated to gungan language, and the result is: 'If yousa throw away all thoughts of attainment,  yousa will then comin to see dha real purpose of yous quest.'
        </h5>
