<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The only real mistake is the one from which we learn nothing. ' was translated to vulcan language, and the result is: 'Wuh goh yeht lafosh nam-tor wuh veh s' if etek oren-tor nothing.'
        </h5>
