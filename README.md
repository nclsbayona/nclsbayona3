<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Kindness is a language which the deaf can hear and the blind can see.' was translated to huttese language, and the result is: 'Kindness sa do language which doe deaf can hear um doe blind can stuka.'
        </h5>
