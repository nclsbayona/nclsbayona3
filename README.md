<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The law of harvest is to reap more than you sow. Sow an act, and you reap a habit. Sow a habit and you reap a character. Sow a character and you reap a destiny.' was translated to oldenglish language, and the result is: ' {The} insettan un−l¯æd rîp {is} æt−bregdan repan swîðe {than} êower onsâwan. {Sow} ealdgenîðla fremman, fullan êow rîp a sidu. {Sow} a wuna mid êow snîðan dimf b¯æm môdstaðol. {Sow} hlêg stæf lôca in êow repan weargbr¯æde folgoð.'
        </h5>
