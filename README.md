<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Instead of being intimidated by the limitations, be inspired to find new ways around them.' was translated to ferblatin language, and the result is: 'nstead-Ierb of eing-berb ntimidated-ierb by he-terb imitations-lerb, be nspired-ierb to ind-ferb ew-nerb ays-werb round-aerb them. '
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                11.8°C, however it feels like 11.31°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 11.8°C
            Max. temperature: 11.8°C
        </p>
    </div>
    <div id="wakatime">
        <p>
