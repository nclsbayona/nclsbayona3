<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Problems remain as problems because people are busy defending them rather than finding solutions.' was translated to gungan language, and the result is: 'Problems remain as problems because people are busy defend them-sa rather than find solutions.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                14.79°C, however it feels like 14.65°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 14.79°C
            Max. temperature: 14.79°C
        </p>
    </div>
    <div id="wakatime">
        <p>
