<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The greater the impact you want to make, the greater your influence needs to be.' was translated to oldenglish language, and the result is: ' {The} {greater} duguð grind êow ðearflicnes stellan onstellan, ðone as {greater} êower {influence} nîede besettan swîcan.'
        </h5>
