<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Every adversity, every failure, every heartbreak, carries with it the seed of an equal or greater benefit.' was translated to pirate language, and the result is: 'Every adversity, every failure, every heartbreak, carries with it th' seed o' an equal or greater benefit.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                10.71°C, however it feels like 10.29°C, climate is
                <i>overcast clouds</i>
            .
