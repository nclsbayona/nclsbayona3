<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Kindness is a language which the deaf can hear and the blind can see.' was translated to valyrian language, and the result is: 'Kindness iksos nykeā udrir skore se deaf kostagon rȳbagon se se laesdaor kostagon ūndegon.'
        </h5>
