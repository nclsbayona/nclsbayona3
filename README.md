<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Life can only be understood backwards; but it must be lived forwards.' was translated to huttese language, and the result is: 'Life can only be understood backwards; but it must be lived forwards.'
        </h5>
