<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The future is no more uncertain than the present.' was translated to dothraki language, and the result is: 'The future is vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) alikh uncertain than the present.'
        </h5>
