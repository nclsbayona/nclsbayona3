<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Success in any endeavor depends on the degree to which it is an expression of your true self. ' was translated to pirate language, and the result is: 'Success in any endeavor depends on th' degree t' which it be an expression o' yer true self.  '
        </h5>
