<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Alone we can do so little; together we can do so much.' was translated to yoda language, and the result is: 'So little; together we can do so much,  alone we can do.'
        </h5>
