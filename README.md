<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'It's the job that's never started that takes the longest to finish.' was translated to yoda language, and the result is: 'That takes the longest to finish,  it's the job that's never started.'
        </h5>
