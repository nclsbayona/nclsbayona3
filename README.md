<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Everything has cracks - that's how the light gets in' was translated to sindarin language, and the result is: 'Everything has cracks - i's how i galad gets in'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                11.32°C, however it feels like 10.99°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 11.32°C
            Max. temperature: 11.32°C
        </p>
    </div>
    <div id="wakatime">
        <p>
