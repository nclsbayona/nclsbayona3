<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The sweetest pleasure arises from difficulties overcome.' was translated to yoda language, and the result is: 'From difficulties overcome,  the sweetest pleasure arises.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                10.34°C, however it feels like 9.88°C, climate is
                <i>broken clouds</i>
            .
            Min. temperature: 10.34°C
            Max. temperature: 10.34°C
        </p>
    </div>
    <div id="wakatime">
        <p>
