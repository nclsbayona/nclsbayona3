<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'We learn to walk by falling down. If we never fell down, we would never walk.' was translated to yoda language, and the result is: 'To walk by falling down,  we learn.Down,  if we never fell,We would never walk.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                13.68°C, however it feels like 13.58°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 13.68°C
            Max. temperature: 13.68°C
        </p>
    </div>
    <div id="wakatime">
        <p>
