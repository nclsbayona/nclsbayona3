<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you don't have confidence, you'll always find a way not to win' was translated to oldenglish language, and the result is: ' {If} êower {don't}  trûwa, {you'll} synnes begietan bâm fær hnot âstellan forgeearnung'
        </h5>
