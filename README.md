<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Meaning is something you build into your life. You build it out of your own past, out of your affections and loyalties, out of the experience of humankind as it is passed on to you... You are the only one who can put them together into that unique pattern that will be your life.' was translated to pirate language, and the result is: 'Meanin' be somethin' ye build into yer life.  ye build it out o' yer own past, out o' yer affections and loyalties, out o' th' experience o' humankind as it be passed on t' ye.., and a bucket o' chum.  ye be th' only one who can put them together into that unique pattern that will be yer life.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                ...
                <i>thunderstorm with light rain</i>
            .
