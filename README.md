<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'There are no accidents... there is only some purpose that we haven't yet understood.' was translated to yoda language, and the result is: 'No accidents,  there are...Only some purpose that we haven't yet understood,  there is.'
        </h5>
