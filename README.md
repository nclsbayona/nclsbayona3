<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'A leader is one who knows the way, goes the way, and shows the way.' was translated to oldenglish language, and the result is: ' stæfr¯æw lâttêowa {is} ðrymfæst ðætte {knows} sê stîg, {goes} ðone as sîðfæt, wislic {shows} ðone as cost.'
        </h5>
