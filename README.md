<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Vulnerability is not winning or losing; it's having the courage to show up and be seen when we have no control over the outcome.' was translated to oldenglish language, and the result is: ' {Vulnerability} {is} nâteðæshwôn {winning} sam {losing}; {it's} twihynde ðone as wæfernes scrift ætberan uppe oð sý sîene ðonne and attraction with pron ðe ic brûcan ðêos racian tô−foran duguð ûtan−cumen.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                17.83°C, however it feels like 17.29°C, climate is
                <i>broken clouds</i>
            .
            Min. temperature: 17.83°C
            Max. temperature: 17.83°C
        </p>
    </div>
    <div id="wakatime">
        <p>
    ...
    <tbody>
        <tr>
            ...
            <td style="padding-left: 1em; padding-right: 1em; text-align: center; vertical-align: top">3 hours and 36 minutes</td>
        </tr>
        <tr>
