<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'You have to make time, even for something as universal as staring at the stars.' was translated to oldenglish language, and the result is: ' {You} âgenlic intô with wyrcan dægtîd, efne nymðe sum inde same only in swâ eallic geond {staring} nêan wægn môna.'
        </h5>
