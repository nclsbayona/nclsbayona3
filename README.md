<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'People don't realize that now is all there ever is; there is no past or future except as memory or anticipation in your mind.' was translated to oldenglish language, and the result is: ' {People} {don't} {realize} ðêah ðâgýt {is} {all} {there} âhw¯ær {is}; {there} {is} n¯ænig pro forð forðbie palendse eftwyrd ongietan on myne sam forestæppung to êower brêosthord.'
        </h5>
