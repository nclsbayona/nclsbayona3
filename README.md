<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'All human wisdom is contained in these two words - Wait and Hope' was translated to oldenglish language, and the result is: ' {All} mennisc glêawnes {is} {contained} binnan {these} twêgen nu hlêoðorcwide {-} {Wait} gên {Hope}'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                16.48°C, however it feels like 15.96°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 16.48°C
            Max. temperature: 16.48°C
        </p>
    </div>
    <div id="wakatime">
        <p>
