<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Note that this journey is uniquely yours, no one elses. So the path has to be your own.' was translated to gungan language, and the result is: 'Note dat disa journey is uniquely yours,  nosa una elses. So dha path has besa yous own.'
        </h5>
