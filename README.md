<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Many of life's failures are people who did not realize how close they were to success when they gave up.' was translated to oldenglish language, and the result is: ' {Many} râd {life's} {failures} rôðor lêode ðætte {did} nâ {realize} hwæt−hwugu s¯ælan hê {were} toward forðsîð hwænne hit hê {gave} ûpweard.'
        </h5>
