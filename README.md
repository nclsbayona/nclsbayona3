<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Friendship takes time and energy if it's going to work.' was translated to huttese language, and the result is: 'Friendship takes tee-tocky um energy if soong koona tah work.'
        </h5>
