<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Too much sanity may be madness and the maddest of all, to see life as it is and not as it should be. ' was translated to valyrian language, and the result is: 'Tolī olvie sanity kostagon sagon madness se se maddest hen ry,  naejot ūndegon glaeson hae ziry iksos se daor hae ziry should sagon.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                11.85°C, however it feels like 11.55°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 11.85°C
            Max. temperature: 11.85°C
        </p>
    </div>
    <div id="wakatime">
        <p>
