<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Very little is needed to make a happy life; it is all within yourself, in your way of thinking.' was translated to oldenglish language, and the result is: ' {Very} lýthwôn and {is} {needed} from− r¯æran bâm drêam−hæbbende onworpennes; hîe {is} {all} inne {yourself}, oððæt êower onwîcan of {thinking}.'
        </h5>
