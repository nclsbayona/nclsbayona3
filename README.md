<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'It is not that we have too little time to do all the things we need to do , it is that we feel the need to do too many things in the time we have.' was translated to oldenglish language, and the result is: ' {It} {is} n¯ænig pro ðe we of−gân for ðâm ðe hwônlic nêadðearfnes hand fremian {all} dôð {things} attraction with pron ðe ic gâd âweorpan âræfnan {}, ðæge pro {is} sê attraction with pron ðe ic frêdan dôð forððêon from− full−fremman for ðý ðe micle {things} toward wægn ðrâg attraction with pron ðe ic hæfde.'
        </h5>
