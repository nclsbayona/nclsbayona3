<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'In a world of change, the learners shall inherit the earth, while the learned shall find themselves perfectly suited for a world that no longer exists.' was translated to vulcan language, and the result is: 'Svi' wuh panu t' rubah,  wuh learners dungau inherit wuh terra,  du' wuh oren-tor dungau talal themselves perfectly suited na' wuh panu ik rai longer nam-tor.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                18.73°C, however it feels like 17.68°C, climate is
                <i>broken clouds</i>
            .
