<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you want to be happy, do not dwell in the past, do not worry about the future, focus on living fully in the present.' was translated to pirate language, and the result is: 'If ye want t' be grog-filled, dern't dwell in th' past, dern't worry about th' future, focus on livin' fully in th' present.'
        </h5>
