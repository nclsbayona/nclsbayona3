<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Without the confidence, nothing can be accomplished.' was translated to yoda language, and the result is: 'Without the confidence,Accomplished,  nothing can be.'
        </h5>
