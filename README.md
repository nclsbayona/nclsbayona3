<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Do Something. If it works, do more of it. If it doesn't, do something else.' was translated to yoda language, and the result is: 'Something,  do.If it works,More of it,  do.If it doesn't,Something else,  do.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                11.21°C, however it feels like 10.84°C, climate is
                <i>overcast clouds</i>
            .
