<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Someone who points out your flaws to you is not necessarily your enemy. Someone who speaks of your virtues is not necessarily your friend.' was translated to dothraki language, and the result is: 'Someone fin points out yeri flaws to yeri is vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) necessarily yeri dozgo. Someone fin speaks ki yeri virtues is vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) necessarily yeri okeo.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                16.05°C, however it feels like 15.75°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 16.05°C
            Max. temperature: 16.05°C
        </p>
    </div>
    <div id="wakatime">
        <p>
