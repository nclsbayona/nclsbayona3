<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'What we call the beginning is often the end. And to make an end is to make a beginning. The end is where we start from.' was translated to pirate language, and the result is: 'What we call th' beginnin' be often th' end.  Yo-ho-ho, I'll warrant ye!  And t' make an end be t' make a beginnin'.  th' end be whar we start from.'
        </h5>
