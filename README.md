<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Vulnerability is not winning or losing; it's having the courage to show up and be seen when we have no control over the outcome.' was translated to sith language, and the result is: 'Vulnerability kash nenx dujozimas ax losing; zhol's having tave courage kia parod xok ir buti aikstus tikazi mes zinot nie control prie tave outcome.'
        </h5>
