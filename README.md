<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If the plan doesn't work, change the plan, but never the goal.' was translated to huttese language, and the result is: 'If doe plan doesn't work,  change doe plan,  but never doe goal.'
        </h5>
