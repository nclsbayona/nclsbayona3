<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Some changes look negative on the surface but you will soon realize that space is being created in your life for something new to emerge.' was translated to klingon language, and the result is: ''op changes look negative on the ghor 'ach tlhih will tugh tlhoj 'e' logh is dep created in your yin for vay' new to emerge.'
        </h5>
