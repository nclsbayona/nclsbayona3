<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Don't count the days; make the days count.' was translated to sindarin language, and the result is: 'Don't nedi- i days; ech- i days nedi-.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                12.08°C, however it feels like 11.82°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 12.08°C
            Max. temperature: 12.08°C
        </p>
    </div>
    <div id="wakatime">
        <p>
