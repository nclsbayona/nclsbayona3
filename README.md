<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Life is about choice. You can choose to be a victim or anything else you like to be.' was translated to huttese language, and the result is: 'Life sa about choice. U can choose tah be do victim mo anything else u like tah be.'
        </h5>
