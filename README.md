<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Give a girl the right shoes, and she can conquer the world.' was translated to huttese language, and the result is: 'Give do girl doe right shoes,  um she can conquer doe world.'
        </h5>
...
Stir well.
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                19.71°C, however it feels like 19.12°C, climate is
                <i>scattered clouds</i>
            .
            Min. temperature: 19.71°C
            Max. temperature: 19.71°C
        </p>
    </div>
    <div id="wakatime">
        <p>
