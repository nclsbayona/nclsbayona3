<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you want to be happy, do not dwell in the past, do not worry about the future, focus on living fully in the present.' was translated to minion language, and the result is: 'asa to quer da be fid, batooay non dwell een ta lego, batooay non vox cama ta tegpul, err lib ehkit yin een ta ughrec.'
        </h5>
