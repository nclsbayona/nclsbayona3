<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'You are the sky. Everything else - it's just the weather.' was translated to huttese language, and the result is: 'U are doe sky. Everything else - soong just doe weather.'
        </h5>
