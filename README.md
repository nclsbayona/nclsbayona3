<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Happiness is not the absence of problems, it's the ability to deal with them.' was translated to sith language, and the result is: 'Happiness kash nenx tave absence iv problems,  zhol's tave gabunas kia spresti su savimi.'
        </h5>
