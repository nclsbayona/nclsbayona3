<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'I wanted to achieve something essential in life, something that is not measured by money or position in society. The mountains are not stadiums where I satisfy my ambitions to achieve. They are my cathedrals, the houses of my religion. In the mountains I attempt to understand my life. They are the way I practice my religion. In the mountains I celebrate creation, on each journey I am reborn.' was translated to oldenglish language, and the result is: ' attraction with pron ðe ic {wanted} more distant ræfn−an âhwæðer {essential} binnan brêostsefa, edwihte ðætte {is} hnot {measured} by mynet ofðe steall inne ymbhwyrf. {The} {mountains} copor nâteðæshwôn {stadiums} ðider ic pro cwêman mîn {ambitions} âdôn hêgan. {They} gleng mîn {cathedrals}, dôð boldgetimbru orgilde mîn lêafa. {In} ðone as {mountains} ic pro onhebban ûðe forcunnian mîn bl¯æd. {They} frêogan wægn sîðfat attraction with pron ðe ic faru mîn lêaffulnes. {In} ðone as {mountains} ic pro weorðian frumscepend, fullan welhwilc pro traht attraction with pron ðe ic {am} {reborn}.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                15.65°C, however it feels like 15.28°C, climate is
                <i>broken clouds</i>
            .
            Min. temperature: 15.65°C
            Max. temperature: 15.65°C
        </p>
    </div>
    <div id="wakatime">
        <p>
