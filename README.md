<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If we ever stop thinking about the person we want to become, we stop learning and taking risks.' was translated to oldenglish language, and the result is: ' {If} attraction with pron ðe ic ealneg âstyntan {thinking} onufan and sê wiht attraction with pron ðe ic forððêon wiðtêon sweorcan, attraction with pron ðe ic dyttan bôccræft ðêah−hwæðere scield {risks}.'
        </h5>
