<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'No one returns from a long journey the same person they were before.' was translated to pig-latin language, and the result is: 'o-Nay one-way eturns-ray om-fray a-way ong-lay ourney-jay e-thay ame-say erson-pay ey-thay ere-way efore-bay. '
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                18.48°C, however it feels like 18°C, climate is
                <i>broken clouds</i>
            .
            Min. temperature: 18.48°C
            Max. temperature: 18.48°C
        </p>
    </div>
    <div id="wakatime">
        <p>
