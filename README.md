<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The more you like yourself, the less you are like anyone else, which makes you unique.' was translated to oldenglish language, and the result is: ' {The} ðe êower efengelic {yourself}, ðone as l¯æs êower boda efengelic {anyone} ellor, sê {makes} êow bl¯ædfæst.'
        </h5>
