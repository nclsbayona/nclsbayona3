<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'People become attached to their burdens sometimes more than the burdens are attached to them.' was translated to oldenglish language, and the result is: ' {People} weorðan {attached} fyllan sîn {burdens} ðrâge ðe {than} wægn {burdens} weorðscipe {attached} unnan 1 an ðæge pro.'
        </h5>
