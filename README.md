<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'To create more positive results in your life, replace 'if only' with 'next time'.' was translated to yoda language, and the result is: 'More positive results in your life,  to create,'if only' with 'next time',  replace.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                16.2°C, however it feels like 15.78°C, climate is
                <i>broken clouds</i>
            .
