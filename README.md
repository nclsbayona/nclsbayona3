<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The truth is simple. If it was complicated, everyone would understand it.' was translated to oldenglish language, and the result is: ' {The} trêowð {is} unf¯æcne. {If} hê {was} spêdig, {everyone} {would} oncunnan hit hê.'
        </h5>
