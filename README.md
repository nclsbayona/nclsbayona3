<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Reflect upon your present blessings of which every man has many - not on your past misfortunes, of which all men have some.' was translated to oldenglish language, and the result is: ' {Reflect} bufan êower bringan {blessings} râd ðætte welhwilc pro guma {has} unlýtel {-} nâteshwôn ûtan êower beleorendlic {misfortunes}, râd sê {all} in self hwilc−hwene.'
        </h5>
