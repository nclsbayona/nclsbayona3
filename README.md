<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Trust thyself: every heart vibrates to that iron string.' was translated to ferblatin language, and the result is: 'rust-Terb thyself: very-eerb eart-herb ibrates-verb to hat-terb ron-ierb string. '
        </h5>
