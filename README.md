<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'We are all born ignorant, but one must work hard to remain stupid.' was translated to yoda language, and the result is: 'All born ignorant,  we are,Stupid,  but one must work hard to remain.'
        </h5>
    ...
    <div id="drink">
        ...
        <img src="https://www.thecocktaildb.com/images/media/drink/qxvtst1461867579.jpg">
        <h4>
            <font color="#F0A0FF">
                Name: Clove Cocktail
            </font>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                8.95°C, however it feels like 8.95°C, climate is
                <i>light rain</i>
            .
            Min. temperature: 8.95°C
            Max. temperature: 8.95°C
        </p>
    </div>
    <div id="wakatime">
        <p>
