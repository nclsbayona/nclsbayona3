<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Winning is not everything, but the effort to win is.' was translated to gungan language, and the result is: 'Winn is not everyth,  but dha effort to win is.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                10.97°C, however it feels like 10.47°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 10.97°C
            Max. temperature: 10.97°C
        </p>
    </div>
    <div id="wakatime">
        <p>
