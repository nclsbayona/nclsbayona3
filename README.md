<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Whenever we’re afraid, it’s because we don’t know enough. If we understood enough, we would never be afraid' was translated to oldenglish language, and the result is: ' {Whenever} {we’re} fyrht, {it’s} fullan we {don’t} witen nôg. {If} attraction with pron ðe ic {understood} +nðh, attraction with pron ðe ic {would} twêgen nu libban de forhtlic'
        </h5>
