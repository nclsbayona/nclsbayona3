<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you do not change direction, you may end up where you are heading.' was translated to dothraki language, and the result is: 'If yeri hash vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) change direction,  yeri may nakho yath finne yeri are heading.'
        </h5>
