<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'It is far easier to start something than it is to finish it.' was translated to pirate language, and the result is: 'It be far easier t' start somethin' than it be t' finish it.'
        </h5>
