<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'He who is not contented with what he has, would not be contented with what he would like to have.' was translated to dothraki language, and the result is: 'Anna fin is vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) contented ma fini anna has,  would vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) be contented ma fini anna would ven to hash.'
        </h5>
