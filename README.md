<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'We're kept from our goal not by obstacles, but by a clear path to a lesser goal.' was translated to oldenglish language, and the result is: ' {We're} {kept} ðanon ûser {goal} nâteðæshwôn forð forðbie {obstacles}, swâðêana fore bêga onscêotan sîðfat into weargbr¯æde {lesser} {goal}.'
        </h5>
