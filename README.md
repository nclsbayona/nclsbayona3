<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Failure is an option here. If things are not failing, you are not innovating enough.' was translated to klingon language, and the result is: 'Failure is an nuh nadev. If things are not failing,  tlhih are not innovating mevyap.'
        </h5>
