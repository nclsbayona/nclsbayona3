<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Not every day is going to offer us a chance to save somebody's life, but every day offers us an opportunity to affect one.' was translated to oldenglish language, and the result is: ' {Not} æghwilc gêardagas {is} stepegong from− timbran ûs of pro ic bêgra wif stellan gêocian {somebody's} môdgeðôht, hwæt form and with a gêardagas {offers} ûs of pro ic cyning limplicnes forweorpan {affect} ânlic.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                12.94°C, however it feels like 12.67°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 12.94°C
            Max. temperature: 12.94°C
        </p>
    </div>
    <div id="wakatime">
        <p>
