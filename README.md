<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Failure is just another way to learn how to do something right' was translated to oldenglish language, and the result is: ' {Failure} {is} rihtlic {another} onwîcan wîte be−frînan tôhwega and lecgan drohtian wiht rihte'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                11.88°C, however it feels like 11.63°C, climate is
                <i>broken clouds</i>
            .
            Min. temperature: 11.88°C
            Max. temperature: 11.88°C
        </p>
    </div>
    <div id="wakatime">
        <p>
