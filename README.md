<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Named must your fear be before banish it you can.' was translated to oldenglish language, and the result is: ' {Named} must êower f¯ær cunnon beforan âwrecan man êower canne.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                14.52°C, however it feels like 14.22°C, climate is
                <i>light rain</i>
            .
            Min. temperature: 14.52°C
            Max. temperature: 14.52°C
        </p>
    </div>
    <div id="wakatime">
        <p>
