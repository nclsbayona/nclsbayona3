<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you want to test your memory, try to recall what you were worrying about one year ago today.' was translated to oldenglish language, and the result is: ' {If} êow ðearflicnes from− sweotolian êower ingemynd, cunnian âlecgan eftgecîgan {what} êow {were} {worrying} hw¯ær heofontorht winterstund {ago} {today}.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                9.47°C, however it feels like 9.47°C, climate is
                <i>few clouds</i>
            .
            Min. temperature: 9.47°C
            Max. temperature: 9.47°C
        </p>
    </div>
    <div id="wakatime">
        <p>
