<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Do not look for a sanctuary in anyone except your self.' was translated to dothraki language, and the result is: 'Hash vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) athtihar ha a sanctuary she anyone except yeri self.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                9.82°C, however it feels like 9.82°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 9.82°C
            Max. temperature: 9.82°C
        </p>
    </div>
    <div id="wakatime">
        <p>
