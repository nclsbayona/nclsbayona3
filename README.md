<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Don't be tempted to break momentum-work through it.' was translated to minion language, and the result is: 'domo be tempted da ich piuhit-traba thru pik.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                17.13°C, however it feels like 16.44°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 17.13°C
            Max. temperature: 17.13°C
        </p>
    </div>
    <div id="wakatime">
        <p>
