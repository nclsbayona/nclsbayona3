<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Just do what must be done. This may not be happiness but it is greatness.' was translated to oldenglish language, and the result is: ' {Just} drohtian {what} must bêo {done}. {This} mêowle nâ bêo bliss to ðæge pro {is} unne.'
        </h5>
