<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you truly expect something to be difficult, it will be.' was translated to dothraki language, and the result is: 'If yeri truly expect ato to be difficult,  anna will be.'
        </h5>
