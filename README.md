<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Remember that you are very special, no one can play your role better than you.' was translated to oldenglish language, and the result is: ' {Remember} ðêah êower frêogan tela , ðêos dêore canne gamenian êower {role} fæstnian {than} êower.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                11.96°C, however it feels like 11.61°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 11.96°C
            Max. temperature: 11.96°C
        </p>
    </div>
    <div id="wakatime">
        <p>
