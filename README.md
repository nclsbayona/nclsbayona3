<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The way to get started is to quit talking and begin doing.' was translated to mandalorian language, and the result is: 'Te way brokar get started is brokar quit talking bal begin doing.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                11.74°C, however it feels like 11.37°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 11.74°C
            Max. temperature: 11.74°C
        </p>
    </div>
    <div id="wakatime">
        <p>
