<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'I am an optimist. It does not seem too much use being anything else..' was translated to gungan language, and the result is: 'Mesa an optimist. It does not seem too mui use be anyth else.'
        </h5>
