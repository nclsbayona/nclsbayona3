<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The best way to predict the future is to create it.' was translated to oldenglish language, and the result is: ' {The} fyrmest su of forma gang æt−bregdan wîtegian dôð tôweardnes {is} stêpan stefnian hit hê.'
        </h5>
