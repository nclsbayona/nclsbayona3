<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'I always advice people - Don't wait ! Do something when you are young, when you have no responsibilities. Invest time in yourself to have great Experiences that are going to enrich you, then you can't possibly lose.' was translated to oldenglish language, and the result is: ' attraction with pron ðe ic ferhð lâr fîras {-} {Don't} ieldian {}! {Do} sum inde âhwænne êow weorðung cildlic, mid êow âl¯ætan nâ {responsibilities}. {Invest} hwîl oð {yourself} lecgan forgîemelêasian lîffæst {Experiences} ðêah clyppan stæpe âweorpan wlencan êow, ðærrihtes êower {can't} wên−unga lettan.'
        </h5>
