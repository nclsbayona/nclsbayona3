<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'When angry count to ten before you speak. If very angry, count to one hundred.' was translated to sindarin language, and the result is: 'Ir angrui nedi- na caen before cin ped-. If verui angrui,  nedi- na er hoth.'
        </h5>
