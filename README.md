<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'There is no absolute success in the world, only constant progress.' was translated to dothraki language, and the result is: 'Rekke is vo (a shortened variant of vos,  ki may be used when the next word starts ma a consonant.) absolute success she the rhaesheser,  disse constant progress.'
        </h5>
