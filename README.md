<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'An aspirational diet will have you dreaming of success; but it's the attachment of expectations and tangible goals that feeds the desire, persistence, and fortitude required to make the win.' was translated to oldenglish language, and the result is: ' {An} {aspirational} {diet} cwide âlecgan êow {dreaming} orgilde forweaxan; sôðlic {it's} wægn {attachment} râd {expectations} verb grâpigendlic {goals} ðe {feeds} ðone as geornung, inwunenes, hwæt fæstr¯ædnes {required} âsettan wyrcan wægn earnian.'
        </h5>
