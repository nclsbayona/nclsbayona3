<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'The last time doesn't exist. It's only this time. And everything is going to be different this time. There's only now.' was translated to pirate language, and the result is: 'th' last time doesn't exist.  It's only this time.  Walk the plank!  And everythin' be goin' t' be different this time.  There's only now.'
        </h5>
