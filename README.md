<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'It is not because things are difficult that we do not dare; it is because we do not dare that things are difficult.  ' was translated to klingon language, and the result is: ''oh is not because things are difficult 'e' mah do not ngil; 'oh is because mah do not ngil 'e' things are difficult.'
        </h5>
