<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Don't forget to enjoy the journey' was translated to oldenglish language, and the result is: ' {Don't} ofergietan hêan nyttian duguð herestr¯æt'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                13.65°C, however it feels like 13.19°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 13.65°C
            Max. temperature: 13.65°C
        </p>
    </div>
    <div id="wakatime">
        <p>
