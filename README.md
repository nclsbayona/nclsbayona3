<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Successful people appear to be traveling along one continual, successful road. What is not apparent is the perseverance it takes following each defeat to keep you on that road. No one I know of has ever experienced one success after another without defeats, failures, disappointments, and frustrations galore along the way. Learning to overcome those times of agony is what separates the winners from the losers.' was translated to oldenglish language, and the result is: ' {Successful} woruld wæfersýn later sîe {traveling} geond dêore singallic, bêntîðe foldweg. {What} {is} nâteshwôn {apparent} {is} sê wununes hê {takes} folgoð hwæðer oferdrîfan (gyden hendan êower toward ' right to own or occupy land or connected with its occupation lâd. {No} æðellic ic pro witen of {has} â infrôd duguðlic spêd hinder {another} wiðûtan {defeats}, {failures}, {disappointments}, from {frustrations} {galore} âlangian duguð r¯æd. {Learning} ðêon oferswîðan and sv ðæge pro {times} râd dêaðcwalu {is} {what} {separates} wægn {winners} intô with sê {losers}.'
        </h5>
