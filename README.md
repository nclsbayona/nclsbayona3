<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Where you are right now doesn't have to determine where you'll end up.' was translated to dothraki language, and the result is: 'Finne yeri are jil ajjin doesn't eth determine finne yeri'll nakho yath.'
        </h5>
