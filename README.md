<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Effort only fully releases its reward after a person refuses to quit.' was translated to oldenglish language, and the result is: ' {Effort} ânlic fullic {releases} sîn sceatt æthindan wýscan hâd {refuses} oð ofgiefan.'
        </h5>
