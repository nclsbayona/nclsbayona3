<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you truly expect something to be difficult, it will be.' was translated to mandalorian language, and the result is: 'Meh gar truly expect something brokar cuyir urakto,  bic will cuyir.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                19.86°C, however it feels like 19.26°C, climate is
                <i>broken clouds</i>
            .
            Min. temperature: 19.86°C
            Max. temperature: 19.86°C
        </p>
    </div>
    <div id="wakatime">
        <p>
