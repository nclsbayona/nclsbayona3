<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'All courses of action are risky, so prudence is not in avoiding danger (it's impossible), but calculating risk and acting decisively. Make mistakes of ambition and not mistakes of sloth. Develop the strength to do bold things, not the strength to suffer.' was translated to huttese language, and the result is: 'All courses of action are risky,  so prudence sa nopa noleeya avoiding danger (soong impossible),  but calculating risk um acting decisively. Make mistakes of ambition um nopa mistakes of sloth. Develop doe strength tah do bold things,  nopa doe strength tah suffer.'
        </h5>
    ...
    <div id="drink">
        ...
        <img src="https://www.thecocktaildb.com/images/media/drink/wyrsxu1441554538.jpg">
        <h4>
            <font color="#F0A0FF">
                Name: Rum Punch
            </font>
