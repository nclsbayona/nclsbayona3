<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'If you truly expect something to be difficult, it will be.' was translated to gungan language, and the result is: 'If yousa truly expect someth besa difficult,  it will be.'
        </h5>
