<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Inspiration exists, but it has to find you working.' was translated to oldenglish language, and the result is: ' {Inspiration} {exists}, ge hit hê {has} oððicgan mêtan êow weorcnes.'
        </h5>
    ...
    <div id="weather-info">
        ...
        <p>
            <b> 
                12.96°C, however it feels like 12.58°C, climate is
                <i>overcast clouds</i>
            .
            Min. temperature: 12.96°C
            Max. temperature: 12.96°C
        </p>
    </div>
    <div id="wakatime">
        <p>
