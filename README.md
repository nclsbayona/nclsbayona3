<div id="full-page" style="background-color:#000011;" align="center">
    <div id="greetings" align="center">
        ...
        <h5>
            The text 'Only a man who knows what it is like to be defeated can reach down to the bottom of his soul and come up with the extra ounce of power it takes to win when the match is even.' was translated to oldenglish language, and the result is: ' {Only} bêgra wiga ðêos {knows} {what} man {is} efengelic verb bêon unsigefæst canne streccan neoð−an ûtâðýdan duguð botm orgilde his of hê feorh m fêores forðý wiðercweðan ûpweard mid duguð {extra} yndse orgilde ðrymm ðæge pro {takes} ben¯æman earnung ðâ dôð onlîcian {is} swîgtîma.'
        </h5>
